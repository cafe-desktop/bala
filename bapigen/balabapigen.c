/* balavapigen.c generated by balac, the Bala compiler
 * generated from balavapigen.bala, do not modify */
...
static gchar** bala_vapi_gen_metadata_directories;
static gboolean bala_vapi_gen_nostdpkg;
static gchar** bala_vapi_gen_packages;
static gchar* bala_vapi_gen_library;
static gchar* bala_vapi_gen_directory;
static gboolean bala_vapi_gen_disable_warnings;
static gboolean bala_vapi_gen_version;
static gboolean bala_vapi_gen_quiet_mode;
static gchar** bala_vapi_gen_sources;
static gchar* bala_vapi_gen_directory = NULL;
static gboolean bala_vapi_gen_version = FALSE;
static gboolean bala_vapi_gen_quiet_mode = FALSE;
static gboolean bala_vapi_gen_disable_warnings = FALSE;
static gchar** bala_vapi_gen_sources = NULL;
static gchar** bala_vapi_gen_vapi_directories = NULL;
static gchar** bala_vapi_gen_gir_directories = NULL;
static gchar** bala_vapi_gen_metadata_directories = NULL;
static gchar* bala_vapi_gen_library = NULL;
static gchar** bala_vapi_gen_packages = NULL;
static gboolean bala_vapi_gen_nostdpkg = FALSE;

G_GNUC_INTERNAL gpointer bala_vapi_gen_ref (gpointer instance);
G_GNUC_INTERNAL void bala_vapi_gen_unref (gpointer instance);
G_GNUC_INTERNAL GParamSpec* bala_param_spec_vapi_gen (const gchar* name,
                                      const gchar* nick,
                                      const gchar* blurb,
                                      GType object_type,
                                      GParamFlags flags);
G_GNUC_INTERNAL void bala_value_set_vapi_gen (GValue* value,
                              gpointer v_object) G_GNUC_UNUSED;
G_GNUC_INTERNAL void bala_value_take_vapi_gen (GValue* value,
                               gpointer v_object);
...
bala_vapi_gen_run (BalaBAPIGen* self)
{
	...
	_tmp4_ = bala_vapi_gen_vapi_directories;
	_tmp4__length1 = _bala_array_length (bala_vapi_gen_vapi_directories);
	bala_code_context_set_vapi_directories (_tmp3_, _tmp4_, _tmp4__length1);
	_tmp5_ = self->priv->context;
	_tmp6_ = bala_vapi_gen_gir_directories;
	_tmp6__length1 = _bala_array_length (bala_vapi_gen_gir_directories);
	bala_code_context_set_gir_directories (_tmp5_, _tmp6_, _tmp6__length1);
	_tmp7_ = self->priv->context;
	_tmp8_ = bala_vapi_gen_metadata_directories;
	_tmp8__length1 = _bala_array_length (bala_vapi_gen_metadata_directories);
	...
	_tmp11_ = _tmp10_;
	bala_report_set_enable_warnings (_tmp11_, !bala_vapi_gen_disable_warnings);
	_tmp12_ = self->priv->context;
	_tmp13_ = bala_code_context_get_report (_tmp12_);
	_tmp14_ = _tmp13_;
	bala_report_set_verbose_errors (_tmp14_, !bala_vapi_gen_quiet_mode);
	_tmp15_ = self->priv->context;
	bala_code_context_push (_tmp15_);
	_tmp16_ = self->priv->context;
	bala_code_context_set_nostdpkg (_tmp16_, bala_vapi_gen_nostdpkg);
	if (!bala_vapi_gen_nostdpkg) {
	...
	if (bala_report_get_errors (_tmp21_) > 0) {
		result = bala_vapi_gen_quit (self);
		return result;
	}
	_tmp22_ = bala_vapi_gen_sources;
	_tmp22__length1 = _bala_array_length (bala_vapi_gen_sources);
	{
	...
	_tmp48_ = bala_vapi_gen_packages;
	_tmp48__length1 = _bala_array_length (bala_vapi_gen_packages);
	if (_tmp48_ != NULL) {
		gchar** _tmp49_;
		gint _tmp49__length1;
		_tmp49_ = bala_vapi_gen_packages;
		_tmp49__length1 = _bala_array_length (bala_vapi_gen_packages);
		{
		...
		bala_vapi_gen_packages = (_bala_array_free (bala_vapi_gen_packages, _bala_array_length (bala_vapi_gen_packages), (GDestroyNotify) g_free), NULL);
		bala_vapi_gen_packages = NULL;
	}
	...
	_tmp56_ = bala_vapi_gen_sources;
	_tmp56__length1 = _bala_array_length (bala_vapi_gen_sources);
	{
		gchar** source_collection = NULL;
		gint source_collection_length1 = 0;
		gint _source_collection_size_ = 0;
	...
	_package_names_size_ = package_names_length1;
	{
		...
		while (TRUE) {
			...
			_tmp109_ = _tmp108_;
			_tmp110_ = bala_vapi_gen_sources;
			_tmp110__length1 = _bala_array_length (bala_vapi_gen_sources);
	...
	_tmp137_ = bala_vapi_gen_library;
	...
	_tmp152_ = bala_vapi_gen_directory;
	if (_tmp152_ != NULL) {
		const gchar* _tmp153_;
		const gchar* _tmp154_;
		gchar* _tmp155_;
		_tmp153_ = bala_vapi_gen_directory;
	...
	_g_free0 (bala_vapi_gen_library);
	bala_vapi_gen_library = NULL;
	result = bala_vapi_gen_quit (self);
	_g_free0 (vapi_filename);
                    ...
                    gint args_length1)
{
	...
	_tmp12_ = bala_vapi_gen_sources;
	_tmp12__length1 = _bala_array_length (bala_vapi_gen_sources);
	if (_tmp12_ == NULL) {
		FILE* _tmp13_;
		_tmp13_ = stderr;
	...
	_tmp14_ = bala_vapi_gen_new ();
	vapigen = _tmp14_;
	_tmp15_ = vapigen;
	result = bala_vapi_gen_run (_tmp15_);
	_bala_vapi_gen_unref0 (vapigen);
	return result;
}
...
static void
bala_value_vapi_gen_init (GValue* value)
{
	value->data[0].v_pointer = NULL;
}

static void
bala_value_vapi_gen_free_value (GValue* value)
{
	if (value->data[0].v_pointer) {
		bala_vapi_gen_unref (value->data[0].v_pointer);
	}
}

static void
bala_value_vapi_gen_copy_value (const GValue* src_value,
                                GValue* dest_value)
{
	if (src_value->data[0].v_pointer) {
		dest_value->data[0].v_pointer = bala_vapi_gen_ref (src_value->data[0].v_pointer);
	} else {
...
static gpointer
bala_value_vapi_gen_peek_pointer (const GValue* value)
{
	return value->data[0].v_pointer;
}

static gchar*
bala_value_vapi_gen_collect_value (GValue* value,
                                   ...
                                   guint collect_flags)
{
	if (collect_values[0].v_pointer) {
		...
		value->data[0].v_pointer = bala_vapi_gen_ref (object);
	} else {
		value->data[0].v_pointer = NULL;
	}
	return NULL;
...
static gchar*
bala_value_vapi_gen_lcopy_value (const GValue* value,
                                 guint n_collect_values,
                                 GTypeCValue* collect_values,
                                 guint collect_flags)
{
	...
	if (!value->data[0].v_pointer) {
		...
		*object_p = bala_vapi_gen_ref (value->data[0].v_pointer);
	}
	return NULL;
}

G_GNUC_INTERNAL GParamSpec*
bala_param_spec_vapi_gen (const gchar* name,
                          const gchar* nick,
                          const gchar* blurb,
                          GType object_type,
                          GParamFlags flags)
...
bala_vapi_gen_get_type (void)
{
	static volatile gsize bala_vapi_gen_type_id__volatile = 0;
	if (g_once_init_enter (&bala_vapi_gen_type_id__volatile)) {
		GType bala_vapi_gen_type_id;
		bala_vapi_gen_type_id = bala_vapi_gen_get_type_once ();
		g_once_init_leave (&bala_vapi_gen_type_id__volatile, bala_vapi_gen_type_id);
	}
	return bala_vapi_gen_type_id__volatile;
}
