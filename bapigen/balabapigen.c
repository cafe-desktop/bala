/* balavapigen.c generated by balac, the Vala compiler
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ValaVAPIGen, bala_vapi_gen_unref)
static gint bala_vapi_gen_quit (ValaVAPIGen* self);
static gint bala_vapi_gen_run (ValaVAPIGen* self);
...
static gint bala_vapi_gen_main (gchar** args,
                         gint args_length1);
G_GNUC_INTERNAL ValaVAPIGen* bala_vapi_gen_new (void);
G_GNUC_INTERNAL ValaVAPIGen* bala_vapi_gen_construct (GType object_type);
static void bala_vapi_gen_finalize (ValaVAPIGen * obj);
...
bala_vapi_gen_get_instance_private (ValaVAPIGen* self)
{
	return G_STRUCT_MEMBER_P (self, ValaVAPIGen_private_offset);
}

static gint
bala_vapi_gen_quit (ValaVAPIGen* self)
{
...
static gint
bala_vapi_gen_run (ValaVAPIGen* self)
{
	ValaCodeContext* _tmp0_;
...
static void
bala_vapi_gen_class_init (ValaVAPIGenClass * klass,
                          gpointer klass_data)
{
	bala_vapi_gen_parent_class = g_type_class_peek_parent (klass);
	((ValaVAPIGenClass *) klass)->finalize = bala_vapi_gen_finalize;
	g_type_class_adjust_private_offset (klass, &ValaVAPIGen_private_offset);
}

static void
bala_vapi_gen_instance_init (ValaVAPIGen * self,
                             gpointer klass)
{
...
static void
bala_vapi_gen_finalize (ValaVAPIGen * obj)
{
	ValaVAPIGen * self;
...
bala_vapi_gen_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (ValaVAPIGenClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_vapi_gen_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaVAPIGen), 0, (GInstanceInitFunc) bala_vapi_gen_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType bala_vapi_gen_type_id;
	bala_vapi_gen_type_id = g_type_register_fundamental (g_type_fundamental_next (), "ValaVAPIGen", &g_define_type_info, &g_define_type_fundamental_info, 0);
	ValaVAPIGen_private_offset = g_type_add_instance_private (bala_vapi_gen_type_id, sizeof (ValaVAPIGenPrivate));
