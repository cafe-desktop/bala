/* balavapicheck.c generated by balac, the Vala compiler
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ValaVAPICheck, bala_vapi_check_unref)
G_GNUC_INTERNAL ValaVAPICheck* bala_vapi_check_new (const gchar* gidlname,
                                    ValaCodeContext* context);
G_GNUC_INTERNAL ValaVAPICheck* bala_vapi_check_construct (GType object_type,
                                          const gchar* gidlname,
                                          ValaCodeContext* context);
static void bala_vapi_check_set_gidl (ValaVAPICheck* self,
                               ValaSourceFile* value);
static void bala_vapi_check_set_metadata (ValaVAPICheck* self,
                                   ValaSourceFile* value);
static void bala_vapi_check_set_context (ValaVAPICheck* self,
                                  ValaCodeContext* value);
G_GNUC_INTERNAL ValaCodeContext* bala_vapi_check_get_context (ValaVAPICheck* self);
G_GNUC_INTERNAL ValaSourceFile* bala_vapi_check_get_gidl (ValaVAPICheck* self);
G_GNUC_INTERNAL ValaSourceFile* bala_vapi_check_get_metadata (ValaVAPICheck* self);
static void bala_vapi_check_parse_gidl (ValaVAPICheck* self);
static void bala_vapi_check_parse_members (ValaVAPICheck* self,
                                    const gchar* name,
                                    GList* members);
static void _g_idl_module_free0_ (gpointer var);
static inline void _g_list_free__g_idl_module_free0_ (GList* self);
static void bala_vapi_check_add_symbol (ValaVAPICheck* self,
                                 const gchar* name,
                                 const gchar* separator);
static gchar* bala_vapi_check_get_scope (ValaVAPICheck* self);
static void bala_vapi_check_enter_scope (ValaVAPICheck* self,
                                  const gchar* name);
static void bala_vapi_check_leave_scope (ValaVAPICheck* self);
static gint bala_vapi_check_check_metadata (ValaVAPICheck* self);
G_GNUC_INTERNAL gint bala_vapi_check_run (ValaVAPICheck* self);
static gint bala_vapi_check_main (gchar** args,
                           gint args_length1);
static void bala_vapi_check_finalize (ValaVAPICheck * obj);
...
bala_vapi_check_get_instance_private (ValaVAPICheck* self)
{
...
bala_vapi_check_get_context (ValaVAPICheck* self)
{
...
static void
bala_vapi_check_set_context (ValaVAPICheck* self,
                             ValaCodeContext* value)
{
	ValaCodeContext* _tmp0_;
...
bala_vapi_check_get_gidl (ValaVAPICheck* self)
{
...
static void
bala_vapi_check_set_gidl (ValaVAPICheck* self,
                          ValaSourceFile* value)
{
	ValaSourceFile* _tmp0_;
	g_return_if_fail (self != NULL);
...
G_GNUC_INTERNAL ValaSourceFile*
bala_vapi_check_get_metadata (ValaVAPICheck* self)
{
	ValaSourceFile* result;
	ValaSourceFile* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
static void
bala_vapi_check_set_metadata (ValaVAPICheck* self,
                              ValaSourceFile* value)
{
	ValaSourceFile* _tmp0_;
	g_return_if_fail (self != NULL);
...
static void
bala_vapi_check_parse_gidl (ValaVAPICheck* self)
{
	GEqualFunc _tmp0_;
...
static void
bala_vapi_check_add_symbol (ValaVAPICheck* self,
                            const gchar* name,
                            const gchar* separator)
{
	g_return_if_fail (self != NULL);
	...
	if (NULL != separator) {
		...
		bala_collection_add ((ValaCollection*) _tmp8_, name);
	}
}

static gchar*
bala_vapi_check_get_scope (ValaVAPICheck* self)
{
	ValaList* _tmp0_;
	ValaList* _tmp1_;
	gint _tmp2_;
...
static void
bala_vapi_check_enter_scope (ValaVAPICheck* self,
                             const gchar* name)
{
	ValaList* _tmp0_;
	g_return_if_fail (self != NULL);
...
static void
bala_vapi_check_leave_scope (ValaVAPICheck* self)
{
	ValaList* _tmp0_;
	ValaList* _tmp1_;
	gint _tmp2_;
...
static void
bala_vapi_check_parse_members (ValaVAPICheck* self,
                               const gchar* name,
                               GList* members)
{
	g_return_if_fail (self != NULL);
...
static gint
bala_vapi_check_check_metadata (ValaVAPICheck* self)
{
	gint _tmp38_ = -1;
	GError* _inner_error0_ = NULL;
	gint result = 0;
	g_return_val_if_fail (self != NULL, 0);
	{
		...
		while (TRUE) {
			...
			if (_tmp17_ > 0) {
				...
				_tmp19_ = symbol;
				_tmp14_ = !bala_collection_contains ((ValaCollection*) _tmp18_, _tmp19_);
			} else {
				_tmp14_ = FALSE;
			}
			if (_tmp14_) {
...
bala_vapi_check_run (ValaVAPICheck* self)
{
	ValaSourceFile* _tmp0_;
	const gchar* _tmp1_;
	const gchar* _tmp2_;
...
static void
bala_vapi_check_class_init (ValaVAPICheckClass * klass,
                            gpointer klass_data)
{
	bala_vapi_check_parent_class = g_type_class_peek_parent (klass);
	((ValaVAPICheckClass *) klass)->finalize = bala_vapi_check_finalize;
	g_type_class_adjust_private_offset (klass, &ValaVAPICheck_private_offset);
}

static void
bala_vapi_check_instance_init (ValaVAPICheck * self,
                               gpointer klass)
{
...
static void
bala_vapi_check_finalize (ValaVAPICheck * obj)
{
	ValaVAPICheck * self;
...
bala_vapi_check_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (ValaVAPICheckClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_vapi_check_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaVAPICheck), 0, (GInstanceInitFunc) bala_vapi_check_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType bala_vapi_check_type_id;
	bala_vapi_check_type_id = g_type_register_fundamental (g_type_fundamental_next (), "ValaVAPICheck", &g_define_type_info, &g_define_type_fundamental_info, 0);
	ValaVAPICheck_private_offset = g_type_add_instance_private (bala_vapi_check_type_id, sizeof (ValaVAPICheckPrivate));
