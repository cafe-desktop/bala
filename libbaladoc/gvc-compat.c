...
void
baladoc_compat_gvc_init (void);

Agnode_t*
baladoc_compat_gvc_graph_create_node (Agraph_t* graph, const char *name);

Agraph_t*
baladoc_compat_gvc_graph_new (const char *name);

Agedge_t*
baladoc_compat_gvc_graph_create_edge (Agraph_t* graph, Agnode_t* from, Agnode_t* to);
