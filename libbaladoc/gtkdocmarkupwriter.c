/* gtkdocmarkupwriter.c generated by balac, the Vala compiler
...
static void ___lambda131__baladoc_markup_writer_write_func (const gchar* text,
                                                     gpointer self);
static gboolean baladoc_gtk_doc_markup_writer_real_inline_element (ValadocMarkupWriter* base,
                                                            const gchar* name);
static gboolean baladoc_gtk_doc_markup_writer_real_content_inline_element (ValadocMarkupWriter* base,
                                                                    const gchar* name);
static void baladoc_gtk_doc_markup_writer_finalize (ValadocMarkupWriter * obj);
static GType baladoc_gtk_doc_markup_writer_get_type_once (void);

static inline gpointer
baladoc_gtk_doc_markup_writer_get_instance_private (ValadocGtkDocMarkupWriter* self)
{
	return G_STRUCT_MEMBER_P (self, ValadocGtkDocMarkupWriter_private_offset);
}

void
baladoc_gtk_doc_markup_writer_reset (ValadocGtkDocMarkupWriter* self)
{
	GString* _tmp0_;
...
const gchar*
baladoc_gtk_doc_markup_writer_get_content (ValadocGtkDocMarkupWriter* self)
{
	const gchar* result;
	GString* _tmp0_;
	const gchar* _tmp1_;
...
baladoc_gtk_doc_markup_writer_construct (GType object_type)
{
	...
	self = (ValadocGtkDocMarkupWriter*) baladoc_markup_writer_construct (object_type, ___lambda131__baladoc_markup_writer_write_func, block1_data_ref (_data1_), block1_data_unref, FALSE);
...
static gboolean
baladoc_gtk_doc_markup_writer_real_inline_element (ValadocMarkupWriter* base,
                                                   const gchar* name)
{
	ValadocGtkDocMarkupWriter * self;
...
static gboolean
baladoc_gtk_doc_markup_writer_real_content_inline_element (ValadocMarkupWriter* base,
                                                           const gchar* name)
{
	ValadocGtkDocMarkupWriter * self;
	gboolean _tmp0_ = FALSE;
...
static void
baladoc_gtk_doc_markup_writer_class_init (ValadocGtkDocMarkupWriterClass * klass,
                                          gpointer klass_data)
{
	baladoc_gtk_doc_markup_writer_parent_class = g_type_class_peek_parent (klass);
	((ValadocMarkupWriterClass *) klass)->finalize = baladoc_gtk_doc_markup_writer_finalize;
	g_type_class_adjust_private_offset (klass, &ValadocGtkDocMarkupWriter_private_offset);
	((ValadocMarkupWriterClass *) klass)->inline_element = (gboolean (*) (ValadocMarkupWriter*, const gchar*)) baladoc_gtk_doc_markup_writer_real_inline_element;
	((ValadocMarkupWriterClass *) klass)->content_inline_element = (gboolean (*) (ValadocMarkupWriter*, const gchar*)) baladoc_gtk_doc_markup_writer_real_content_inline_element;
}

static void
baladoc_gtk_doc_markup_writer_instance_init (ValadocGtkDocMarkupWriter * self,
                                             gpointer klass)
{
...
static void
baladoc_gtk_doc_markup_writer_finalize (ValadocMarkupWriter * obj)
{
	ValadocGtkDocMarkupWriter * self;
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocGtkDocMarkupWriterClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_gtk_doc_markup_writer_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocGtkDocMarkupWriter), 0, (GInstanceInitFunc) baladoc_gtk_doc_markup_writer_instance_init, NULL };
	GType baladoc_gtk_doc_markup_writer_type_id;
	baladoc_gtk_doc_markup_writer_type_id = g_type_register_static (BALADOC_TYPE_MARKUP_WRITER, "ValadocGtkDocMarkupWriter", &g_define_type_info, 0);
	ValadocGtkDocMarkupWriter_private_offset = g_type_add_instance_private (baladoc_gtk_doc_markup_writer_type_id, sizeof (ValadocGtkDocMarkupWriterPrivate));
