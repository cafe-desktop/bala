/* wiki.c generated by balac, the Vala compiler
...
static ValadocDocumentationIface * baladoc_wiki_page_baladoc_documentation_parent_iface = NULL;
static gint ValadocWikiPageTree_private_offset;
static gpointer baladoc_wiki_page_tree_parent_class = NULL;

static void baladoc_wiki_page_set_documentation_str (ValadocWikiPage* self,
                                              const gchar* value);
static void baladoc_wiki_page_set_path (ValadocWikiPage* self,
                                 const gchar* value);
static void baladoc_wiki_page_set_name (ValadocWikiPage* self,
                                 const gchar* value);
static gchar* baladoc_wiki_page_real_get_filename (ValadocDocumentation* base);
...
static void _bala_baladoc_wiki_page_set_property (GObject * object,
                                           ...
                                           const GValue * value,
                                           GParamSpec * pspec);
static void baladoc_wiki_page_tree_create_tree_from_path (ValadocWikiPageTree* self,
...
baladoc_wiki_page_get_instance_private (ValadocWikiPage* self)
{
	return G_STRUCT_MEMBER_P (self, ValadocWikiPage_private_offset);
}

ValadocContentPage*
baladoc_wiki_page_get_documentation (ValadocWikiPage* self)
{
...
void
baladoc_wiki_page_set_documentation (ValadocWikiPage* self,
...
const gchar*
baladoc_wiki_page_get_documentation_str (ValadocWikiPage* self)
{
	const gchar* result;
	const gchar* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
static void
baladoc_wiki_page_set_documentation_str (ValadocWikiPage* self,
                                         const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
...
const gchar*
baladoc_wiki_page_get_path (ValadocWikiPage* self)
{
	const gchar* result;
	const gchar* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
static void
baladoc_wiki_page_set_path (ValadocWikiPage* self,
                            const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
...
const gchar*
baladoc_wiki_page_get_name (ValadocWikiPage* self)
{
	const gchar* result;
	const gchar* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
static void
baladoc_wiki_page_set_name (ValadocWikiPage* self,
                            const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
...
baladoc_wiki_page_real_get_package (ValadocDocumentation* base)
{
 ...
 */
static gchar*
baladoc_wiki_page_real_get_filename (ValadocDocumentation* base)
{
	ValadocWikiPage * self;
	const gchar* _tmp0_;
	gchar* _tmp1_;
...
void
baladoc_wiki_page_read (ValadocWikiPage* self,
                        ValadocErrorReporter* reporter)
{
...
void
baladoc_wiki_page_parse (ValadocWikiPage* self,
                         ValadocDocumentationParser* docparser,
...
static void
baladoc_wiki_page_class_init (ValadocWikiPageClass * klass,
                              gpointer klass_data)
{
...
static void
baladoc_wiki_page_baladoc_documentation_interface_init (ValadocDocumentationIface * iface,
                                                        gpointer iface_data)
{
	baladoc_wiki_page_baladoc_documentation_parent_iface = g_type_interface_peek_parent (iface);
	iface->get_filename = (gchar* (*) (ValadocDocumentation*)) baladoc_wiki_page_real_get_filename;
	iface->get_package = baladoc_wiki_page_real_get_package;
}

static void
baladoc_wiki_page_instance_init (ValadocWikiPage * self,
                                 gpointer klass)
{
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocWikiPageClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_wiki_page_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocWikiPage), 0, (GInstanceInitFunc) baladoc_wiki_page_instance_init, NULL };
	...
	baladoc_wiki_page_type_id = g_type_register_static (G_TYPE_OBJECT, "ValadocWikiPage", &g_define_type_info, 0);
	g_type_add_interface_static (baladoc_wiki_page_type_id, BALADOC_TYPE_DOCUMENTATION, &baladoc_documentation_info);
	ValadocWikiPage_private_offset = g_type_add_instance_private (baladoc_wiki_page_type_id, sizeof (ValadocWikiPagePrivate));
...
static inline gpointer
baladoc_wiki_page_tree_get_instance_private (ValadocWikiPageTree* self)
{
...
ValaCollection*
baladoc_wiki_page_tree_get_pages (ValadocWikiPageTree* self)
{
...
ValadocWikiPage*
baladoc_wiki_page_tree_search (ValadocWikiPageTree* self,
                               const gchar* name)
{
	...
	}
	{
		...
		while (TRUE) {
			...
			_tmp8_ = _page_list;
			_tmp9_ = bala_list_get ((ValaList*) _tmp8_, _page_index);
...
static void
baladoc_wiki_page_tree_create_tree_from_path (ValadocWikiPageTree* self,
                                              ValadocDocumentationParser* docparser,
                                              ValadocApiPackage* package,
                                              ValadocErrorReporter* reporter,
                                              const gchar* path,
...
void
baladoc_wiki_page_tree_parse (ValadocWikiPageTree* self,
                              ...
                              ValadocErrorReporter* reporter)
{
	...
	baladoc_wiki_page_tree_create_tree_from_path (self, docparser, package, reporter, _tmp4_, NULL);
	{
		...
		while (TRUE) {
			...
			_tmp12_ = _page_list;
			_tmp13_ = bala_list_get ((ValaList*) _tmp12_, _page_index);
...
void
baladoc_wiki_page_tree_check (ValadocWikiPageTree* self,
                              ValadocSettings* settings,
                              ValadocDocumentationParser* docparser,
                              ValadocApiPackage* pkg)
{
...
static void
baladoc_wiki_page_tree_class_init (ValadocWikiPageTreeClass * klass,
                                   gpointer klass_data)
{
...
static void
baladoc_wiki_page_tree_instance_init (ValadocWikiPageTree * self,
                                      gpointer klass)
{
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocWikiPageTreeClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_wiki_page_tree_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocWikiPageTree), 0, (GInstanceInitFunc) baladoc_wiki_page_tree_instance_init, NULL };
	GType baladoc_wiki_page_tree_type_id;
	baladoc_wiki_page_tree_type_id = g_type_register_static (G_TYPE_OBJECT, "ValadocWikiPageTree", &g_define_type_info, 0);
	ValadocWikiPageTree_private_offset = g_type_add_instance_private (baladoc_wiki_page_tree_type_id, sizeof (ValadocWikiPageTreePrivate));
