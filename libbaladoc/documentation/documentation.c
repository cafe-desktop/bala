/* documentation.c generated by balac, the Vala compiler
...
ValadocApiPackage*
baladoc_documentation_get_package (ValadocDocumentation* self)
{
 ...
 */
gchar*
baladoc_documentation_get_filename (ValadocDocumentation* self)
{
	g_return_val_if_fail (self != NULL, NULL);
...
static void
baladoc_documentation_default_init (ValadocDocumentationIface * iface,
                                    gpointer iface_data)
{
	/**
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocDocumentationIface), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_documentation_default_init, (GClassFinalizeFunc) NULL, NULL, 0, 0, (GInstanceInitFunc) NULL, NULL };
	GType baladoc_documentation_type_id;
	baladoc_documentation_type_id = g_type_register_static (G_TYPE_INTERFACE, "ValadocDocumentation", &g_define_type_info, 0);
