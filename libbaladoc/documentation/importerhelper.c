/* importerhelper.c generated by balac, the Vala compiler
...
G_GNUC_INTERNAL ValadocContentParagraph* baladoc_importer_helper_split_paragraph (ValadocContentParagraph* p,
                                                                  ValadocContentContentFactory* factory);
G_GNUC_INTERNAL ValadocContentText* baladoc_importer_helper_split_text (ValadocContentText* text,
                                                        ValadocContentContentFactory* factory);
G_GNUC_INTERNAL ValadocContentRun* baladoc_importer_helper_split_run (ValadocContentRun* run,
                                                      ValadocContentContentFactory* factory);
G_GNUC_INTERNAL ValadocContentInline* baladoc_importer_helper_split_inline (ValadocContentInline* item,
                                                            ValadocContentContentFactory* factory);
...
baladoc_importer_helper_resolve_parameter_ctype (ValadocApiTree* tree,
                                                 ValadocApiNode* element,
                                                 const gchar* parameter_name,
                                                 gchar* * param_name,
                                                 gchar* * param_array_name,
                                                 gboolean* is_return_type_len)
{
	...
	param = NULL;
	{
		...
		while (TRUE) {
			...
			if (g_strcmp0 (_tmp12_, _tmp14_) == 0) {
				...
				_tmp15_ = node;
				_tmp16_ = _g_object_ref0 (BALADOC_API_IS_PARAMETER (_tmp15_) ? ((ValadocApiParameter*) _tmp15_) : NULL);
			...
			_tmp17_ = node;
			_tmp18_ = baladoc_api_parameter_get_implicit_array_length_cparameter_name (G_TYPE_CHECK_INSTANCE_CAST (_tmp17_, BALADOC_API_TYPE_PARAMETER, ValadocApiParameter));
			_tmp19_ = _tmp18_;
			_tmp20_ = parts;
			...
			if (g_strcmp0 (_tmp19_, _tmp21_) == 0) {
				...
				gchar* _tmp25_;
				_tmp22_ = node;
				_tmp23_ = baladoc_api_node_get_name ((ValadocApiNode*) G_TYPE_CHECK_INSTANCE_CAST (_tmp22_, BALADOC_API_TYPE_PARAMETER, ValadocApiParameter));
				_tmp24_ = _tmp23_;
	...
	if (BALADOC_API_IS_CALLABLE (element)) {
		...
		const gchar* _tmp30_;
		_tmp27_ = baladoc_api_callable_get_implicit_array_length_cparameter_name (G_TYPE_CHECK_INSTANCE_CAST (element, BALADOC_API_TYPE_CALLABLE, ValadocApiCallable));
		_tmp28_ = _tmp27_;
		_tmp29_ = parts;
	...
	while (TRUE) {
		...
		if (BALADOC_API_IS_TYPEREFERENCE (_tmp42_)) {
			...
			_tmp43_ = inner;
			_tmp44_ = baladoc_api_typereference_get_data_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp43_, BALADOC_API_TYPE_TYPEREFERENCE, ValadocApiTypeReference));
			_tmp45_ = _tmp44_;
			...
			if (BALADOC_API_IS_POINTER (_tmp47_)) {
				...
				_tmp48_ = inner;
				_tmp49_ = baladoc_api_pointer_get_data_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp48_, BALADOC_API_TYPE_POINTER, ValadocApiPointer));
				_tmp50_ = _tmp49_;
				...
				if (BALADOC_API_IS_ARRAY (_tmp52_)) {
					...
					_tmp53_ = inner;
					_tmp54_ = baladoc_api_array_get_data_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp53_, BALADOC_API_TYPE_ARRAY, ValadocApiArray));
					_tmp55_ = _tmp54_;
	...
	if (BALADOC_API_IS_ERROR_DOMAIN (_tmp59_)) {
		...
		gchar* _tmp61_;
		_tmp60_ = inner;
		_tmp61_ = baladoc_api_error_domain_get_cname (G_TYPE_CHECK_INSTANCE_CAST (_tmp60_, BALADOC_API_TYPE_ERROR_DOMAIN, ValadocApiErrorDomain));
		_g_free0 (cname);
		cname = _tmp61_;
	} else {
		...
		if (BALADOC_API_IS_STRUCT (_tmp62_)) {
			...
			gchar* _tmp64_;
			_tmp63_ = inner;
			_tmp64_ = baladoc_api_struct_get_cname (G_TYPE_CHECK_INSTANCE_CAST (_tmp63_, BALADOC_API_TYPE_STRUCT, ValadocApiStruct));
			_g_free0 (cname);
			cname = _tmp64_;
		} else {
			...
			if (BALADOC_API_IS_CLASS (_tmp65_)) {
				...
				gchar* _tmp67_;
				_tmp66_ = inner;
				_tmp67_ = baladoc_api_class_get_cname (G_TYPE_CHECK_INSTANCE_CAST (_tmp66_, BALADOC_API_TYPE_CLASS, ValadocApiClass));
				_g_free0 (cname);
				cname = _tmp67_;
			} else {
				...
				if (BALADOC_API_IS_ENUM (_tmp68_)) {
					...
					gchar* _tmp70_;
					_tmp69_ = inner;
					_tmp70_ = baladoc_api_enum_get_cname (G_TYPE_CHECK_INSTANCE_CAST (_tmp69_, BALADOC_API_TYPE_ENUM, ValadocApiEnum));
					_g_free0 (cname);
					cname = _tmp70_;
				} else {
...
baladoc_importer_helper_extract_short_desc (ValadocContentComment* comment,
                                            ValadocContentContentFactory* factory)
{
	ValaList* _tmp0_;
	ValaList* _tmp1_;
	...
	_tmp0_ = baladoc_content_block_content_get_content ((ValadocContentBlockContent*) comment);
	_tmp1_ = _tmp0_;
	...
	_tmp4_ = baladoc_content_block_content_get_content ((ValadocContentBlockContent*) comment);
	_tmp5_ = _tmp4_;
	_tmp6_ = bala_list_get (_tmp5_, 0);
	_tmp7_ = (ValadocContentBlock*) _tmp6_;
	_tmp8_ = BALADOC_CONTENT_IS_PARAGRAPH (_tmp7_) ? ((ValadocContentParagraph*) _tmp7_) : NULL;
	if (_tmp8_ == NULL) {
	...
	if (_tmp9_ == NULL) {
		...
		_tmp10_ = baladoc_content_block_content_get_content ((ValadocContentBlockContent*) comment);
		_tmp11_ = _tmp10_;
		_tmp12_ = baladoc_content_content_factory_create_paragraph (factory);
		_tmp13_ = _tmp12_;
		bala_list_insert (_tmp11_, 1, (ValadocContentBlock*) _tmp13_);
		_g_object_unref0 (_tmp13_);
		_g_object_unref0 (first_paragraph);
		return;
	}
	_tmp14_ = first_paragraph;
	baladoc_content_style_attributes_set_horizontal_align ((ValadocContentStyleAttributes*) _tmp14_, BALADOC_CONTENT_HORIZONTAL_ALIGN_NONE);
	_tmp15_ = first_paragraph;
	baladoc_content_style_attributes_set_vertical_align ((ValadocContentStyleAttributes*) _tmp15_, BALADOC_CONTENT_VERTICAL_ALIGN_NONE);
	_tmp16_ = first_paragraph;
	baladoc_content_style_attributes_set_style ((ValadocContentStyleAttributes*) _tmp16_, NULL);
	...
	if (baladoc_content_content_element_is_empty ((ValadocContentContentElement*) _tmp20_) == FALSE) {
		ValaList* _tmp21_;
		ValaList* _tmp22_;
		ValadocContentParagraph* _tmp23_;
		_tmp21_ = baladoc_content_block_content_get_content ((ValadocContentBlockContent*) comment);
		_tmp22_ = _tmp21_;
		_tmp23_ = second_paragraph;
		bala_list_insert (_tmp22_, 1, (ValadocContentBlock*) _tmp23_);
	}
	_g_object_unref0 (second_paragraph);
	_g_object_unref0 (first_paragraph);
}
...
baladoc_importer_helper_split_text (ValadocContentText* text,
                                    ValadocContentContentFactory* factory)
{
	gint offset = 0;
...
baladoc_importer_helper_split_run (ValadocContentRun* run,
                                   ValadocContentContentFactory* factory)
{
	...
	sec = NULL;
	_tmp2_ = baladoc_content_inline_content_get_content ((ValadocContentInlineContent*) run);
	_tmp3_ = _tmp2_;
...
baladoc_importer_helper_split_inline (ValadocContentInline* item,
                                      ValadocContentContentFactory* factory)
{
	...
	if (BALADOC_CONTENT_IS_TEXT (item)) {
		...
		_tmp0_ = baladoc_importer_helper_split_text (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_CONTENT_TYPE_TEXT, ValadocContentText), factory);
		result = (ValadocContentInline*) _tmp0_;
		return result;
	} else {
		if (BALADOC_CONTENT_IS_RUN (item)) {
			ValadocContentRun* _tmp1_;
			_tmp1_ = baladoc_importer_helper_split_run (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_CONTENT_TYPE_RUN, ValadocContentRun), factory);
...
baladoc_importer_helper_split_paragraph (ValadocContentParagraph* p,
                                         ValadocContentContentFactory* factory)
{
	...
	g_return_val_if_fail (factory != NULL, NULL);
	sec = NULL;
	_tmp0_ = baladoc_content_inline_content_get_content ((ValadocContentInlineContent*) p);
	_tmp1_ = _tmp0_;
			...
			while (TRUE) {
				...
				if (_tmp8_ == NULL) {
					...
					if (_tmp11_ != NULL) {
						...
						sec = _tmp12_;
						_tmp13_ = sec;
						_tmp14_ = baladoc_content_style_attributes_get_horizontal_align ((ValadocContentStyleAttributes*) p);
						_tmp15_ = _tmp14_;
						baladoc_content_style_attributes_set_horizontal_align ((ValadocContentStyleAttributes*) _tmp13_, _tmp15_);
						_tmp16_ = sec;
						_tmp17_ = baladoc_content_style_attributes_get_vertical_align ((ValadocContentStyleAttributes*) p);
						_tmp18_ = _tmp17_;
						baladoc_content_style_attributes_set_vertical_align ((ValadocContentStyleAttributes*) _tmp16_, _tmp18_);
						_tmp19_ = sec;
						_tmp20_ = baladoc_content_style_attributes_get_style ((ValadocContentStyleAttributes*) p);
						_tmp21_ = _tmp20_;
						baladoc_content_style_attributes_set_style ((ValadocContentStyleAttributes*) _tmp19_, _tmp21_);
						_tmp22_ = sec;
					...
					_tmp26_ = sec;
					_tmp27_ = baladoc_content_inline_content_get_content ((ValadocContentInlineContent*) _tmp26_);
					_tmp28_ = _tmp27_;
					_tmp29_ = item;
