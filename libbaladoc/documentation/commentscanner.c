/* commentscanner.c generated by balac, the Vala compiler
...
static void baladoc_comment_scanner_real_reset (ValadocWikiScanner* base);
static gint baladoc_comment_scanner_real_get_line_start_column (ValadocWikiScanner* base);
static void baladoc_comment_scanner_real_accept (ValadocWikiScanner* base,
                                          gunichar c,
                                          GError** error);
...
baladoc_comment_scanner_get_instance_private (ValadocCommentScanner* self)
{
                                   ...
                                   ValadocSettings* settings)
{
	...
	self = (ValadocCommentScanner*) baladoc_wiki_scanner_construct (object_type, settings);
	return self;
}

ValadocCommentScanner*
baladoc_comment_scanner_new (ValadocSettings* settings)
{
	return baladoc_comment_scanner_construct (BALADOC_TYPE_COMMENT_SCANNER, settings);
}

static void
baladoc_comment_scanner_real_reset (ValadocWikiScanner* base)
{
	ValadocCommentScanner * self;
	self = (ValadocCommentScanner*) base;
	BALADOC_WIKI_SCANNER_CLASS (baladoc_comment_scanner_parent_class)->reset (G_TYPE_CHECK_INSTANCE_CAST (self, BALADOC_TYPE_WIKI_SCANNER, ValadocWikiScanner));
...
static gint
baladoc_comment_scanner_real_get_line_start_column (ValadocWikiScanner* base)
{
	ValadocCommentScanner * self;
	gint result = 0;
	self = (ValadocCommentScanner*) base;
...
static void
baladoc_comment_scanner_real_accept (ValadocWikiScanner* base,
                                     gunichar c,
                                     GError** error)
{
	ValadocCommentScanner * self;
	...
	if (self->priv->in_line_start) {
		...
		if (c == ((gunichar) '*')) {
			...
			if (self->priv->past_star) {
				self->priv->past_star = FALSE;
				if (c == ((gunichar) '\n')) {
					BALADOC_WIKI_SCANNER_CLASS (baladoc_comment_scanner_parent_class)->accept (G_TYPE_CHECK_INSTANCE_CAST (self, BALADOC_TYPE_WIKI_SCANNER, ValadocWikiScanner), c, &_inner_error0_);
...
static void
baladoc_comment_scanner_class_init (ValadocCommentScannerClass * klass,
                                    gpointer klass_data)
{
	...
	((ValadocWikiScannerClass *) klass)->reset = (void (*) (ValadocWikiScanner*)) baladoc_comment_scanner_real_reset;
	((ValadocWikiScannerClass *) klass)->get_line_start_column = (gint (*) (ValadocWikiScanner*)) baladoc_comment_scanner_real_get_line_start_column;
	((ValadocWikiScannerClass *) klass)->accept = (void (*) (ValadocWikiScanner*, gunichar, GError**)) baladoc_comment_scanner_real_accept;
	G_OBJECT_CLASS (klass)->finalize = baladoc_comment_scanner_finalize;
}

static void
baladoc_comment_scanner_instance_init (ValadocCommentScanner * self,
                                       gpointer klass)
{
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocCommentScannerClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_comment_scanner_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocCommentScanner), 0, (GInstanceInitFunc) baladoc_comment_scanner_instance_init, NULL };
	GType baladoc_comment_scanner_type_id;
	baladoc_comment_scanner_type_id = g_type_register_static (BALADOC_TYPE_WIKI_SCANNER, "ValadocCommentScanner", &g_define_type_info, 0);
	ValadocCommentScanner_private_offset = g_type_add_instance_private (baladoc_comment_scanner_type_id, sizeof (ValadocCommentScannerPrivate));
