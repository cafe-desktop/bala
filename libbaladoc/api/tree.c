/* tree.c generated by balac, the Vala compiler
...
static void baladoc_api_tree_set_wikitree (ValadocApiTree* self,
                                    ValadocWikiPageTree* value);
static void baladoc_api_tree_add_dependencies_to_source_package (ValadocApiTree* self);
G_GNUC_INTERNAL void baladoc_api_package_set_dependency_list (ValadocApiPackage* self,
                                              ValaArrayList* list);
static ValadocApiNode* baladoc_api_tree_search_relative_to (ValadocApiTree* self,
                                                     ValadocApiNode* element,
                                                     gchar** path,
                                                     gint path_length1);
static gchar** baladoc_api_tree_split_name (ValadocApiTree* self,
                                     const gchar* full_name,
                                     gint* result_length1);
static gchar* baladoc_api_tree_get_file_path (ValadocApiTree* self,
                                       const gchar* basename,
                                       gchar** directories,
                                       gint directories_length1);
static ValadocApiPackage* baladoc_api_tree_get_source_package (ValadocApiTree* self);
static void baladoc_api_tree_parse_wiki (ValadocApiTree* self,
                                  ValadocDocumentationParser* docparser);
static void baladoc_api_tree_check_wiki (ValadocApiTree* self,
                                  ValadocDocumentationParser* docparser);
...
G_GNUC_INTERNAL void baladoc_api_item_check_comments (ValadocApiItem* self,
                                      ValadocSettings* settings,
                                      ValadocDocumentationParser* parser);
static void baladoc_api_tree_postprocess_inheritdoc (ValadocApiTree* self,
                                              ValadocDocumentationParser* docparser);
G_GNUC_INTERNAL void baladoc_api_tree_register_inheritdoc (ValadocApiTree* self,
                                           ValadocApiNode* container,
                                           ValadocTagletsInheritDoc* taglet);
static ValadocApiTreeInheritDocContainer* baladoc_api_tree_inherit_doc_container_new (ValadocApiNode* taglet_container,
                                                                               ValadocTagletsInheritDoc* taglet);
static ValadocApiTreeInheritDocContainer* baladoc_api_tree_inherit_doc_container_construct (GType object_type,
                                                                                     ValadocApiNode* taglet_container,
                                                                                     ValadocTagletsInheritDoc* taglet);
static void baladoc_api_tree_inherit_doc_container_finalize (ValadocApiTreeInheritDocContainer * obj);
static GType baladoc_api_tree_inherit_doc_container_get_type_once (void);
static void baladoc_api_tree_finalize (ValadocApiTree * obj);
...
baladoc_api_tree_get_instance_private (ValadocApiTree* self)
{
	return G_STRUCT_MEMBER_P (self, ValadocApiTree_private_offset);
}

void
baladoc_api_tree_add_package (ValadocApiTree* self,
                              ValadocApiPackage* package)
{
	...
	bala_collection_add ((ValaCollection*) _tmp0_, package);
}

ValaCodeContext*
baladoc_api_tree_get_context (ValadocApiTree* self)
{
...
void
baladoc_api_tree_set_context (ValadocApiTree* self,
...
baladoc_api_tree_get_highlighter (ValadocApiTree* self)
{
...
ValadocWikiPageTree*
baladoc_api_tree_get_wikitree (ValadocApiTree* self)
{
...
static void
baladoc_api_tree_set_wikitree (ValadocApiTree* self,
                               ValadocWikiPageTree* value)
{
	ValadocWikiPageTree* _tmp0_;
	g_return_if_fail (self != NULL);
...
ValaCollection*
baladoc_api_tree_get_external_c_files (ValadocApiTree* self)
{
	ValaArrayList* _tmp0_;
...
void
baladoc_api_tree_add_external_c_files (ValadocApiTree* self,
                                       const gchar* name)
{
	ValaArrayList* _tmp0_;
	g_return_if_fail (self != NULL);
	...
	_tmp0_ = self->priv->external_c_files;
	bala_collection_add ((ValaCollection*) _tmp0_, name);
}
 ...
 */
ValaCollection*
baladoc_api_tree_get_package_list (ValadocApiTree* self)
{
	ValaArrayList* _tmp0_;
	ValaCollection* _tmp1_;
	ValaCollection* result = NULL;
...
static void
baladoc_api_tree_add_dependencies_to_source_package (ValadocApiTree* self)
{
 ...
 */
void
baladoc_api_tree_accept (ValadocApiTree* self,
 ...
 */
void
baladoc_api_tree_accept_children (ValadocApiTree* self,
                                  ValadocApiVisitor* visitor)
{
	g_return_if_fail (self != NULL);
	g_return_if_fail (visitor != NULL);
...
baladoc_api_tree_search_relative_to (ValadocApiTree* self,
                                     ValadocApiNode* element,
                                     gchar** path,
                                     gint path_length1)
{
	...
	if (_tmp7_ == NULL) {
		...
		_tmp8_ = baladoc_api_item_get_parent ((ValadocApiItem*) element);
		_tmp9_ = _tmp8_;
		_tmp6_ = _tmp9_ != NULL;
	} else {
		_tmp6_ = FALSE;
	...
	if (_tmp6_) {
		...
		_tmp10_ = baladoc_api_item_get_parent ((ValadocApiItem*) element);
		_tmp11_ = _tmp10_;
		_tmp12_ = baladoc_api_tree_search_relative_to (self, G_TYPE_CHECK_INSTANCE_CAST (_tmp11_, BALADOC_API_TYPE_NODE, ValadocApiNode), path, (gint) path_length1);
		_g_object_unref0 (node);
		node = _tmp12_;
	}
	result = node;
...
ValadocApiNode*
baladoc_api_tree_search_symbol_path (ValadocApiTree* self,
                                     ValadocApiNode* element,
                                     gchar** path,
                                     gint path_length1)
{
	...
	}
	{
		...
		while (TRUE) {
			...
			_tmp10_ = bala_list_get ((ValaList*) _tmp9_, _package_index);
			package = (ValadocApiPackage*) _tmp10_;
			_tmp11_ = package;
			_tmp12_ = baladoc_api_node_find_by_name ((ValadocApiNode*) _tmp11_, "");
			global = _tmp12_;
			_tmp13_ = global;
			if (_tmp13_ != NULL) {
...
baladoc_api_tree_search_symbol_type_cstr (ValadocApiTree* self,
                                          const gchar* cname)
{
...
ValadocApiNode*
baladoc_api_tree_search_symbol_cstr (ValadocApiTree* self,
                                     ValadocApiNode* element,
                                     const gchar* cname)
{
	ValadocCTypeResolver* _tmp0_;
...
ValadocApiNode*
baladoc_api_tree_search_symbol_str (ValadocApiTree* self,
                                    ValadocApiNode* element,
                                    const gchar* symname)
{
	gchar** path = NULL;
...
static gchar**
baladoc_api_tree_split_name (ValadocApiTree* self,
                             const gchar* full_name,
                             gint* result_length1)
{
	gchar** params = NULL;
...
ValadocApiTree*
baladoc_api_tree_new (ValadocErrorReporter* reporter,
                      ValadocSettings* settings,
                      ValaCodeContext* context)
{
...
static gchar*
baladoc_api_tree_get_file_path (ValadocApiTree* self,
                                const gchar* basename,
                                gchar** directories,
                                gint directories_length1)
{
...
gboolean
baladoc_api_tree_create_tree (ValadocApiTree* self)
{
...
baladoc_api_tree_get_source_package (ValadocApiTree* self)
{
	ValadocApiPackage* _tmp0_;
	ValadocApiPackage* _tmp15_;
	ValadocApiPackage* _tmp16_;
	...
	if (_tmp0_ == NULL) {
		{
			...
			while (TRUE) {
				...
				_tmp8_ = _pkg_list;
				_tmp9_ = bala_list_get ((ValaList*) _tmp8_, _pkg_index);
...
static void
baladoc_api_tree_parse_wiki (ValadocApiTree* self,
                             ValadocDocumentationParser* docparser)
{
	ValadocWikiPageTree* _tmp0_;
...
static void
baladoc_api_tree_check_wiki (ValadocApiTree* self,
                             ValadocDocumentationParser* docparser)
{
	ValadocApiPackage* pkg = NULL;
	ValadocApiPackage* _tmp0_;
...
void
baladoc_api_tree_parse_comments (ValadocApiTree* self,
                                 ValadocDocumentationParser* docparser)
{
	g_return_if_fail (self != NULL);
	g_return_if_fail (docparser != NULL);
	baladoc_api_tree_parse_wiki (self, docparser);
	{
		...
		while (TRUE) {
			...
			if (baladoc_api_node_is_browsable ((ValadocApiNode*) _tmp9_, _tmp10_)) {
				ValadocApiPackage* _tmp11_;
				ValadocSettings* _tmp12_;
				_tmp11_ = pkg;
				_tmp12_ = self->priv->settings;
				baladoc_api_item_parse_comments ((ValadocApiItem*) _tmp11_, _tmp12_, docparser);
			}
			_g_object_unref0 (pkg);
		}
		_bala_iterable_unref0 (_pkg_list);
...
void
baladoc_api_tree_check_comments (ValadocApiTree* self,
                                 ValadocDocumentationParser* docparser)
{
	g_return_if_fail (self != NULL);
	g_return_if_fail (docparser != NULL);
	baladoc_api_tree_check_wiki (self, docparser);
	{
		...
		while (TRUE) {
			...
			if (baladoc_api_node_is_browsable ((ValadocApiNode*) _tmp9_, _tmp10_)) {
				...
				_tmp11_ = pkg;
				_tmp12_ = self->priv->settings;
				baladoc_api_item_check_comments ((ValadocApiItem*) _tmp11_, _tmp12_, docparser);
...
baladoc_api_tree_register_inheritdoc (ValadocApiTree* self,
                                      ValadocApiNode* container,
                                      ValadocTagletsInheritDoc* taglet)
{
	ValaList* _tmp0_;
...
static void
baladoc_api_tree_postprocess_inheritdoc (ValadocApiTree* self,
                                         ValadocDocumentationParser* docparser)
{
	g_return_if_fail (self != NULL);
	g_return_if_fail (docparser != NULL);
	while (TRUE) {
		...
		_tmp0_ = self->priv->inheritdocs;
		_tmp1_ = bala_collection_get_is_empty ((ValaCollection*) _tmp0_);
		_tmp2_ = _tmp1_;
		if (!(!_tmp2_)) {
			break;
		}
 ...
 */
void
baladoc_api_tree_import_comments (ValadocApiTree* self,
				...
				imported = FALSE;
				{
					...
					for (importer_it = 0; importer_it < importer_collection_length1; importer_it = importer_it + 1) {
						...
						importer = _tmp4_;
						{
							...
							_tmp16_ = processed;
							_tmp17_ = path;
							if (!bala_collection_contains ((ValaCollection*) _tmp16_, _tmp17_)) {
...
static ValadocApiTreeInheritDocContainer*
baladoc_api_tree_inherit_doc_container_new (ValadocApiNode* taglet_container,
                                            ValadocTagletsInheritDoc* taglet)
{
...
static void
baladoc_api_tree_inherit_doc_container_class_init (ValadocApiTreeInheritDocContainerClass * klass,
                                                   gpointer klass_data)
{
	baladoc_api_tree_inherit_doc_container_parent_class = g_type_class_peek_parent (klass);
	((ValadocApiTreeInheritDocContainerClass *) klass)->finalize = baladoc_api_tree_inherit_doc_container_finalize;
}

static void
baladoc_api_tree_inherit_doc_container_instance_init (ValadocApiTreeInheritDocContainer * self,
                                                      gpointer klass)
{
	self->ref_count = 1;
}
...
static void
baladoc_api_tree_inherit_doc_container_finalize (ValadocApiTreeInheritDocContainer * obj)
{
...
baladoc_api_tree_inherit_doc_container_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (ValadocApiTreeInheritDocContainerClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_api_tree_inherit_doc_container_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocApiTreeInheritDocContainer), 0, (GInstanceInitFunc) baladoc_api_tree_inherit_doc_container_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType baladoc_api_tree_inherit_doc_container_type_id;
	baladoc_api_tree_inherit_doc_container_type_id = g_type_register_fundamental (g_type_fundamental_next (), "ValadocApiTreeInheritDocContainer", &g_define_type_info, &g_define_type_fundamental_info, 0);
...
static void
baladoc_api_tree_class_init (ValadocApiTreeClass * klass,
                             gpointer klass_data)
{
	baladoc_api_tree_parent_class = g_type_class_peek_parent (klass);
	((ValadocApiTreeClass *) klass)->finalize = baladoc_api_tree_finalize;
	g_type_class_adjust_private_offset (klass, &ValadocApiTree_private_offset);
}

static void
baladoc_api_tree_instance_init (ValadocApiTree * self,
                                gpointer klass)
{
	GEqualFunc _tmp0_;
	ValaArrayList* _tmp1_;
...
static void
baladoc_api_tree_finalize (ValadocApiTree * obj)
{
	ValadocApiTree * self;
...
baladoc_api_tree_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (ValadocApiTreeClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_api_tree_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocApiTree), 0, (GInstanceInitFunc) baladoc_api_tree_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType baladoc_api_tree_type_id;
	baladoc_api_tree_type_id = g_type_register_fundamental (g_type_fundamental_next (), "ValadocApiTree", &g_define_type_info, &g_define_type_fundamental_info, 0);
	ValadocApiTree_private_offset = g_type_add_instance_private (baladoc_api_tree_type_id, sizeof (ValadocApiTreePrivate));
