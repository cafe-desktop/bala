...
static GParamSpec* valadoc_api_property_properties[BALADOC_API_PROPERTY_NUM_PROPERTIES];
...
valadoc_api_property_new (ValadocApiNode* parent,
                          ...
                          ValaProperty* data)
{
	return valadoc_api_property_construct (BALADOC_API_TYPE_PROPERTY, parent, file, name, accessibility, comment, data);
}
                                        ...
                                        ValadocApiTypeReference* value)
{
	...
	if (old_value != value) {
		...
		g_object_notify_by_pspec ((GObject *) self, valadoc_api_property_properties[BALADOC_API_PROPERTY_PROPERTY_TYPE_PROPERTY]);
	}
}
...
valadoc_api_property_get_is_virtual (ValadocApiProperty* self)
{
	...
	_tmp1_ = _tmp0_;
	_tmp2_ = vala_property_get_is_virtual (G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, BALA_TYPE_PROPERTY, ValaProperty));
	_tmp3_ = _tmp2_;
	result = _tmp3_;
	return result;
}
...
valadoc_api_property_get_is_abstract (ValadocApiProperty* self)
{
	...
	_tmp0_ = valadoc_api_item_get_data ((ValadocApiItem*) self);
	_tmp1_ = _tmp0_;
	_tmp2_ = vala_property_get_is_abstract (G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, BALA_TYPE_PROPERTY, ValaProperty));
	_tmp3_ = _tmp2_;
	result = _tmp3_;
	return result;
}
...
valadoc_api_property_get_is_override (ValadocApiProperty* self)
{
	...
	_tmp0_ = valadoc_api_item_get_data ((ValadocApiItem*) self);
	_tmp1_ = _tmp0_;
	_tmp2_ = vala_property_get_overrides (G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, BALA_TYPE_PROPERTY, ValaProperty));
	_tmp3_ = _tmp2_;
	result = _tmp3_;
	return result;
}
                                          ...
                                          gboolean value)
{
	...
	if (old_value != value) {
		...
		g_object_notify_by_pspec ((GObject *) self, valadoc_api_property_properties[BALADOC_API_PROPERTY_IS_DBUS_VISIBLE_PROPERTY]);
	}
}
                                 ...
                                 ValadocApiPropertyAccessor* value)
{
	...
	if (old_value != value) {
		...
		g_object_notify_by_pspec ((GObject *) self, valadoc_api_property_properties[BALADOC_API_PROPERTY_SETTER_PROPERTY]);
	}
}
                                 ...
                                 ValadocApiPropertyAccessor* value)
{
	...
	if (old_value != value) {
		...
		g_object_notify_by_pspec ((GObject *) self, valadoc_api_property_properties[BALADOC_API_PROPERTY_GETTER_PROPERTY]);
	}
}
                                        ...
                                        ValadocApiProperty* value)
{
	...
	if (old_value != value) {
		...
		g_object_notify_by_pspec ((GObject *) self, valadoc_api_property_properties[BALADOC_API_PROPERTY_BASE_PROPERTY_PROPERTY]);
	}
}
                                          ...
                                          ValadocDocumentationParser* parser)
{
	...
	BALADOC_API_ITEM_CLASS (valadoc_api_property_parent_class)->parse_comments ((ValadocApiItem*) G_TYPE_CHECK_INSTANCE_CAST (self, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol), settings, parser);
}
                                          ...
                                          ValadocDocumentationParser* parser)
{
	...
	BALADOC_API_ITEM_CLASS (valadoc_api_property_parent_class)->check_comments ((ValadocApiItem*) G_TYPE_CHECK_INSTANCE_CAST (self, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol), settings, parser);
}
                                 ...
                                 gpointer klass_data)
{
	...
	BALADOC_API_NODE_CLASS (klass)->get_node_type = valadoc_api_property_real_get_node_type;
	 ...
	 * The property type.
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_PROPERTY_PROPERTY_TYPE_PROPERTY, valadoc_api_property_properties[BALADOC_API_PROPERTY_PROPERTY_TYPE_PROPERTY] = g_param_spec_object ("property-type", "property-type", "property-type", BALADOC_API_TYPE_TYPEREFERENCE, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE | G_PARAM_WRITABLE));
	/**
	 * Specifies whether the property is virtual.
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_PROPERTY_IS_VIRTUAL_PROPERTY, valadoc_api_property_properties[BALADOC_API_PROPERTY_IS_VIRTUAL_PROPERTY] = g_param_spec_boolean ("is-virtual", "is-virtual", "is-virtual", FALSE, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE));
	/**
	 * Specifies whether the property is abstract.
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_PROPERTY_IS_ABSTRACT_PROPERTY, valadoc_api_property_properties[BALADOC_API_PROPERTY_IS_ABSTRACT_PROPERTY] = g_param_spec_boolean ("is-abstract", "is-abstract", "is-abstract", FALSE, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE));
	/**
	 * Specifies whether the property is override.
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_PROPERTY_IS_OVERRIDE_PROPERTY, valadoc_api_property_properties[BALADOC_API_PROPERTY_IS_OVERRIDE_PROPERTY] = g_param_spec_boolean ("is-override", "is-override", "is-override", FALSE, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE));
	/**
	 * Specifies whether the property is visible.
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_PROPERTY_IS_DBUS_VISIBLE_PROPERTY, valadoc_api_property_properties[BALADOC_API_PROPERTY_IS_DBUS_VISIBLE_PROPERTY] = g_param_spec_boolean ("is-dbus-visible", "is-dbus-visible", "is-dbus-visible", FALSE, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE));
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_PROPERTY_SETTER_PROPERTY, valadoc_api_property_properties[BALADOC_API_PROPERTY_SETTER_PROPERTY] = g_param_spec_object ("setter", "setter", "setter", BALADOC_API_TYPE_PROPERTY_ACCESSOR, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE | G_PARAM_WRITABLE));
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_PROPERTY_GETTER_PROPERTY, valadoc_api_property_properties[BALADOC_API_PROPERTY_GETTER_PROPERTY] = g_param_spec_object ("getter", "getter", "getter", BALADOC_API_TYPE_PROPERTY_ACCESSOR, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE | G_PARAM_WRITABLE));
	/**
	 * Specifies the virtual or abstract property this property overrides.
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_PROPERTY_BASE_PROPERTY_PROPERTY, valadoc_api_property_properties[BALADOC_API_PROPERTY_BASE_PROPERTY_PROPERTY] = g_param_spec_object ("base-property", "base-property", "base-property", BALADOC_API_TYPE_PROPERTY, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE | G_PARAM_WRITABLE));
	/**
	 * {@inheritDoc}
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_PROPERTY_NODE_TYPE_PROPERTY, valadoc_api_property_properties[BALADOC_API_PROPERTY_NODE_TYPE_PROPERTY] = g_param_spec_enum ("node-type", "node-type", "node-type", BALADOC_API_TYPE_NODE_TYPE, 0, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE));
}
...
valadoc_api_property_get_type_once (void)
{
	...
	valadoc_api_property_type_id = g_type_register_static (BALADOC_API_TYPE_SYMBOL, "ValadocApiProperty", &g_define_type_info, 0);
