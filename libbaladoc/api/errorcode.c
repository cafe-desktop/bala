...
static GParamSpec* valadoc_api_error_code_properties[BALADOC_API_ERROR_CODE_NUM_PROPERTIES];
...
valadoc_api_error_code_new (ValadocApiErrorDomain* parent,
                            ...
                            ValaErrorCode* data)
{
	return valadoc_api_error_code_construct (BALADOC_API_TYPE_ERROR_CODE, parent, file, name, comment, data);
}
                                   ...
                                   gpointer klass_data)
{
	...
	BALADOC_API_NODE_CLASS (klass)->get_node_type = valadoc_api_error_code_real_get_node_type;
	 ...
	 * {@inheritDoc}
	 */
	g_object_class_install_property (G_OBJECT_CLASS (klass), BALADOC_API_ERROR_CODE_NODE_TYPE_PROPERTY, valadoc_api_error_code_properties[BALADOC_API_ERROR_CODE_NODE_TYPE_PROPERTY] = g_param_spec_enum ("node-type", "node-type", "node-type", BALADOC_API_TYPE_NODE_TYPE, 0, G_PARAM_STATIC_STRINGS | G_PARAM_READABLE));
}
...
valadoc_api_error_code_get_type_once (void)
{
	...
	valadoc_api_error_code_type_id = g_type_register_static (BALADOC_API_TYPE_SYMBOL, "ValadocApiErrorCode", &g_define_type_info, 0);
