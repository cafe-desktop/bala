/* pointer.c generated by balac, the Vala compiler
...
static ValadocContentInline* baladoc_api_pointer_real_build_signature (ValadocApiItem* base);
...
baladoc_api_pointer_get_instance_private (ValadocApiPointer* self)
{
	return G_STRUCT_MEMBER_P (self, ValadocApiPointer_private_offset);
}

ValadocApiItem*
baladoc_api_pointer_get_data_type (ValadocApiPointer* self)
{
...
void
baladoc_api_pointer_set_data_type (ValadocApiPointer* self,
                               ...
                               ValaPointerType* data)
{
	...
	self = (ValadocApiPointer*) baladoc_api_item_construct (object_type, (ValaCodeNode*) data);
	baladoc_api_item_set_parent ((ValadocApiItem*) self, parent);
	return self;
}

ValadocApiPointer*
baladoc_api_pointer_new (ValadocApiItem* parent,
                         ValaPointerType* data)
{
...
baladoc_api_pointer_real_build_signature (ValadocApiItem* base)
{
...
static void
baladoc_api_pointer_class_init (ValadocApiPointerClass * klass,
                                gpointer klass_data)
{
	...
	((ValadocApiItemClass *) klass)->build_signature = (ValadocContentInline* (*) (ValadocApiItem*)) baladoc_api_pointer_real_build_signature;
...
static void
baladoc_api_pointer_instance_init (ValadocApiPointer * self,
                                   gpointer klass)
{
...
{
	ValadocApiPointer * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALADOC_API_TYPE_POINTER, ValadocApiPointer);
	_g_object_unref0 (self->priv->_data_type);
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocApiPointerClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_api_pointer_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocApiPointer), 0, (GInstanceInitFunc) baladoc_api_pointer_instance_init, NULL };
	GType baladoc_api_pointer_type_id;
	baladoc_api_pointer_type_id = g_type_register_static (BALADOC_API_TYPE_ITEM, "ValadocApiPointer", &g_define_type_info, 0);
	ValadocApiPointer_private_offset = g_type_add_instance_private (baladoc_api_pointer_type_id, sizeof (ValadocApiPointerPrivate));
...
{
	ValadocApiPointer * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (object, BALADOC_API_TYPE_POINTER, ValadocApiPointer);
	switch (property_id) {
