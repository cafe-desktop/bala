/* class.c generated by balac, the Vala compiler
...
static gchar* _baladoc_api_class_get_private_cname (ValadocApiClass* self,
                                             ValaClass* element);
static void baladoc_api_class_set_is_fundamental (ValadocApiClass* self,
                                           gboolean value);
static void baladoc_api_class_set_is_abstract (ValadocApiClass* self,
                                        gboolean value);
static void baladoc_api_class_set_is_sealed (ValadocApiClass* self,
                                      gboolean value);
static void baladoc_api_class_real_accept (ValadocApiNode* base,
                                    ValadocApiVisitor* visitor);
static ValadocContentInline* baladoc_api_class_real_build_signature (ValadocApiItem* base);
...
baladoc_api_class_get_instance_private (ValadocApiClass* self)
{
                             ...
                             ValaClass* data)
{
	...
	if (_tmp2_ == NULL) {
		const gchar* _tmp3_;
		const gchar* _tmp4_;
		_tmp3_ = bala_symbol_get_name ((ValaSymbol*) data);
		_tmp4_ = _tmp3_;
	...
	self = (ValadocApiClass*) baladoc_api_typesymbol_construct (object_type, parent, file, name, accessibility, comment, is_basic_type, (ValaTypeSymbol*) data);
	...
	if (!_tmp8_) {
		...
		_tmp11_ = bala_get_ccode_type_get_function ((ValaObjectTypeSymbol*) data);
	...
	_tmp13_ = bala_gd_bus_module_get_dbus_name ((ValaTypeSymbol*) data);
	_g_free0 (self->priv->dbus_name);
	self->priv->dbus_name = _tmp13_;
	_tmp14_ = bala_get_ccode_type_id ((ValaCodeNode*) data);
	_g_free0 (self->priv->type_id);
	self->priv->type_id = _tmp14_;
	_tmp15_ = bala_get_ccode_name ((ValaCodeNode*) data);
	_g_free0 (self->priv->cname);
	self->priv->cname = _tmp15_;
	_tmp16_ = bala_get_ccode_param_spec_function ((ValaCodeNode*) data);
	_g_free0 (self->priv->param_spec_function_name);
	self->priv->param_spec_function_name = _tmp16_;
	_tmp17_ = bala_get_ccode_unref_function ((ValaObjectTypeSymbol*) data);
	_g_free0 (self->priv->unref_function_name);
	self->priv->unref_function_name = _tmp17_;
	_tmp18_ = bala_get_ccode_ref_function ((ValaTypeSymbol*) data);
	...
	if (bala_class_is_fundamental (data)) {
		...
		gchar* _tmp21_;
		gchar* _tmp22_;
		_tmp20_ = bala_get_ccode_lower_case_prefix ((ValaSymbol*) data);
		_tmp21_ = _tmp20_;
	...
	if (_tmp26_) {
		gchar* _tmp27_;
		_tmp27_ = bala_get_ccode_free_function ((ValaTypeSymbol*) data);
		_g_free0 (_tmp24_);
		_tmp24_ = _tmp27_;
	} else {
		_g_free0 (_tmp24_);
	...
	_tmp29_ = bala_get_ccode_take_value_function ((ValaCodeNode*) data);
	_g_free0 (self->priv->take_value_function_cname);
	self->priv->take_value_function_cname = _tmp29_;
	_tmp30_ = bala_get_ccode_get_value_function ((ValaCodeNode*) data);
	_g_free0 (self->priv->get_value_function_cname);
	self->priv->get_value_function_cname = _tmp30_;
	_tmp31_ = bala_get_ccode_set_value_function ((ValaCodeNode*) data);
...
ValadocApiClass*
baladoc_api_class_new (ValadocApiNode* parent,
                       ValadocApiSourceFile* file,
                       const gchar* name,
                       ValaSymbolAccessibility accessibility,
                       ValadocApiSourceComment* comment,
...
static gchar*
_baladoc_api_class_get_private_cname (ValadocApiClass* self,
                                      ValaClass* element)
{
	gboolean _tmp0_;
	gboolean _tmp1_;
	...
	_tmp2_ = bala_get_ccode_name ((ValaCodeNode*) element);
	cname = _tmp2_;
	_tmp4_ = cname;
	if (_tmp4_ != NULL) {
		const gchar* _tmp5_;
...
baladoc_api_class_get_base_type (ValadocApiClass* self)
{
...
void
baladoc_api_class_set_base_type (ValadocApiClass* self,
 ...
 */
gchar*
baladoc_api_class_get_cname (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_private_cname (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_type_id (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_ref_function_cname (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_unref_function_cname (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_free_function_name (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_finalize_function_name (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_param_spec_function_cname (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_set_value_function_cname (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_get_value_function_cname (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_take_value_function_cname (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_dbus_name (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_class_macro_name (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_class_type_macro_name (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
 ...
 */
gchar*
baladoc_api_class_get_is_class_type_macro_name (ValadocApiClass* self)
{
	const gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* result = NULL;
...
ValaCollection*
baladoc_api_class_get_implemented_interface_list (ValadocApiClass* self)
{
 ...
 */
ValaCollection*
baladoc_api_class_get_full_implemented_interface_list (ValadocApiClass* self)
{
...
void
baladoc_api_class_add_interface (ValadocApiClass* self,
...
gboolean
baladoc_api_class_get_is_abstract (ValadocApiClass* self)
{
	gboolean result;
...
static void
baladoc_api_class_set_is_abstract (ValadocApiClass* self,
                                   gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
...
gboolean
baladoc_api_class_get_is_sealed (ValadocApiClass* self)
{
	gboolean result;
	g_return_val_if_fail (self != NULL, FALSE);
...
static void
baladoc_api_class_set_is_sealed (ValadocApiClass* self,
                                 gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
...
gboolean
baladoc_api_class_get_is_fundamental (ValadocApiClass* self)
{
	gboolean result;
	g_return_val_if_fail (self != NULL, FALSE);
...
static void
baladoc_api_class_set_is_fundamental (ValadocApiClass* self,
                                      gboolean value)
{
	gboolean old_value;
	g_return_if_fail (self != NULL);
...
gboolean
baladoc_api_class_get_is_compact (ValadocApiClass* self)
{
	gboolean result;
	ValaCodeNode* _tmp0_;
	ValaCodeNode* _tmp1_;
	...
	_tmp1_ = _tmp0_;
	_tmp2_ = bala_class_get_is_compact (G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, BALA_TYPE_CLASS, ValaClass));
	_tmp3_ = _tmp2_;
	result = _tmp3_;
	return result;
}
...
baladoc_api_class_real_get_node_type (ValadocApiNode* base)
{
 ...
 */
static void
baladoc_api_class_real_accept (ValadocApiNode* base,
                               ValadocApiVisitor* visitor)
{
	ValadocApiClass * self;
	self = (ValadocApiClass*) base;
 ...
 */
ValaCollection*
baladoc_api_class_get_known_child_classes (ValadocApiClass* self)
{
	ValaSet* _tmp0_;
	ValaCollection* _tmp1_;
	ValaCollection* result = NULL;
 ...
 */
ValaCollection*
baladoc_api_class_get_known_derived_interfaces (ValadocApiClass* self)
{
	ValaSet* _tmp0_;
	ValaCollection* _tmp1_;
	ValaCollection* result = NULL;
...
void
baladoc_api_class_register_derived_interface (ValadocApiClass* self,
...
void
baladoc_api_class_register_child_class (ValadocApiClass* self,
                                        ValadocApiClass* cl)
{
	ValadocApiTypeReference* _tmp0_;
	ValaSet* _tmp4_;
	...
	if (_tmp0_ != NULL) {
		...
		_tmp3_ = _tmp2_;
		baladoc_api_class_register_child_class (G_TYPE_CHECK_INSTANCE_CAST (_tmp3_, BALADOC_API_TYPE_CLASS, ValadocApiClass), cl);
	}
	_tmp4_ = self->priv->_known_child_classes;
	bala_collection_add ((ValaCollection*) _tmp4_, cl);
}
...
baladoc_api_class_real_build_signature (ValadocApiItem* base)
{
	ValadocApiClass * self;
	...
	_tmp10_ = signature;
	baladoc_api_signature_builder_append_symbol (_tmp10_, (ValadocApiNode*) self, TRUE);
	_tmp11_ = baladoc_api_node_get_children_by_type ((ValadocApiNode*) self, BALADOC_API_NODE_TYPE_TYPE_PARAMETER, FALSE);
	...
	if (_tmp31_ != NULL) {
		...
		_tmp35_ = baladoc_api_item_get_signature ((ValadocApiItem*) _tmp34_);
		_tmp36_ = _tmp35_;
	...
	if (_tmp39_ > 0) {
		...
		}
		{
			...
			while (TRUE) {
				...
				_tmp49_ = bala_list_get ((ValaList*) _tmp48_, _implemented_interface_index);
...
static void
baladoc_api_class_class_init (ValadocApiClassClass * klass,
                              gpointer klass_data)
{
	...
	((ValadocApiNodeClass *) klass)->accept = (void (*) (ValadocApiNode*, ValadocApiVisitor*)) baladoc_api_class_real_accept;
	((ValadocApiItemClass *) klass)->build_signature = (ValadocContentInline* (*) (ValadocApiItem*)) baladoc_api_class_real_build_signature;
...
static void
baladoc_api_class_instance_init (ValadocApiClass * self,
                                 gpointer klass)
{
	GHashFunc _tmp0_;
	GEqualFunc _tmp1_;
...
{
	ValadocApiClass * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALADOC_API_TYPE_CLASS, ValadocApiClass);
	_bala_iterable_unref0 (self->priv->interfaces);
	_g_free0 (self->priv->dbus_name);
	_g_free0 (self->priv->take_value_function_cname);
	_g_free0 (self->priv->get_value_function_cname);
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocApiClassClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_api_class_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocApiClass), 0, (GInstanceInitFunc) baladoc_api_class_instance_init, NULL };
	GType baladoc_api_class_type_id;
	baladoc_api_class_type_id = g_type_register_static (BALADOC_API_TYPE_TYPESYMBOL, "ValadocApiClass", &g_define_type_info, 0);
	ValadocApiClass_private_offset = g_type_add_instance_private (baladoc_api_class_type_id, sizeof (ValadocApiClassPrivate));
...
{
	ValadocApiClass * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (object, BALADOC_API_TYPE_CLASS, ValadocApiClass);
	switch (property_id) {
