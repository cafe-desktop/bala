/* scanner.c generated by balac, the Vala compiler
...
void
baladoc_scanner_set_parser (ValadocScanner* self,
...
void
baladoc_scanner_reset (ValadocScanner* self)
{
	g_return_if_fail (self != NULL);
...
void
baladoc_scanner_scan (ValadocScanner* self,
                      const gchar* content,
                      GError** error)
{
	g_return_if_fail (self != NULL);
...
void
baladoc_scanner_end (ValadocScanner* self,
                     GError** error)
{
	g_return_if_fail (self != NULL);
...
void
baladoc_scanner_stop (ValadocScanner* self)
{
	g_return_if_fail (self != NULL);
...
gchar*
baladoc_scanner_get_line_content (ValadocScanner* self)
{
...
static void
baladoc_scanner_default_init (ValadocScannerIface * iface,
                              gpointer iface_data)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocScannerIface), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_scanner_default_init, (GClassFinalizeFunc) NULL, NULL, 0, 0, (GInstanceInitFunc) NULL, NULL };
	GType baladoc_scanner_type_id;
	baladoc_scanner_type_id = g_type_register_static (G_TYPE_INTERFACE, "ValadocScanner", &g_define_type_info, 0);
