/* manyrule.c generated by balac, the Vala compiler
...
#define BALADOC_MANY_RULE_STATE(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), BALADOC_MANY_RULE_TYPE_STATE, ValadocManyRuleState))
#define BALADOC_MANY_RULE_STATE_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST ((klass), BALADOC_MANY_RULE_TYPE_STATE, ValadocManyRuleStateClass))
...
#define BALADOC_MANY_RULE_STATE_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS ((obj), BALADOC_MANY_RULE_TYPE_STATE, ValadocManyRuleStateClass))
...
G_GNUC_INTERNAL ValadocManyRule* baladoc_many_rule_construct (GType object_type,
                                              GObject* scheme);
static gboolean baladoc_many_rule_real_is_optional (ValadocRule* base);
static gboolean baladoc_many_rule_real_starts_with_token (ValadocRule* base,
                                                   ValadocToken* token);
static gboolean baladoc_many_rule_real_accept_token (ValadocRule* base,
                                              ValadocToken* token,
...
static ValadocManyRuleState* baladoc_many_rule_state_new (void);
static ValadocManyRuleState* baladoc_many_rule_state_construct (GType object_type);
static gboolean baladoc_many_rule_real_would_accept_token (ValadocRule* base,
                                                    ValadocToken* token,
                                                    GObject* state);
static gboolean baladoc_many_rule_real_would_reduce (ValadocRule* base,
                                              ValadocToken* token,
                                              GObject* rule_state);
static gchar* baladoc_many_rule_real_to_string (ValadocRule* base,
                                         GObject* rule_state);
...
baladoc_many_rule_get_instance_private (ValadocManyRule* self)
{
                             ...
                             GObject* scheme)
{
	...
	self = (ValadocManyRule*) baladoc_rule_construct (object_type);
...
static gboolean
baladoc_many_rule_real_is_optional (ValadocRule* base)
{
	...
	result = baladoc_rule_is_optional_rule ((ValadocRule*) self, _tmp0_);
	return result;
}

static gboolean
baladoc_many_rule_real_starts_with_token (ValadocRule* base,
                                          ValadocToken* token)
{
	ValadocManyRule * self;
	GObject* _tmp0_;
	...
	_tmp0_ = self->priv->_scheme;
	if (baladoc_rule_has_start_token ((ValadocRule*) self, _tmp0_, token)) {
		result = TRUE;
		return result;
	}
	result = FALSE;
...
static gboolean
baladoc_many_rule_real_accept_token (ValadocRule* base,
                                     ValadocToken* token,
                                     ValadocParserCallback* parser,
                                     ValadocRuleForward forward,
                                     GError** error)
{
	...
	_tmp1_ = BALADOC_MANY_RULE_IS_STATE (_tmp0_) ? ((ValadocManyRuleState*) _tmp0_) : NULL;
	if (_tmp1_ == NULL) {
	...
	if (baladoc_parser_callback_would_parent_reduce_to_rule (parser, token, (ValadocRule*) self)) {
		baladoc_rule_do_reduce ((ValadocRule*) self, parser, &_inner_error0_);
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			if (_inner_error0_->domain == BALADOC_PARSER_ERROR) {
	...
	_tmp18_ = baladoc_rule_try_to_apply ((ValadocRule*) self, _tmp16_, token, parser, &_tmp17_, &_inner_error0_);
	handled = _tmp17_;
	_tmp15_ = _tmp18_;
	if (G_UNLIKELY (_inner_error0_ != NULL)) {
		if (_inner_error0_->domain == BALADOC_PARSER_ERROR) {
	...
	if (BALADOC_IS_TOKEN_TYPE (_tmp24_)) {
		...
		_tmp26_ = baladoc_token_type_to_pretty_string (G_TYPE_CHECK_INSTANCE_CAST (_tmp25_, BALADOC_TYPE_TOKEN_TYPE, ValadocTokenType));
...
static gboolean
baladoc_many_rule_real_would_accept_token (ValadocRule* base,
                                           ValadocToken* token,
                                           GObject* state)
{
	ValadocManyRule * self;
...
static gboolean
baladoc_many_rule_real_would_reduce (ValadocRule* base,
                                     ValadocToken* token,
                                     GObject* rule_state)
{
	ValadocManyRule * self;
	...
	self = (ValadocManyRule*) base;
	g_return_val_if_fail (token != NULL, FALSE);
	_tmp0_ = _g_object_ref0 (BALADOC_MANY_RULE_IS_STATE (rule_state) ? ((ValadocManyRuleState*) rule_state) : NULL);
	state = _tmp0_;
	_tmp2_ = state;
	if (_tmp2_->done_one) {
		_tmp1_ = TRUE;
		...
		_tmp1_ = baladoc_rule_is_optional_rule ((ValadocRule*) self, _tmp3_);
	}
	result = _tmp1_;
	_g_object_unref0 (state);
	return result;
...
static gchar*
baladoc_many_rule_real_to_string (ValadocRule* base,
                                  GObject* rule_state)
{
	ValadocManyRule * self;
	ValadocManyRuleState* state = NULL;
...
static void
baladoc_many_rule_state_class_init (ValadocManyRuleStateClass * klass,
                                    gpointer klass_data)
{
...
static void
baladoc_many_rule_state_instance_init (ValadocManyRuleState * self,
                                       gpointer klass)
{
	self->started = FALSE;
	self->done_one = FALSE;
...
baladoc_many_rule_state_finalize (GObject * obj)
{
	...
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALADOC_MANY_RULE_TYPE_STATE, ValadocManyRuleState);
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocManyRuleStateClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_many_rule_state_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocManyRuleState), 0, (GInstanceInitFunc) baladoc_many_rule_state_instance_init, NULL };
	GType baladoc_many_rule_state_type_id;
	baladoc_many_rule_state_type_id = g_type_register_static (G_TYPE_OBJECT, "ValadocManyRuleState", &g_define_type_info, 0);
...
static void
baladoc_many_rule_class_init (ValadocManyRuleClass * klass,
                              gpointer klass_data)
{
	...
	((ValadocRuleClass *) klass)->is_optional = (gboolean (*) (ValadocRule*)) baladoc_many_rule_real_is_optional;
	((ValadocRuleClass *) klass)->starts_with_token = (gboolean (*) (ValadocRule*, ValadocToken*)) baladoc_many_rule_real_starts_with_token;
	((ValadocRuleClass *) klass)->accept_token = (gboolean (*) (ValadocRule*, ValadocToken*, ValadocParserCallback*, ValadocRuleForward, GError**)) baladoc_many_rule_real_accept_token;
	((ValadocRuleClass *) klass)->would_accept_token = (gboolean (*) (ValadocRule*, ValadocToken*, GObject*)) baladoc_many_rule_real_would_accept_token;
	((ValadocRuleClass *) klass)->would_reduce = (gboolean (*) (ValadocRule*, ValadocToken*, GObject*)) baladoc_many_rule_real_would_reduce;
	((ValadocRuleClass *) klass)->to_string = (gchar* (*) (ValadocRule*, GObject*)) baladoc_many_rule_real_to_string;
	G_OBJECT_CLASS (klass)->finalize = baladoc_many_rule_finalize;
}

static void
baladoc_many_rule_instance_init (ValadocManyRule * self,
                                 gpointer klass)
{
...
{
	ValadocManyRule * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALADOC_TYPE_MANY_RULE, ValadocManyRule);
	_g_object_unref0 (self->priv->_scheme);
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocManyRuleClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_many_rule_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocManyRule), 0, (GInstanceInitFunc) baladoc_many_rule_instance_init, NULL };
	GType baladoc_many_rule_type_id;
	baladoc_many_rule_type_id = g_type_register_static (BALADOC_TYPE_RULE, "ValadocManyRule", &g_define_type_info, 0);
	ValadocManyRule_private_offset = g_type_add_instance_private (baladoc_many_rule_type_id, sizeof (ValadocManyRulePrivate));
