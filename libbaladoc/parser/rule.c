/* rule.c generated by balac, the Vala compiler
...
G_GNUC_INTERNAL ValadocSequenceRule* baladoc_sequence_rule_new (GObject** scheme,
                                                gint scheme_length1);
G_GNUC_INTERNAL ValadocSequenceRule* baladoc_sequence_rule_construct (GType object_type,
                                                      GObject** scheme,
                                                      gint scheme_length1);
...
G_GNUC_INTERNAL ValadocManyRule* baladoc_many_rule_new (GObject* scheme);
G_GNUC_INTERNAL ValadocManyRule* baladoc_many_rule_construct (GType object_type,
                                              GObject* scheme);
G_GNUC_INTERNAL GType baladoc_many_rule_get_type (void) G_GNUC_CONST G_GNUC_UNUSED;
G_GNUC_INTERNAL ValadocOptionalRule* baladoc_optional_rule_new (GObject* scheme);
G_GNUC_INTERNAL ValadocOptionalRule* baladoc_optional_rule_construct (GType object_type,
                                                      GObject* scheme);
...
static void ___lambda7__baladoc_rule_action (gpointer self,
                                      GError** error);
static gboolean baladoc_rule_real_is_optional (ValadocRule* self);
static gboolean baladoc_rule_real_starts_with_token (ValadocRule* self,
                                              ValadocToken* token);
static gboolean baladoc_rule_real_accept_token (ValadocRule* self,
                                         ValadocToken* token,
                                         ValadocParserCallback* parser,
                                         ValadocRuleForward forward,
                                         GError** error);
static gboolean baladoc_rule_real_would_accept_token (ValadocRule* self,
                                               ValadocToken* token,
                                               GObject* state);
static gboolean baladoc_rule_real_would_reduce (ValadocRule* self,
                                         ValadocToken* token,
                                         GObject* state);
static gchar* baladoc_rule_real_to_string (ValadocRule* self,
                                    GObject* state);
...
baladoc_rule_get_instance_private (ValadocRule* self)
{
...
baladoc_rule_forward_get_type_once (void)
{
	...
	baladoc_rule_forward_type_id = g_enum_register_static ("ValadocRuleForward", values);
...
const gchar*
baladoc_rule_get_name (ValadocRule* self)
{
	const gchar* result;
	const gchar* _tmp0_;
...
ValadocRule*
baladoc_rule_set_name (ValadocRule* self,
                       const gchar* name)
{
	gchar* _tmp0_;
	ValadocRule* _tmp1_;
...
ValadocRule*
baladoc_rule_set_start (ValadocRule* self,
                        ValadocRuleAction action,
                        gpointer action_target)
{
	Block3Data* _data3_;
...
ValadocRule*
baladoc_rule_set_reduce (ValadocRule* self,
                         ValadocRuleAction action,
                         gpointer action_target)
{
	Block4Data* _data4_;
...
ValadocRule*
baladoc_rule_set_skip (ValadocRule* self,
                       ValadocRuleAction action,
                       gpointer action_target)
{
	Block5Data* _data5_;
...
static gboolean
baladoc_rule_real_is_optional (ValadocRule* self)
{
...
gboolean
baladoc_rule_is_optional (ValadocRule* self)
{
...
static gboolean
baladoc_rule_real_starts_with_token (ValadocRule* self,
                                     ValadocToken* token)
{
	gboolean _tmp0_ = FALSE;
...
gboolean
baladoc_rule_starts_with_token (ValadocRule* self,
                                ValadocToken* token)
{
	g_return_val_if_fail (self != NULL, FALSE);
...
static gboolean
baladoc_rule_real_accept_token (ValadocRule* self,
                                ValadocToken* token,
                                ValadocParserCallback* parser,
                                ValadocRuleForward forward,
                                GError** error)
...
gboolean
baladoc_rule_accept_token (ValadocRule* self,
                           ValadocToken* token,
                           ValadocParserCallback* parser,
                           ValadocRuleForward forward,
                           GError** error)
...
static gboolean
baladoc_rule_real_would_accept_token (ValadocRule* self,
                                      ValadocToken* token,
                                      GObject* state)
{
	gboolean _tmp0_ = FALSE;
...
gboolean
baladoc_rule_would_accept_token (ValadocRule* self,
                                 ValadocToken* token,
                                 GObject* state)
{
	g_return_val_if_fail (self != NULL, FALSE);
...
static gboolean
baladoc_rule_real_would_reduce (ValadocRule* self,
                                ValadocToken* token,
                                GObject* state)
{
	gboolean _tmp0_ = FALSE;
...
gboolean
baladoc_rule_would_reduce (ValadocRule* self,
                           ValadocToken* token,
                           GObject* state)
{
	g_return_val_if_fail (self != NULL, FALSE);
...
static gchar*
baladoc_rule_real_to_string (ValadocRule* self,
                             GObject* state)
{
...
gchar*
baladoc_rule_to_string (ValadocRule* self,
                        GObject* state)
{
	g_return_val_if_fail (self != NULL, NULL);
...
gboolean
baladoc_rule_is_optional_rule (ValadocRule* self,
...
gboolean
baladoc_rule_has_start_token (ValadocRule* self,
                              GObject* scheme_element,
                              ValadocToken* token)
{
...
gboolean
baladoc_rule_try_to_apply (ValadocRule* self,
                           GObject* scheme_element,
                           ValadocToken* token,
                           ValadocParserCallback* parser,
                           gboolean* handled,
...
void
baladoc_rule_do_start (ValadocRule* self,
                       ValadocParserCallback* parser,
                       GError** error)
{
...
void
baladoc_rule_do_reduce (ValadocRule* self,
                        ValadocParserCallback* parser,
                        GError** error)
{
	ValadocRuleAction _tmp0_;
...
void
baladoc_rule_do_skip (ValadocRule* self,
                      ValadocParserCallback* parser,
                      GError** error)
{
	ValadocRuleAction _tmp0_;
...
static void
baladoc_rule_class_init (ValadocRuleClass * klass,
                         gpointer klass_data)
{
	...
	((ValadocRuleClass *) klass)->is_optional = (gboolean (*) (ValadocRule*)) baladoc_rule_real_is_optional;
	((ValadocRuleClass *) klass)->starts_with_token = (gboolean (*) (ValadocRule*, ValadocToken*)) baladoc_rule_real_starts_with_token;
	((ValadocRuleClass *) klass)->accept_token = (gboolean (*) (ValadocRule*, ValadocToken*, ValadocParserCallback*, ValadocRuleForward, GError**)) baladoc_rule_real_accept_token;
	((ValadocRuleClass *) klass)->would_accept_token = (gboolean (*) (ValadocRule*, ValadocToken*, GObject*)) baladoc_rule_real_would_accept_token;
	((ValadocRuleClass *) klass)->would_reduce = (gboolean (*) (ValadocRule*, ValadocToken*, GObject*)) baladoc_rule_real_would_reduce;
	((ValadocRuleClass *) klass)->to_string = (gchar* (*) (ValadocRule*, GObject*)) baladoc_rule_real_to_string;
...
static void
baladoc_rule_instance_init (ValadocRule * self,
                            gpointer klass)
{
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocRuleClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_rule_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocRule), 0, (GInstanceInitFunc) baladoc_rule_instance_init, NULL };
	GType baladoc_rule_type_id;
	baladoc_rule_type_id = g_type_register_static (G_TYPE_OBJECT, "ValadocRule", &g_define_type_info, G_TYPE_FLAG_ABSTRACT);
	ValadocRule_private_offset = g_type_add_instance_private (baladoc_rule_type_id, sizeof (ValadocRulePrivate));
