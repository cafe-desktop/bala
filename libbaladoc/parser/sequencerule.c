/* sequencerule.c generated by balac, the Vala compiler
...
#define BALADOC_SEQUENCE_RULE_STATE(obj) (G_TYPE_CHECK_INSTANCE_CAST ((obj), BALADOC_SEQUENCE_RULE_TYPE_STATE, ValadocSequenceRuleState))
#define BALADOC_SEQUENCE_RULE_STATE_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST ((klass), BALADOC_SEQUENCE_RULE_TYPE_STATE, ValadocSequenceRuleStateClass))
...
#define BALADOC_SEQUENCE_RULE_STATE_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS ((obj), BALADOC_SEQUENCE_RULE_TYPE_STATE, ValadocSequenceRuleStateClass))
...
static GObject** _bala_array_dup3 (GObject** self,
                            gint length);
static gboolean baladoc_sequence_rule_real_is_optional (ValadocRule* base);
static gboolean baladoc_sequence_rule_real_starts_with_token (ValadocRule* base,
                                                       ValadocToken* token);
static gboolean baladoc_sequence_rule_test_token (ValadocSequenceRule* self,
                                           gint from_index,
                                           ValadocToken* token);
static gboolean baladoc_sequence_rule_test_reduce (ValadocSequenceRule* self,
                                            gint from_index,
                                            ValadocToken* token);
static gboolean baladoc_sequence_rule_real_accept_token (ValadocRule* base,
                                                  ValadocToken* token,
...
static ValadocSequenceRuleState* baladoc_sequence_rule_state_new (void);
static ValadocSequenceRuleState* baladoc_sequence_rule_state_construct (GType object_type);
static gboolean baladoc_sequence_rule_real_would_accept_token (ValadocRule* base,
                                                        ValadocToken* token,
                                                        GObject* rule_state);
static gboolean baladoc_sequence_rule_real_would_reduce (ValadocRule* base,
                                                  ValadocToken* token,
                                                  GObject* rule_state);
static gchar* baladoc_sequence_rule_real_to_string (ValadocRule* base,
                                             GObject* rule_state);
...
baladoc_sequence_rule_get_instance_private (ValadocSequenceRule* self)
{
                                 ...
                                 gint scheme_length1)
{
	...
	GObject** _tmp0_;
	gint _tmp0__length1;
	self = (ValadocSequenceRule*) baladoc_rule_construct (object_type);
...
static gboolean
baladoc_sequence_rule_real_is_optional (ValadocRule* base)
{
...
static gboolean
baladoc_sequence_rule_real_starts_with_token (ValadocRule* base,
                                              ValadocToken* token)
{
	ValadocSequenceRule * self;
	gboolean result = FALSE;
...
static gboolean
baladoc_sequence_rule_test_token (ValadocSequenceRule* self,
                                  gint from_index,
                                  ValadocToken* token)
{
	gint i = 0;
	...
	while (TRUE) {
		...
		_tmp4_ = _tmp3_[i];
		if (!baladoc_rule_is_optional_rule ((ValadocRule*) self, _tmp4_)) {
			break;
		}
		_tmp5_ = i;
		i = _tmp5_ + 1;
...
static gboolean
baladoc_sequence_rule_test_reduce (ValadocSequenceRule* self,
                                   gint from_index,
                                   ValadocToken* token)
{
	gint i = 0;
	...
	while (TRUE) {
		...
		_tmp1__length1 = self->priv->_scheme_length1;
		_tmp2_ = _tmp1_[i];
		if (!baladoc_rule_is_optional_rule ((ValadocRule*) self, _tmp2_)) {
			result = FALSE;
			return result;
		}
		_tmp3_ = i;
...
static gboolean
baladoc_sequence_rule_real_accept_token (ValadocRule* base,
                                         ValadocToken* token,
                                         ValadocParserCallback* parser,
                                         ValadocRuleForward forward,
                                         GError** error)
{
	...
	_tmp1_ = BALADOC_SEQUENCE_RULE_IS_STATE (_tmp0_) ? ((ValadocSequenceRuleState*) _tmp0_) : NULL;
	if (_tmp1_ == NULL) {
	...
	scheme_element = NULL;
	{
		...
		while (TRUE) {
			...
			_tmp22_ = baladoc_rule_try_to_apply ((ValadocRule*) self, _tmp20_, token, parser, &_tmp21_, &_inner_error0_);
			handled = _tmp21_;
			_tmp19_ = _tmp22_;
			if (G_UNLIKELY (_inner_error0_ != NULL)) {
				if (_inner_error0_->domain == BALADOC_PARSER_ERROR) {
			...
			if (!baladoc_rule_is_optional_rule ((ValadocRule*) self, _tmp27_)) {
				break;
			} else {
				GObject* _tmp28_;
				_tmp28_ = scheme_element;
				baladoc_rule_do_skip (G_TYPE_CHECK_INSTANCE_CAST (_tmp28_, BALADOC_TYPE_RULE, ValadocRule), parser, &_inner_error0_);
				if (G_UNLIKELY (_inner_error0_ != NULL)) {
					if (_inner_error0_->domain == BALADOC_PARSER_ERROR) {
	...
	if (BALADOC_IS_TOKEN_TYPE (_tmp37_)) {
		...
		_tmp39_ = baladoc_token_type_to_pretty_string (G_TYPE_CHECK_INSTANCE_CAST (_tmp38_, BALADOC_TYPE_TOKEN_TYPE, ValadocTokenType));
...
static gboolean
baladoc_sequence_rule_real_would_accept_token (ValadocRule* base,
                                               ValadocToken* token,
                                               GObject* rule_state)
{
	ValadocSequenceRule * self;
	...
	self = (ValadocSequenceRule*) base;
	g_return_val_if_fail (token != NULL, FALSE);
	_tmp0_ = _g_object_ref0 (BALADOC_SEQUENCE_RULE_IS_STATE (rule_state) ? ((ValadocSequenceRuleState*) rule_state) : NULL);
	state = _tmp0_;
...
static gboolean
baladoc_sequence_rule_real_would_reduce (ValadocRule* base,
                                         ValadocToken* token,
                                         GObject* rule_state)
{
	ValadocSequenceRule * self;
...
static gchar*
baladoc_sequence_rule_real_to_string (ValadocRule* base,
                                      GObject* rule_state)
{
	ValadocSequenceRule * self;
	ValadocSequenceRuleState* state = NULL;
...
static void
baladoc_sequence_rule_state_class_init (ValadocSequenceRuleStateClass * klass,
                                        gpointer klass_data)
{
...
static void
baladoc_sequence_rule_state_instance_init (ValadocSequenceRuleState * self,
                                           gpointer klass)
{
	self->index = 0;
}
...
baladoc_sequence_rule_state_finalize (GObject * obj)
{
	...
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALADOC_SEQUENCE_RULE_TYPE_STATE, ValadocSequenceRuleState);
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocSequenceRuleStateClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_sequence_rule_state_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocSequenceRuleState), 0, (GInstanceInitFunc) baladoc_sequence_rule_state_instance_init, NULL };
	GType baladoc_sequence_rule_state_type_id;
	baladoc_sequence_rule_state_type_id = g_type_register_static (G_TYPE_OBJECT, "ValadocSequenceRuleState", &g_define_type_info, 0);
...
static void
baladoc_sequence_rule_class_init (ValadocSequenceRuleClass * klass,
                                  gpointer klass_data)
{
	...
	((ValadocRuleClass *) klass)->is_optional = (gboolean (*) (ValadocRule*)) baladoc_sequence_rule_real_is_optional;
	((ValadocRuleClass *) klass)->starts_with_token = (gboolean (*) (ValadocRule*, ValadocToken*)) baladoc_sequence_rule_real_starts_with_token;
	((ValadocRuleClass *) klass)->accept_token = (gboolean (*) (ValadocRule*, ValadocToken*, ValadocParserCallback*, ValadocRuleForward, GError**)) baladoc_sequence_rule_real_accept_token;
	((ValadocRuleClass *) klass)->would_accept_token = (gboolean (*) (ValadocRule*, ValadocToken*, GObject*)) baladoc_sequence_rule_real_would_accept_token;
	((ValadocRuleClass *) klass)->would_reduce = (gboolean (*) (ValadocRule*, ValadocToken*, GObject*)) baladoc_sequence_rule_real_would_reduce;
	((ValadocRuleClass *) klass)->to_string = (gchar* (*) (ValadocRule*, GObject*)) baladoc_sequence_rule_real_to_string;
	G_OBJECT_CLASS (klass)->finalize = baladoc_sequence_rule_finalize;
}

static void
baladoc_sequence_rule_instance_init (ValadocSequenceRule * self,
                                     gpointer klass)
{
...
{
	ValadocSequenceRule * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALADOC_TYPE_SEQUENCE_RULE, ValadocSequenceRule);
	self->priv->_scheme = (_bala_array_free (self->priv->_scheme, self->priv->_scheme_length1, (GDestroyNotify) g_object_unref), NULL);
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocSequenceRuleClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_sequence_rule_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocSequenceRule), 0, (GInstanceInitFunc) baladoc_sequence_rule_instance_init, NULL };
	GType baladoc_sequence_rule_type_id;
	baladoc_sequence_rule_type_id = g_type_register_static (BALADOC_TYPE_RULE, "ValadocSequenceRule", &g_define_type_info, 0);
	ValadocSequenceRule_private_offset = g_type_add_instance_private (baladoc_sequence_rule_type_id, sizeof (ValadocSequenceRulePrivate));
