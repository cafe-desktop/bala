/* resourcelocator.c generated by balac, the Vala compiler
...
gchar*
baladoc_resource_locator_resolve (ValadocResourceLocator* self,
                                  const gchar* path)
{
...
static void
baladoc_resource_locator_default_init (ValadocResourceLocatorIface * iface,
                                       gpointer iface_data)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocResourceLocatorIface), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_resource_locator_default_init, (GClassFinalizeFunc) NULL, NULL, 0, 0, (GInstanceInitFunc) NULL, NULL };
	GType baladoc_resource_locator_type_id;
	baladoc_resource_locator_type_id = g_type_register_static (G_TYPE_INTERFACE, "ValadocResourceLocator", &g_define_type_info, 0);
