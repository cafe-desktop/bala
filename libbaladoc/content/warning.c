...
static GParamSpec* valadoc_content_warning_properties[BALADOC_CONTENT_WARNING_NUM_PROPERTIES];
...
{
	return valadoc_content_warning_construct (BALADOC_CONTENT_TYPE_WARNING);
}
                                    ...
                                    ValadocSettings* settings)
{
	...
	BALADOC_CONTENT_CONTENT_ELEMENT_CLASS (valadoc_content_warning_parent_class)->check ((ValadocContentContentElement*) G_TYPE_CHECK_INSTANCE_CAST (self, BALADOC_CONTENT_TYPE_BLOCK_CONTENT, ValadocContentBlockContent), api_root, container, file_path, reporter, settings);
}
...
valadoc_content_warning_get_type_once (void)
{
	...
	valadoc_content_warning_type_id = g_type_register_static (BALADOC_CONTENT_TYPE_BLOCK_CONTENT, "ValadocContentWarning", &g_define_type_info, 0);
	g_type_add_interface_static (valadoc_content_warning_type_id, BALADOC_CONTENT_TYPE_BLOCK, &valadoc_content_block_info);
