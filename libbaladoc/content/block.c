/* block.c generated by balac, the Vala compiler
...
static void
baladoc_content_block_default_init (ValadocContentBlockIface * iface,
                                    gpointer iface_data)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocContentBlockIface), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_content_block_default_init, (GClassFinalizeFunc) NULL, NULL, 0, 0, (GInstanceInitFunc) NULL, NULL };
	GType baladoc_content_block_type_id;
	baladoc_content_block_type_id = g_type_register_static (G_TYPE_INTERFACE, "ValadocContentBlock", &g_define_type_info, 0);
