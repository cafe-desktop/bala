/* wikilink.c generated by balac, the Vala compiler
...
static ValadocContentInlineIface * baladoc_content_wiki_link_baladoc_content_inline_parent_iface = NULL;

G_GNUC_INTERNAL void baladoc_content_wiki_link_set_page (ValadocContentWikiLink* self,
...
static void baladoc_content_wiki_link_real_check (ValadocContentContentElement* base,
                                           ValadocApiTree* api_root,
                                           ValadocApiNode* container,
                                           const gchar* file_path,
                                           ValadocErrorReporter* reporter,
                                           ValadocSettings* settings);
static void baladoc_content_wiki_link_real_accept (ValadocContentContentElement* base,
                                            ValadocContentContentVisitor* visitor);
static gboolean baladoc_content_wiki_link_real_is_empty (ValadocContentContentElement* base);
static ValadocContentContentElement* baladoc_content_wiki_link_real_copy (ValadocContentContentElement* base,
...
baladoc_content_wiki_link_get_instance_private (ValadocContentWikiLink* self)
{
	return G_STRUCT_MEMBER_P (self, ValadocContentWikiLink_private_offset);
}

ValadocWikiPage*
baladoc_content_wiki_link_get_page (ValadocContentWikiLink* self)
{
...
baladoc_content_wiki_link_set_page (ValadocContentWikiLink* self,
                                    ValadocWikiPage* value)
{
...
const gchar*
baladoc_content_wiki_link_get_name (ValadocContentWikiLink* self)
{
	const gchar* result;
	const gchar* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
void
baladoc_content_wiki_link_set_name (ValadocContentWikiLink* self,
                                    const gchar* value)
{
	gchar* old_value;
	g_return_if_fail (self != NULL);
...
baladoc_content_wiki_link_construct (GType object_type)
{
	...
	self = (ValadocContentWikiLink*) baladoc_content_inline_content_construct (object_type);
	return self;
}
...
static void
baladoc_content_wiki_link_real_check (ValadocContentContentElement* base,
                                      ValadocApiTree* api_root,
                                      ValadocApiNode* container,
                                      const gchar* file_path,
                                      ValadocErrorReporter* reporter,
                                      ValadocSettings* settings)
{
	...
	BALADOC_CONTENT_CONTENT_ELEMENT_CLASS (baladoc_content_wiki_link_parent_class)->check ((ValadocContentContentElement*) G_TYPE_CHECK_INSTANCE_CAST (self, BALADOC_CONTENT_TYPE_INLINE_CONTENT, ValadocContentInlineContent), api_root, container, file_path, reporter, settings);
...
static void
baladoc_content_wiki_link_real_accept (ValadocContentContentElement* base,
                                       ValadocContentContentVisitor* visitor)
{
	ValadocContentWikiLink * self;
	self = (ValadocContentWikiLink*) base;
...
static gboolean
baladoc_content_wiki_link_real_is_empty (ValadocContentContentElement* base)
{
	ValadocContentWikiLink * self;
...
baladoc_content_wiki_link_real_copy (ValadocContentContentElement* base,
                                     ValadocContentContentElement* new_parent)
{
	ValadocContentWikiLink * self;
...
static void
baladoc_content_wiki_link_class_init (ValadocContentWikiLinkClass * klass,
                                      gpointer klass_data)
{
	...
	((ValadocContentContentElementClass *) klass)->check = (void (*) (ValadocContentContentElement*, ValadocApiTree*, ValadocApiNode*, const gchar*, ValadocErrorReporter*, ValadocSettings*)) baladoc_content_wiki_link_real_check;
	((ValadocContentContentElementClass *) klass)->accept = (void (*) (ValadocContentContentElement*, ValadocContentContentVisitor*)) baladoc_content_wiki_link_real_accept;
	((ValadocContentContentElementClass *) klass)->is_empty = (gboolean (*) (ValadocContentContentElement*)) baladoc_content_wiki_link_real_is_empty;
	((ValadocContentContentElementClass *) klass)->copy = (ValadocContentContentElement* (*) (ValadocContentContentElement*, ValadocContentContentElement*)) baladoc_content_wiki_link_real_copy;
...
static void
baladoc_content_wiki_link_baladoc_content_inline_interface_init (ValadocContentInlineIface * iface,
                                                                 gpointer iface_data)
{
...
static void
baladoc_content_wiki_link_instance_init (ValadocContentWikiLink * self,
                                         gpointer klass)
{
...
{
	ValadocContentWikiLink * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALADOC_CONTENT_TYPE_WIKI_LINK, ValadocContentWikiLink);
	_g_object_unref0 (self->priv->_page);
	_g_free0 (self->priv->_name);
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocContentWikiLinkClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_content_wiki_link_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocContentWikiLink), 0, (GInstanceInitFunc) baladoc_content_wiki_link_instance_init, NULL };
	...
	baladoc_content_wiki_link_type_id = g_type_register_static (BALADOC_CONTENT_TYPE_INLINE_CONTENT, "ValadocContentWikiLink", &g_define_type_info, 0);
	g_type_add_interface_static (baladoc_content_wiki_link_type_id, BALADOC_CONTENT_TYPE_INLINE, &baladoc_content_inline_info);
	ValadocContentWikiLink_private_offset = g_type_add_instance_private (baladoc_content_wiki_link_type_id, sizeof (ValadocContentWikiLinkPrivate));
...
{
	ValadocContentWikiLink * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (object, BALADOC_CONTENT_TYPE_WIKI_LINK, ValadocContentWikiLink);
	switch (property_id) {
