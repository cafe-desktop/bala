/* codetoken.c generated by balac, the Vala compiler
...
static void baladoc_highlighter_code_token_set_token_type (ValadocHighlighterCodeToken* self,
                                                    ValadocHighlighterCodeTokenType value);
static void baladoc_highlighter_code_token_set_content (ValadocHighlighterCodeToken* self,
                                                 const gchar* value);
static void baladoc_highlighter_code_token_finalize (ValadocHighlighterCodeToken * obj);
static GType baladoc_highlighter_code_token_get_type_once (void);

static inline gpointer
baladoc_highlighter_code_token_get_instance_private (ValadocHighlighterCodeToken* self)
{
	return G_STRUCT_MEMBER_P (self, ValadocHighlighterCodeToken_private_offset);
}

ValadocHighlighterCodeTokenType
baladoc_highlighter_code_token_get_token_type (ValadocHighlighterCodeToken* self)
{
...
static void
baladoc_highlighter_code_token_set_token_type (ValadocHighlighterCodeToken* self,
                                               ValadocHighlighterCodeTokenType value)
{
...
const gchar*
baladoc_highlighter_code_token_get_content (ValadocHighlighterCodeToken* self)
{
	const gchar* result;
	const gchar* _tmp0_;
...
static void
baladoc_highlighter_code_token_set_content (ValadocHighlighterCodeToken* self,
                                            const gchar* value)
{
	gchar* _tmp0_;
	g_return_if_fail (self != NULL);
...
ValadocHighlighterCodeToken*
baladoc_highlighter_code_token_new (ValadocHighlighterCodeTokenType type,
                                    const gchar* content)
{
...
static void
baladoc_highlighter_code_token_class_init (ValadocHighlighterCodeTokenClass * klass,
                                           gpointer klass_data)
{
	baladoc_highlighter_code_token_parent_class = g_type_class_peek_parent (klass);
	((ValadocHighlighterCodeTokenClass *) klass)->finalize = baladoc_highlighter_code_token_finalize;
	g_type_class_adjust_private_offset (klass, &ValadocHighlighterCodeToken_private_offset);
}

static void
baladoc_highlighter_code_token_instance_init (ValadocHighlighterCodeToken * self,
                                              gpointer klass)
{
...
static void
baladoc_highlighter_code_token_finalize (ValadocHighlighterCodeToken * obj)
{
	ValadocHighlighterCodeToken * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALADOC_HIGHLIGHTER_TYPE_CODE_TOKEN, ValadocHighlighterCodeToken);
...
baladoc_highlighter_code_token_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (ValadocHighlighterCodeTokenClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_highlighter_code_token_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocHighlighterCodeToken), 0, (GInstanceInitFunc) baladoc_highlighter_code_token_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType baladoc_highlighter_code_token_type_id;
	baladoc_highlighter_code_token_type_id = g_type_register_fundamental (g_type_fundamental_next (), "ValadocHighlighterCodeToken", &g_define_type_info, &g_define_type_fundamental_info, 0);
	ValadocHighlighterCodeToken_private_offset = g_type_add_instance_private (baladoc_highlighter_code_token_type_id, sizeof (ValadocHighlighterCodeTokenPrivate));
...
const gchar*
baladoc_highlighter_code_token_type_to_string (ValadocHighlighterCodeTokenType self)
{
...
baladoc_highlighter_code_token_type_get_type_once (void)
{
	...
	baladoc_highlighter_code_token_type_type_id = g_enum_register_static ("ValadocHighlighterCodeTokenType", values);
