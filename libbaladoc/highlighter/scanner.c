...
baladoc_highlighter_scanner_next (ValadocHighlighterScanner* self)
{
...
static void
baladoc_highlighter_scanner_default_init (ValadocHighlighterScannerIface * iface,
                                          gpointer iface_data)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocHighlighterScannerIface), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_highlighter_scanner_default_init, (GClassFinalizeFunc) NULL, NULL, 0, 0, (GInstanceInitFunc) NULL, NULL };
	GType baladoc_highlighter_scanner_type_id;
	baladoc_highlighter_scanner_type_id = g_type_register_static (G_TYPE_INTERFACE, "ValadocHighlighterScanner", &g_define_type_info, 0);
