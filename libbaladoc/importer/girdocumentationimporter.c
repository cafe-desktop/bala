/* girdocumentationimporter.c generated by balac, the Vala compiler
...
static void baladoc_importer_gir_documentation_importer_real_process (ValadocImporterDocumentationImporter* base,
                                                               const gchar* source_file);
static void baladoc_importer_gir_documentation_importer_next (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_error (ValadocImporterGirDocumentationImporter* self,
                                                        const gchar* message);
static void baladoc_importer_gir_documentation_importer_parse_repository (ValadocImporterGirDocumentationImporter* self);
static ValadocApiParameter* baladoc_importer_gir_documentation_importer_find_parameter (ValadocImporterGirDocumentationImporter* self,
                                                                                 ValadocApiNode* node,
                                                                                 const gchar* name);
static inline gchar* baladoc_importer_gir_documentation_importer_get_cparameter_name (ValadocImporterGirDocumentationImporter* self,
                                                                        gchar** param_names,
...
static ValadocImporterGirDocumentationImporterImplicitParameterPos* baladoc_importer_gir_documentation_importer_implicit_parameter_pos_dup (const ValadocImporterGirDocumentationImporterImplicitParameterPos* self);
static void baladoc_importer_gir_documentation_importer_implicit_parameter_pos_free (ValadocImporterGirDocumentationImporterImplicitParameterPos* self);
static void baladoc_importer_gir_documentation_importer_attach_comment (ValadocImporterGirDocumentationImporter* self,
                                                                 const gchar* cname,
...
G_GNUC_INTERNAL void baladoc_api_parameter_set_implicit_destroy_cparameter_name (ValadocApiParameter* self,
                                                                 const gchar* value);
G_GNUC_INTERNAL void baladoc_api_parameter_set_implicit_closure_cparameter_name (ValadocApiParameter* self,
                                                                 const gchar* value);
G_GNUC_INTERNAL void baladoc_api_parameter_set_implicit_array_length_cparameter_name (ValadocApiParameter* self,
                                                                      const gchar* value);
...
static void baladoc_importer_gir_documentation_importer_warning (ValadocImporterGirDocumentationImporter* self,
                                                          const gchar* message);
static void baladoc_importer_gir_documentation_importer_start_element (ValadocImporterGirDocumentationImporter* self,
                                                                const gchar* name);
static void baladoc_importer_gir_documentation_importer_end_element (ValadocImporterGirDocumentationImporter* self,
                                                              const gchar* name);
static void baladoc_importer_gir_documentation_importer_parse_namespace (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_include (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_package (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_c_include (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_skip_element (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_alias (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_enumeration (ValadocImporterGirDocumentationImporter* self,
                                                                    const gchar* element_name);
static void baladoc_importer_gir_documentation_importer_parse_bitfield (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_method (ValadocImporterGirDocumentationImporter* self,
                                                               const gchar* element_name);
static void baladoc_importer_gir_documentation_importer_parse_callback (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_record (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_class (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_interface (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_boxed (ValadocImporterGirDocumentationImporter* self,
                                                              const gchar* element_name);
static void baladoc_importer_gir_documentation_importer_parse_union (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_constant (ValadocImporterGirDocumentationImporter* self);
static ValadocApiGirSourceComment* baladoc_importer_gir_documentation_importer_parse_symbol_doc (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_type (ValadocImporterGirDocumentationImporter* self,
                                                             gint* array_length_pos);
static ValadocApiSourceComment* baladoc_importer_gir_documentation_importer_parse_doc (ValadocImporterGirDocumentationImporter* self,
                                                                                const gchar* element_name);
static void baladoc_importer_gir_documentation_importer_parse_enumeration_member (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_return_value (ValadocImporterGirDocumentationImporter* self,
                                                                     ValadocApiSourceComment* * comment,
                                                                     gint* array_length_ret);
static void baladoc_importer_gir_documentation_importer_parse_parameter (ValadocImporterGirDocumentationImporter* self,
                                                                  ValadocApiSourceComment* * comment,
                                                                  gchar* * param_name,
                                                                  gint* destroy_pos,
                                                                  gint* closure_pos,
                                                                  gint* array_length_pos);
static void baladoc_importer_gir_documentation_importer_parse_field (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_constructor (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_property (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_signal (ValadocImporterGirDocumentationImporter* self);
static void baladoc_importer_gir_documentation_importer_parse_function (ValadocImporterGirDocumentationImporter* self,
                                                                 const gchar* element_name);
static void _bala_array_add3 (gchar** * array,
                       gint* length,
                       gint* size,
                       gchar* value);
static void baladoc_importer_gir_documentation_importer_implicit_parameter_pos_init (ValadocImporterGirDocumentationImporterImplicitParameterPos *self,
                                                                              gint parameter,
                                                                              gint position);
static void _bala_array_add4 (ValadocImporterGirDocumentationImporterImplicitParameterPos* * array,
                       gint* length,
                       gint* size,
                       const ValadocImporterGirDocumentationImporterImplicitParameterPos* value);
static void _bala_array_add5 (ValadocImporterGirDocumentationImporterImplicitParameterPos* * array,
                       gint* length,
                       gint* size,
                       const ValadocImporterGirDocumentationImporterImplicitParameterPos* value);
static void _bala_array_add6 (ValadocImporterGirDocumentationImporterImplicitParameterPos* * array,
                       gint* length,
                       gint* size,
                       const ValadocImporterGirDocumentationImporterImplicitParameterPos* value);
...
baladoc_importer_gir_documentation_importer_get_instance_private (ValadocImporterGirDocumentationImporter* self)
{
	return G_STRUCT_MEMBER_P (self, ValadocImporterGirDocumentationImporter_private_offset);
}

static const gchar*
baladoc_importer_gir_documentation_importer_real_get_file_extension (ValadocImporterDocumentationImporter* base)
{
	const gchar* result;
                                                       ...
                                                       ValadocErrorReporter* reporter)
{
	...
	self = (ValadocImporterGirDocumentationImporter*) baladoc_importer_documentation_importer_construct (object_type, tree, modules, settings);
...
ValadocImporterGirDocumentationImporter*
baladoc_importer_gir_documentation_importer_new (ValadocApiTree* tree,
                                                 ValadocDocumentationParser* parser,
                                                 ValadocModuleLoader* modules,
                                                 ValadocSettings* settings,
                                                 ValadocErrorReporter* reporter)
...
static void
baladoc_importer_gir_documentation_importer_real_process (ValadocImporterDocumentationImporter* base,
                                                          const gchar* source_file)
{
	ValadocImporterGirDocumentationImporter * self;
...
baladoc_importer_gir_documentation_importer_find_parameter (ValadocImporterGirDocumentationImporter* self,
                                                            ValadocApiNode* node,
                                                            const gchar* name)
{
	...
	parameters = _tmp0_;
	{
		...
		while (TRUE) {
			...
			_tmp10_ = param;
			_tmp11_ = baladoc_api_node_get_name ((ValadocApiNode*) G_TYPE_CHECK_INSTANCE_CAST (_tmp10_, BALADOC_API_TYPE_PARAMETER, ValadocApiParameter));
			_tmp12_ = _tmp11_;
			if (g_strcmp0 (_tmp12_, name) == 0) {
				ValadocApiNode* _tmp13_;
				ValadocApiParameter* _tmp14_;
				_tmp13_ = param;
				_tmp14_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp13_, BALADOC_API_TYPE_PARAMETER, ValadocApiParameter));
				result = _tmp14_;
...
static inline gchar*
baladoc_importer_gir_documentation_importer_get_cparameter_name (ValadocImporterGirDocumentationImporter* self,
                                                                 gchar** param_names,
                                                                 gint param_names_length1,
                                                                 gint length_pos)
{
...
static void
baladoc_importer_gir_documentation_importer_attach_comment (ValadocImporterGirDocumentationImporter* self,
                                                            const gchar* cname,
                                                            ValadocApiGirSourceComment* comment,
                                                            gchar** param_names,
                                                            gint param_names_length1,
                                                            ...
                                                            gint array_length_ret)
{
	...
	if (param_names != NULL) {
		...
		if (BALADOC_API_IS_CALLABLE (_tmp30_)) {
			...
			_tmp33_ = _tmp32_;
			baladoc_api_callable_set_implicit_array_length_cparameter_name (G_TYPE_CHECK_INSTANCE_CAST (_tmp31_, BALADOC_API_TYPE_CALLABLE, ValadocApiCallable), _tmp33_);
			_g_free0 (_tmp33_);
		}
	}
	_tmp34_ = self->priv->parser;
	_tmp35_ = node;
	_tmp36_ = baladoc_documentation_parser_parse (_tmp34_, _tmp35_, (ValadocApiSourceComment*) comment);
	content = _tmp36_;
	_tmp37_ = content;
	if (_tmp37_ == NULL) {
...
static void
baladoc_importer_gir_documentation_importer_warning (ValadocImporterGirDocumentationImporter* self,
                                                     const gchar* message)
{
	...
	_tmp5_ = bala_source_reference_new (G_TYPE_CHECK_INSTANCE_CAST (_tmp2_, BALA_TYPE_SOURCE_FILE, ValaSourceFile), &_tmp3_, &_tmp4_);
	_tmp6_ = _tmp5_;
...
static void
baladoc_importer_gir_documentation_importer_error (ValadocImporterGirDocumentationImporter* self,
                                                   const gchar* message)
{
	ValadocApiSourceFile* _tmp0_;
	ValaSourceFile* _tmp1_;
...
static void
baladoc_importer_gir_documentation_importer_next (ValadocImporterGirDocumentationImporter* self)
{
...
static void
baladoc_importer_gir_documentation_importer_start_element (ValadocImporterGirDocumentationImporter* self,
                                                           const gchar* name)
{
	gboolean _tmp0_ = FALSE;
...
static void
baladoc_importer_gir_documentation_importer_end_element (ValadocImporterGirDocumentationImporter* self,
                                                         const gchar* name)
{
	gboolean _tmp0_ = FALSE;
	ValaMarkupTokenType _tmp1_;
...
static void
baladoc_importer_gir_documentation_importer_parse_repository (ValadocImporterGirDocumentationImporter* self)
{
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
	gchar* _tmp2_;
...
static void
baladoc_importer_gir_documentation_importer_parse_include (ValadocImporterGirDocumentationImporter* self)
{
	g_return_if_fail (self != NULL);
...
static void
baladoc_importer_gir_documentation_importer_parse_package (ValadocImporterGirDocumentationImporter* self)
{
	g_return_if_fail (self != NULL);
...
static void
baladoc_importer_gir_documentation_importer_parse_c_include (ValadocImporterGirDocumentationImporter* self)
{
	g_return_if_fail (self != NULL);
...
static void
baladoc_importer_gir_documentation_importer_skip_element (ValadocImporterGirDocumentationImporter* self)
{
	gint level = 0;
	g_return_if_fail (self != NULL);
	baladoc_importer_gir_documentation_importer_next (self);
...
static void
baladoc_importer_gir_documentation_importer_parse_namespace (ValadocImporterGirDocumentationImporter* self)
{
	g_return_if_fail (self != NULL);
...
static void
baladoc_importer_gir_documentation_importer_parse_alias (ValadocImporterGirDocumentationImporter* self)
{
...
baladoc_importer_gir_documentation_importer_parse_symbol_doc (ValadocImporterGirDocumentationImporter* self)
{
	ValadocApiGirSourceComment* comment = NULL;
...
baladoc_importer_gir_documentation_importer_parse_doc (ValadocImporterGirDocumentationImporter* self,
                                                       const gchar* element_name)
{
	ValaMarkupReader* _tmp0_;
	const gchar* _tmp1_;
...
static void
baladoc_importer_gir_documentation_importer_parse_enumeration (ValadocImporterGirDocumentationImporter* self,
                                                               const gchar* element_name)
{
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
...
static void
baladoc_importer_gir_documentation_importer_parse_bitfield (ValadocImporterGirDocumentationImporter* self)
{
	g_return_if_fail (self != NULL);
...
static void
baladoc_importer_gir_documentation_importer_parse_enumeration_member (ValadocImporterGirDocumentationImporter* self)
{
	gchar* c_identifier = NULL;
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
...
static void
baladoc_importer_gir_documentation_importer_parse_return_value (ValadocImporterGirDocumentationImporter* self,
                                                                ValadocApiSourceComment* * comment,
                                                                gint* array_length_ret)
{
	ValadocApiSourceComment* _bala_comment = NULL;
	...
	_bala_comment = (ValadocApiSourceComment*) _tmp0_;
...
static void
baladoc_importer_gir_documentation_importer_parse_parameter (ValadocImporterGirDocumentationImporter* self,
                                                             ValadocApiSourceComment* * comment,
                                                             gchar* * param_name,
                                                             gint* destroy_pos,
                                                             gint* closure_pos,
                                                             gint* array_length_pos)
{
	...
	_baladoc_api_source_comment_unref0 (_bala_comment);
	_bala_comment = (ValadocApiSourceComment*) _tmp10_;
...
static void
baladoc_importer_gir_documentation_importer_parse_type (ValadocImporterGirDocumentationImporter* self,
                                                        gint* array_length_pos)
{
	gint _bala_array_length_pos = 0;
	ValaMarkupReader* _tmp0_;
...
static void
baladoc_importer_gir_documentation_importer_parse_record (ValadocImporterGirDocumentationImporter* self)
{
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
	const gchar* _tmp2_;
...
static void
baladoc_importer_gir_documentation_importer_parse_class (ValadocImporterGirDocumentationImporter* self)
{
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
	const gchar* _tmp2_;
...
static void
baladoc_importer_gir_documentation_importer_parse_interface (ValadocImporterGirDocumentationImporter* self)
{
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
	const gchar* _tmp2_;
...
static void
baladoc_importer_gir_documentation_importer_parse_field (ValadocImporterGirDocumentationImporter* self)
{
	gchar* c_identifier = NULL;
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
...
static void
baladoc_importer_gir_documentation_importer_parse_property (ValadocImporterGirDocumentationImporter* self)
{
	gchar* c_identifier = NULL;
	const gchar* _tmp0_;
	ValaMarkupReader* _tmp1_;
...
static void
baladoc_importer_gir_documentation_importer_parse_callback (ValadocImporterGirDocumentationImporter* self)
{
	g_return_if_fail (self != NULL);
...
static void
baladoc_importer_gir_documentation_importer_parse_constructor (ValadocImporterGirDocumentationImporter* self)
{
	g_return_if_fail (self != NULL);
...
static void
_bala_array_add4 (ValadocImporterGirDocumentationImporterImplicitParameterPos* * array,
                  gint* length,
                  gint* size,
                  const ValadocImporterGirDocumentationImporterImplicitParameterPos* value)
{
...
static void
_bala_array_add5 (ValadocImporterGirDocumentationImporterImplicitParameterPos* * array,
                  gint* length,
                  gint* size,
                  const ValadocImporterGirDocumentationImporterImplicitParameterPos* value)
{
...
static void
_bala_array_add6 (ValadocImporterGirDocumentationImporterImplicitParameterPos* * array,
                  gint* length,
                  gint* size,
                  const ValadocImporterGirDocumentationImporterImplicitParameterPos* value)
{
...
static void
baladoc_importer_gir_documentation_importer_parse_function (ValadocImporterGirDocumentationImporter* self,
                                                            const gchar* element_name)
{
	gchar* c_identifier = NULL;
	const gchar* _tmp0_;
...
static void
baladoc_importer_gir_documentation_importer_parse_method (ValadocImporterGirDocumentationImporter* self,
                                                          const gchar* element_name)
{
	g_return_if_fail (self != NULL);
	g_return_if_fail (element_name != NULL);
...
static void
baladoc_importer_gir_documentation_importer_parse_signal (ValadocImporterGirDocumentationImporter* self)
{
	g_return_if_fail (self != NULL);
...
static void
baladoc_importer_gir_documentation_importer_parse_boxed (ValadocImporterGirDocumentationImporter* self,
                                                         const gchar* element_name)
{
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
...
static void
baladoc_importer_gir_documentation_importer_parse_union (ValadocImporterGirDocumentationImporter* self)
{
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
	const gchar* _tmp2_;
...
static void
baladoc_importer_gir_documentation_importer_parse_constant (ValadocImporterGirDocumentationImporter* self)
{
	gchar* c_identifier = NULL;
	ValaMarkupReader* _tmp0_;
	gchar* _tmp1_;
...
static void
baladoc_importer_gir_documentation_importer_implicit_parameter_pos_init (ValadocImporterGirDocumentationImporterImplicitParameterPos *self,
                                                                         gint parameter,
                                                                         gint position)
{
...
baladoc_importer_gir_documentation_importer_implicit_parameter_pos_dup (const ValadocImporterGirDocumentationImporterImplicitParameterPos* self)
{
...
static void
baladoc_importer_gir_documentation_importer_implicit_parameter_pos_free (ValadocImporterGirDocumentationImporterImplicitParameterPos* self)
{
	g_free (self);
}
...
baladoc_importer_gir_documentation_importer_implicit_parameter_pos_get_type_once (void)
{
	...
	baladoc_importer_gir_documentation_importer_implicit_parameter_pos_type_id = g_boxed_type_register_static ("ValadocImporterGirDocumentationImporterImplicitParameterPos", (GBoxedCopyFunc) baladoc_importer_gir_documentation_importer_implicit_parameter_pos_dup, (GBoxedFreeFunc) baladoc_importer_gir_documentation_importer_implicit_parameter_pos_free);
...
static void
baladoc_importer_gir_documentation_importer_class_init (ValadocImporterGirDocumentationImporterClass * klass,
                                                        gpointer klass_data)
{
	...
	((ValadocImporterDocumentationImporterClass *) klass)->process = (void (*) (ValadocImporterDocumentationImporter*, const gchar*)) baladoc_importer_gir_documentation_importer_real_process;
...
static void
baladoc_importer_gir_documentation_importer_instance_init (ValadocImporterGirDocumentationImporter * self,
                                                           gpointer klass)
{
...
{
	ValadocImporterGirDocumentationImporter * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALADOC_IMPORTER_TYPE_GIR_DOCUMENTATION_IMPORTER, ValadocImporterGirDocumentationImporter);
	_bala_markup_reader_unref0 (self->priv->reader);
	_g_object_unref0 (self->priv->parser);
	_g_object_unref0 (self->priv->file);
	_g_free0 (self->priv->parent_c_identifier);
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValadocImporterGirDocumentationImporterClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) baladoc_importer_gir_documentation_importer_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValadocImporterGirDocumentationImporter), 0, (GInstanceInitFunc) baladoc_importer_gir_documentation_importer_instance_init, NULL };
	GType baladoc_importer_gir_documentation_importer_type_id;
	baladoc_importer_gir_documentation_importer_type_id = g_type_register_static (BALADOC_IMPORTER_TYPE_DOCUMENTATION_IMPORTER, "ValadocImporterGirDocumentationImporter", &g_define_type_info, 0);
	ValadocImporterGirDocumentationImporter_private_offset = g_type_add_instance_private (baladoc_importer_gir_documentation_importer_type_id, sizeof (ValadocImporterGirDocumentationImporterPrivate));
...
{
	ValadocImporterGirDocumentationImporter * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (object, BALADOC_IMPORTER_TYPE_GIR_DOCUMENTATION_IMPORTER, ValadocImporterGirDocumentationImporter);
	switch (property_id) {
