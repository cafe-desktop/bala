/* balaccodecompiler.c generated by balac, the Vala compiler
...
static void bala_ccode_compiler_finalize (ValaCCodeCompiler * obj);
...
void
bala_ccode_compiler_compile (ValaCCodeCompiler* self,
	...
	if (!_tmp128_) {
		{
			...
			while (TRUE) {
				...
				ValaSourceFileType _tmp139_;
				ValaSourceFileType _tmp140_;
				_file_index = _file_index + 1;
...
static void
bala_ccode_compiler_class_init (ValaCCodeCompilerClass * klass,
                                gpointer klass_data)
{
	bala_ccode_compiler_parent_class = g_type_class_peek_parent (klass);
	((ValaCCodeCompilerClass *) klass)->finalize = bala_ccode_compiler_finalize;
}

static void
bala_ccode_compiler_instance_init (ValaCCodeCompiler * self,
                                   gpointer klass)
{
	self->ref_count = 1;
}
...
static void
bala_ccode_compiler_finalize (ValaCCodeCompiler * obj)
{
...
bala_ccode_compiler_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (ValaCCodeCompilerClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_ccode_compiler_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaCCodeCompiler), 0, (GInstanceInitFunc) bala_ccode_compiler_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType bala_ccode_compiler_type_id;
	bala_ccode_compiler_type_id = g_type_register_fundamental (g_type_fundamental_next (), "ValaCCodeCompiler", &g_define_type_info, &g_define_type_fundamental_info, 0);
