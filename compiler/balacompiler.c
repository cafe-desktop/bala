/* balacompiler.c generated by balac, the Vala compiler
...
static ValaReportColored bala_compiler_colored_output;
static ValaReportColored bala_compiler_colored_output = BALA_REPORT_COLORED_AUTO;
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC (ValaCompiler, bala_compiler_unref)
...
static gboolean bala_compiler_option_parse_color (const gchar* option_name,
                                           ...
                                           void* data,
                                           GError** error);
static gint bala_compiler_quit (ValaCompiler* self);
static gint bala_compiler_run (ValaCompiler* self);
static gint bala_compiler_run_source (gchar** args,
                               gint args_length1);
G_GNUC_INTERNAL ValaCompiler* bala_compiler_new (void);
G_GNUC_INTERNAL ValaCompiler* bala_compiler_construct (GType object_type);
...
static gint bala_compiler_main (gchar** args,
                         gint args_length1);
static void bala_compiler_finalize (ValaCompiler * obj);
...
bala_compiler_get_instance_private (ValaCompiler* self)
{
...
static gint
bala_compiler_quit (ValaCompiler* self)
{
...
static gint
bala_compiler_run (ValaCompiler* self)
{
	...
	if (_tmp162_ == BALA_PROFILE_GOBJECT) {
		...
		_tmp165_ = _tmp164_;
		bala_code_context_set_codegen (_tmp163_, (ValaCodeGenerator*) _tmp165_);
		...
		_tmp168_ = _tmp167_;
		bala_code_context_set_codegen (_tmp166_, (ValaCodeGenerator*) _tmp168_);
...
static void
bala_compiler_class_init (ValaCompilerClass * klass,
                          gpointer klass_data)
{
	bala_compiler_parent_class = g_type_class_peek_parent (klass);
	((ValaCompilerClass *) klass)->finalize = bala_compiler_finalize;
	g_type_class_adjust_private_offset (klass, &ValaCompiler_private_offset);
}

static void
bala_compiler_instance_init (ValaCompiler * self,
                             gpointer klass)
{
...
static void
bala_compiler_finalize (ValaCompiler * obj)
{
	ValaCompiler * self;
...
bala_compiler_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (ValaCompilerClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_compiler_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaCompiler), 0, (GInstanceInitFunc) bala_compiler_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType bala_compiler_type_id;
	bala_compiler_type_id = g_type_register_fundamental (g_type_fundamental_next (), "ValaCompiler", &g_define_type_info, &g_define_type_fundamental_info, 0);
	ValaCompiler_private_offset = g_type_add_instance_private (bala_compiler_type_id, sizeof (ValaCompilerPrivate));
