...
{
	return vala_floating_type_construct (BALA_TYPE_FLOATING_TYPE, type_symbol);
}
...
vala_floating_type_real_copy (ValaDataType* base)
{
	...
	_tmp1_ = _tmp0_;
	_tmp2_ = vala_floating_type_new (G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, BALA_TYPE_STRUCT, ValaStruct));
	_result_ = _tmp2_;
...
vala_floating_type_get_type_once (void)
{
	...
	vala_floating_type_type_id = g_type_register_static (BALA_TYPE_VALUE_TYPE, "ValaFloatingType", &g_define_type_info, 0);
