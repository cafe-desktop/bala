/* balalambdaexpression.c generated by balac, the Vala compiler
...
static void bala_lambda_expression_real_accept (ValaCodeNode* base,
                                         ValaCodeVisitor* visitor);
static void bala_lambda_expression_real_accept_children (ValaCodeNode* base,
                                                  ValaCodeVisitor* visitor);
static gboolean bala_lambda_expression_real_is_pure (ValaExpression* base);
static gboolean bala_lambda_expression_real_check (ValaCodeNode* base,
                                            ValaCodeContext* context);
static void bala_lambda_expression_real_emit (ValaCodeNode* base,
                                       ValaCodeGenerator* codegen);
static void bala_lambda_expression_real_get_used_variables (ValaCodeNode* base,
                                                     ValaCollection* collection);
static void bala_lambda_expression_finalize (ValaCodeNode * obj);
static GType bala_lambda_expression_get_type_once (void);

static inline gpointer
bala_lambda_expression_get_instance_private (ValaLambdaExpression* self)
{
	return G_STRUCT_MEMBER_P (self, ValaLambdaExpression_private_offset);
}

ValaExpression*
bala_lambda_expression_get_expression_body (ValaLambdaExpression* self)
{
...
void
bala_lambda_expression_set_expression_body (ValaLambdaExpression* self,
...
ValaBlock*
bala_lambda_expression_get_statement_body (ValaLambdaExpression* self)
{
	ValaBlock* result;
	ValaBlock* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
void
bala_lambda_expression_set_statement_body (ValaLambdaExpression* self,
                                           ValaBlock* value)
{
	ValaBlock* _tmp0_;
	ValaBlock* _tmp1_;
...
ValaMethod*
bala_lambda_expression_get_method (ValaLambdaExpression* self)
{
	ValaMethod* result;
	ValaMethod* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
void
bala_lambda_expression_set_method (ValaLambdaExpression* self,
                                   ValaMethod* value)
{
	ValaMethod* _tmp0_;
	g_return_if_fail (self != NULL);
                                  ...
                                  ValaSourceReference* source_reference)
{
	...
	self = (ValaLambdaExpression*) bala_expression_construct (object_type);
...
ValaLambdaExpression*
bala_lambda_expression_new (ValaExpression* expression_body,
                            ValaSourceReference* source_reference)
{
...
ValaLambdaExpression*
bala_lambda_expression_new_with_statement_body (ValaBlock* statement_body,
                                                ValaSourceReference* source_reference)
{
 ...
 */
void
bala_lambda_expression_add_parameter (ValaLambdaExpression* self,
                                      ValaParameter* param)
{
	ValaList* _tmp0_;
	g_return_if_fail (self != NULL);
 ...
 */
ValaList*
bala_lambda_expression_get_parameters (ValaLambdaExpression* self)
{
	ValaList* _tmp0_;
...
static void
bala_lambda_expression_real_accept (ValaCodeNode* base,
                                    ValaCodeVisitor* visitor)
{
...
static void
bala_lambda_expression_real_accept_children (ValaCodeNode* base,
                                             ValaCodeVisitor* visitor)
{
	ValaLambdaExpression * self;
	ValaMethod* _tmp0_;
...
static gboolean
bala_lambda_expression_real_is_pure (ValaExpression* base)
{
	ValaLambdaExpression * self;
...
static gboolean
bala_lambda_expression_real_check (ValaCodeNode* base,
                                   ValaCodeContext* context)
{
	ValaLambdaExpression * self;
	gboolean _tmp0_;
	...
	if (!BALA_IS_DELEGATE_TYPE (_tmp5_)) {
		...
		if (_tmp7_ != NULL) {
			...
			_tmp9_ = _tmp8_;
			_tmp10_ = bala_expression_get_target_type ((ValaExpression*) self);
			_tmp11_ = _tmp10_;
	...
	_tmp18_ = bala_expression_get_target_type ((ValaExpression*) self);
	_tmp19_ = _tmp18_;
	_tmp20_ = bala_delegate_type_get_delegate_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp19_, BALA_TYPE_DELEGATE_TYPE, ValaDelegateType));
	_tmp21_ = _tmp20_;
	_tmp22_ = _bala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp21_, BALA_TYPE_DELEGATE, ValaDelegate));
	cb = _tmp22_;
	_tmp23_ = cb;
	_tmp24_ = bala_callable_get_return_type ((ValaCallable*) _tmp23_);
	_tmp25_ = _tmp24_;
	_tmp26_ = bala_expression_get_target_type ((ValaExpression*) self);
	_tmp27_ = _tmp26_;
	_tmp28_ = bala_data_type_get_actual_type (_tmp25_, _tmp27_, NULL, (ValaCodeNode*) self);
	return_type = _tmp28_;
	...
	bala_symbol_set_used ((ValaSymbol*) _tmp37_, TRUE);
	_tmp38_ = return_type;
	if (BALA_IS_ARRAY_TYPE (_tmp38_)) {
		...
		_tmp40_ = cb;
		bala_code_node_copy_attribute_bool ((ValaCodeNode*) _tmp39_, (ValaCodeNode*) _tmp40_, "CCode", "array_length");
		_tmp41_ = self->priv->_method;
		_tmp42_ = cb;
		bala_code_node_copy_attribute_bool ((ValaCodeNode*) _tmp41_, (ValaCodeNode*) _tmp42_, "CCode", "array_null_terminated");
		_tmp43_ = self->priv->_method;
		_tmp44_ = cb;
		bala_code_node_copy_attribute_string ((ValaCodeNode*) _tmp43_, (ValaCodeNode*) _tmp44_, "CCode", "array_length_type");
	} else {
		...
		if (BALA_IS_DELEGATE_TYPE (_tmp45_)) {
			...
			_tmp47_ = cb;
			bala_code_node_copy_attribute_bool ((ValaCodeNode*) _tmp46_, (ValaCodeNode*) _tmp47_, "CCode", "delegate_target");
		}
	}
	_tmp49_ = cb;
	...
	if (_tmp48_) {
		...
		while (TRUE) {
			...
			if (BALA_IS_PROPERTY (_tmp63_)) {
				...
				_tmp64_ = sym;
				_tmp65_ = _bala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp64_, BALA_TYPE_PROPERTY, ValaProperty));
				prop = _tmp65_;
				...
				if (BALA_IS_CONSTRUCTOR (_tmp70_)) {
					...
					_tmp71_ = sym;
					_tmp72_ = _bala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp71_, BALA_TYPE_CONSTRUCTOR, ValaConstructor));
					c = _tmp72_;
					...
					if (BALA_IS_DESTRUCTOR (_tmp77_)) {
						...
						_tmp78_ = sym;
						_tmp79_ = _bala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp78_, BALA_TYPE_DESTRUCTOR, ValaDestructor));
						d = _tmp79_;
						...
						if (BALA_IS_METHOD (_tmp84_)) {
							...
							_tmp85_ = sym;
							_tmp86_ = _bala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp85_, BALA_TYPE_METHOD, ValaMethod));
							m = _tmp86_;
	...
	_tmp101_ = _tmp100_;
	bala_symbol_set_owner ((ValaSymbol*) _tmp95_, _tmp101_);
	_tmp102_ = self->priv->_method;
	bala_code_node_set_parent_node ((ValaCodeNode*) _tmp102_, (ValaCodeNode*) self);
	...
	_tmp106_ = bala_iterable_iterator ((ValaIterable*) _tmp105_);
	...
	if (_tmp110_ != NULL) {
		...
		_tmp113_ = _tmp112_;
		_tmp114_ = cb;
		_tmp115_ = bala_callable_get_parameters ((ValaCallable*) _tmp114_);
		_tmp116_ = bala_collection_get_size ((ValaCollection*) _tmp115_);
		_tmp117_ = _tmp116_;
	...
	if (_tmp107_) {
		...
		_tmp124_ = _tmp123_;
		bala_variable_set_variable_type ((ValaVariable*) _tmp121_, _tmp124_);
		_tmp125_ = self->priv->_method;
		_tmp126_ = lambda_param;
		bala_callable_add_parameter ((ValaCallable*) _tmp125_, _tmp126_);
	...
	}
	{
		...
		_tmp127_ = cb;
		_tmp128_ = bala_callable_get_parameters ((ValaCallable*) _tmp127_);
		_tmp129_ = _bala_iterable_ref0 (_tmp128_);
		_cb_param_list = _tmp129_;
		_tmp130_ = _cb_param_list;
		_tmp131_ = bala_collection_get_size ((ValaCollection*) _tmp130_);
		_tmp132_ = _tmp131_;
		...
		while (TRUE) {
			...
			if (_tmp142_ != _tmp145_) {
				...
				_tmp150_ = bala_symbol_get_name ((ValaSymbol*) _tmp149_);
				_tmp151_ = _tmp150_;
			...
			_tmp155_ = cb_param;
			_tmp156_ = bala_variable_get_variable_type ((ValaVariable*) _tmp155_);
			_tmp157_ = _tmp156_;
			_tmp158_ = bala_expression_get_target_type ((ValaExpression*) self);
			_tmp159_ = _tmp158_;
			_tmp160_ = bala_data_type_get_actual_type (_tmp157_, _tmp159_, NULL, (ValaCodeNode*) self);
			_tmp161_ = _tmp160_;
			bala_variable_set_variable_type ((ValaVariable*) _tmp154_, _tmp161_);
			...
			bala_callable_add_parameter ((ValaCallable*) _tmp164_, _tmp165_);
			_bala_code_node_unref0 (lambda_param);
			_bala_code_node_unref0 (cb_param);
		}
	...
	if (bala_iterator_next (_tmp166_)) {
		...
		bala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		_tmp167_ = bala_code_node_get_source_reference ((ValaCodeNode*) self);
		_tmp168_ = _tmp167_;
	...
	bala_code_node_get_error_types ((ValaCodeNode*) _tmp171_, (ValaCollection*) _tmp172_, NULL);
	{
		...
		while (TRUE) {
			...
			_tmp181_ = bala_list_get ((ValaList*) _tmp180_, _error_type_index);
	...
	if (_tmp187_ != NULL) {
		...
		ValaMethod* _tmp216_;
		ValaBlock* _tmp217_;
		_tmp188_ = bala_code_node_get_source_reference ((ValaCodeNode*) self);
		_tmp189_ = _tmp188_;
		_tmp190_ = bala_block_new (_tmp189_);
		block = _tmp190_;
		_tmp191_ = block;
		_tmp192_ = bala_symbol_get_scope ((ValaSymbol*) _tmp191_);
		_tmp193_ = _tmp192_;
		_tmp194_ = self->priv->_method;
		_tmp195_ = bala_symbol_get_scope ((ValaSymbol*) _tmp194_);
		_tmp196_ = _tmp195_;
		bala_scope_set_parent_scope (_tmp193_, _tmp196_);
		_tmp197_ = self->priv->_method;
		_tmp198_ = bala_callable_get_return_type ((ValaCallable*) _tmp197_);
		_tmp199_ = _tmp198_;
		...
		if (_tmp201_ != NULL) {
			...
			_tmp204_ = _tmp203_;
			_tmp205_ = bala_code_node_get_source_reference ((ValaCodeNode*) self);
			_tmp206_ = _tmp205_;
			_tmp207_ = bala_return_statement_new (_tmp204_, _tmp206_);
			_tmp208_ = _tmp207_;
			bala_block_add_statement (_tmp202_, (ValaStatement*) _tmp208_);
			...
			_tmp215_ = _tmp214_;
			bala_block_add_statement (_tmp209_, (ValaStatement*) _tmp215_);
			_bala_code_node_unref0 (_tmp215_);
		}
		_tmp216_ = self->priv->_method;
		_tmp217_ = block;
		bala_subroutine_set_body ((ValaSubroutine*) _tmp216_, _tmp217_);
		...
		_tmp220_ = _tmp219_;
		bala_subroutine_set_body ((ValaSubroutine*) _tmp218_, _tmp220_);
	}
	_tmp221_ = self->priv->_method;
	_tmp222_ = bala_subroutine_get_body ((ValaSubroutine*) _tmp221_);
	_tmp223_ = _tmp222_;
	_tmp224_ = self->priv->_method;
	_tmp225_ = bala_symbol_get_scope ((ValaSymbol*) _tmp224_);
	_tmp226_ = _tmp225_;
	bala_symbol_set_owner ((ValaSymbol*) _tmp223_, _tmp226_);
	...
	if (_tmp232_ != NULL) {
		{
			...
			while (TRUE) {
				...
				_tmp244_ = type_param;
				_tmp245_ = bala_symbol_get_name ((ValaSymbol*) _tmp244_);
				_tmp246_ = _tmp245_;
				_tmp247_ = type_param;
				_tmp248_ = bala_code_node_get_source_reference ((ValaCodeNode*) _tmp247_);
				_tmp249_ = _tmp248_;
				...
				_tmp253_ = m;
				_tmp254_ = bala_subroutine_get_body ((ValaSubroutine*) _tmp253_);
				_tmp255_ = _tmp254_;
	...
	bala_expression_set_symbol_reference ((ValaExpression*) self, (ValaSymbol*) _tmp256_);
	...
	_tmp260_ = _tmp259_;
	bala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) _tmp260_);
	_bala_code_node_unref0 (_tmp260_);
	_tmp261_ = bala_expression_get_value_type ((ValaExpression*) self);
	_tmp262_ = _tmp261_;
	_tmp263_ = bala_expression_get_target_type ((ValaExpression*) self);
	_tmp264_ = _tmp263_;
	_tmp265_ = bala_data_type_get_value_owned (_tmp264_);
	_tmp266_ = _tmp265_;
	bala_data_type_set_value_owned (_tmp262_, _tmp266_);
	_tmp267_ = bala_code_node_get_error ((ValaCodeNode*) self);
	_tmp268_ = _tmp267_;
	result = !_tmp268_;
...
static void
bala_lambda_expression_real_emit (ValaCodeNode* base,
                                  ValaCodeGenerator* codegen)
{
	ValaLambdaExpression * self;
	self = (ValaLambdaExpression*) base;
	g_return_if_fail (codegen != NULL);
	bala_code_visitor_visit_lambda_expression ((ValaCodeVisitor*) codegen, self);
	bala_code_visitor_visit_expression ((ValaCodeVisitor*) codegen, (ValaExpression*) self);
}

static void
bala_lambda_expression_real_get_used_variables (ValaCodeNode* base,
                                                ValaCollection* collection)
{
	ValaLambdaExpression * self;
	...
	if (_tmp0_) {
		...
		bala_method_get_captured_variables (_tmp5_, G_TYPE_CHECK_INSTANCE_CAST (collection, BALA_TYPE_COLLECTION, ValaCollection));
	}
}

static void
bala_lambda_expression_class_init (ValaLambdaExpressionClass * klass,
                                   gpointer klass_data)
{
	bala_lambda_expression_parent_class = g_type_class_peek_parent (klass);
	((ValaCodeNodeClass *) klass)->finalize = bala_lambda_expression_finalize;
	g_type_class_adjust_private_offset (klass, &ValaLambdaExpression_private_offset);
	((ValaCodeNodeClass *) klass)->accept = (void (*) (ValaCodeNode*, ValaCodeVisitor*)) bala_lambda_expression_real_accept;
	((ValaCodeNodeClass *) klass)->accept_children = (void (*) (ValaCodeNode*, ValaCodeVisitor*)) bala_lambda_expression_real_accept_children;
	((ValaExpressionClass *) klass)->is_pure = (gboolean (*) (ValaExpression*)) bala_lambda_expression_real_is_pure;
	((ValaCodeNodeClass *) klass)->check = (gboolean (*) (ValaCodeNode*, ValaCodeContext*)) bala_lambda_expression_real_check;
	((ValaCodeNodeClass *) klass)->emit = (void (*) (ValaCodeNode*, ValaCodeGenerator*)) bala_lambda_expression_real_emit;
	((ValaCodeNodeClass *) klass)->get_used_variables = (void (*) (ValaCodeNode*, ValaCollection*)) bala_lambda_expression_real_get_used_variables;
}

static void
bala_lambda_expression_instance_init (ValaLambdaExpression * self,
                                      gpointer klass)
{
	GEqualFunc _tmp0_;
...
static void
bala_lambda_expression_finalize (ValaCodeNode * obj)
{
	ValaLambdaExpression * self;
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaLambdaExpressionClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_lambda_expression_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaLambdaExpression), 0, (GInstanceInitFunc) bala_lambda_expression_instance_init, NULL };
	GType bala_lambda_expression_type_id;
	bala_lambda_expression_type_id = g_type_register_static (BALA_TYPE_EXPRESSION, "ValaLambdaExpression", &g_define_type_info, 0);
	ValaLambdaExpression_private_offset = g_type_add_instance_private (bala_lambda_expression_type_id, sizeof (ValaLambdaExpressionPrivate));
