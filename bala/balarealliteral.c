/* balarealliteral.c generated by balac, the Vala compiler
...
static void bala_real_literal_real_accept (ValaCodeNode* base,
                                    ValaCodeVisitor* visitor);
static gboolean bala_real_literal_real_is_pure (ValaExpression* base);
static gchar* bala_real_literal_real_to_string (ValaCodeNode* base);
static gboolean bala_real_literal_real_check (ValaCodeNode* base,
                                       ValaCodeContext* context);
static void bala_real_literal_real_emit (ValaCodeNode* base,
                                  ValaCodeGenerator* codegen);
static void bala_real_literal_finalize (ValaCodeNode * obj);
static GType bala_real_literal_get_type_once (void);

static inline gpointer
bala_real_literal_get_instance_private (ValaRealLiteral* self)
{
	return G_STRUCT_MEMBER_P (self, ValaRealLiteral_private_offset);
}

const gchar*
bala_real_literal_get_value (ValaRealLiteral* self)
{
	const gchar* result;
	const gchar* _tmp0_;
...
void
bala_real_literal_set_value (ValaRealLiteral* self,
                             const gchar* value)
{
	gchar* _tmp0_;
                             ...
                             ValaSourceReference* source)
{
	...
	self = (ValaRealLiteral*) bala_literal_construct (object_type);
...
static void
bala_real_literal_real_accept (ValaCodeNode* base,
                               ValaCodeVisitor* visitor)
{
 ...
 */
gchar*
bala_real_literal_get_type_name (ValaRealLiteral* self)
{
...
static gboolean
bala_real_literal_real_is_pure (ValaExpression* base)
{
	ValaRealLiteral * self;
...
static gchar*
bala_real_literal_real_to_string (ValaCodeNode* base)
{
	ValaRealLiteral * self;
	const gchar* _tmp0_;
	gchar* _tmp1_;
...
static gboolean
bala_real_literal_real_check (ValaCodeNode* base,
                              ValaCodeContext* context)
{
	ValaRealLiteral * self;
	gboolean _tmp0_;
	...
	_tmp15_ = _tmp14_;
	bala_expression_set_value_type ((ValaExpression*) self, (ValaDataType*) _tmp15_);
...
static void
bala_real_literal_real_emit (ValaCodeNode* base,
                             ValaCodeGenerator* codegen)
{
	ValaRealLiteral * self;
	self = (ValaRealLiteral*) base;
	g_return_if_fail (codegen != NULL);
	bala_code_visitor_visit_real_literal ((ValaCodeVisitor*) codegen, self);
	bala_code_visitor_visit_expression ((ValaCodeVisitor*) codegen, (ValaExpression*) self);
}

static void
bala_real_literal_class_init (ValaRealLiteralClass * klass,
                              gpointer klass_data)
{
	bala_real_literal_parent_class = g_type_class_peek_parent (klass);
	((ValaCodeNodeClass *) klass)->finalize = bala_real_literal_finalize;
	g_type_class_adjust_private_offset (klass, &ValaRealLiteral_private_offset);
	((ValaCodeNodeClass *) klass)->accept = (void (*) (ValaCodeNode*, ValaCodeVisitor*)) bala_real_literal_real_accept;
	((ValaExpressionClass *) klass)->is_pure = (gboolean (*) (ValaExpression*)) bala_real_literal_real_is_pure;
	((ValaCodeNodeClass *) klass)->to_string = (gchar* (*) (ValaCodeNode*)) bala_real_literal_real_to_string;
	((ValaCodeNodeClass *) klass)->check = (gboolean (*) (ValaCodeNode*, ValaCodeContext*)) bala_real_literal_real_check;
	((ValaCodeNodeClass *) klass)->emit = (void (*) (ValaCodeNode*, ValaCodeGenerator*)) bala_real_literal_real_emit;
}

static void
bala_real_literal_instance_init (ValaRealLiteral * self,
                                 gpointer klass)
{
...
static void
bala_real_literal_finalize (ValaCodeNode * obj)
{
	ValaRealLiteral * self;
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaRealLiteralClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_real_literal_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaRealLiteral), 0, (GInstanceInitFunc) bala_real_literal_instance_init, NULL };
	GType bala_real_literal_type_id;
	bala_real_literal_type_id = g_type_register_static (BALA_TYPE_LITERAL, "ValaRealLiteral", &g_define_type_info, 0);
	ValaRealLiteral_private_offset = g_type_add_instance_private (bala_real_literal_type_id, sizeof (ValaRealLiteralPrivate));
