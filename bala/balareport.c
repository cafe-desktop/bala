/* balareport.c generated by balac, the Vala compiler
...
static gboolean bala_report_is_atty (ValaReport* self,
                              gint fd);
static void bala_report_report_source (ValaReport* self,
                                ValaSourceReference* source);
static void bala_report_print_highlighted_message (ValaReport* self,
                                            const gchar* message);
static void bala_report_print_message (ValaReport* self,
                                ValaSourceReference* source,
                                const gchar* type,
...
static void bala_report_real_note (ValaReport* self,
                            ValaSourceReference* source,
                            const gchar* message);
static void bala_report_real_depr (ValaReport* self,
                            ValaSourceReference* source,
                            const gchar* message);
static void bala_report_real_warn (ValaReport* self,
                            ValaSourceReference* source,
                            const gchar* message);
static void bala_report_real_err (ValaReport* self,
                           ValaSourceReference* source,
                           const gchar* message);
static void bala_report_finalize (ValaReport * obj);
...
bala_report_get_instance_private (ValaReport* self)
{
...
bala_report_colored_get_type_once (void)
{
	...
	bala_report_colored_type_id = g_enum_register_static ("ValaReportColored", values);
...
gboolean
bala_report_get_enable_warnings (ValaReport* self)
{
	gboolean result;
...
void
bala_report_set_enable_warnings (ValaReport* self,
                                 gboolean value)
{
 ...
 */
gboolean
bala_report_set_colors (ValaReport* self,
                        const gchar* str,
 ...
 */
void
bala_report_set_verbose_errors (ValaReport* self,
                                gboolean verbose)
{
	g_return_if_fail (self != NULL);
 ...
 */
gint
bala_report_get_warnings (ValaReport* self)
{
	gint result = 0;
 ...
 */
gint
bala_report_get_errors (ValaReport* self)
{
	gint result = 0;
	g_return_val_if_fail (self != NULL, 0);
	result = self->errors;
...
static void
bala_report_report_source (ValaReport* self,
                           ValaSourceReference* source)
{
...
static void
bala_report_print_highlighted_message (ValaReport* self,
                                       const gchar* message)
{
	gint start = 0;
	gint cur = 0;
...
static void
bala_report_print_message (ValaReport* self,
                           ValaSourceReference* source,
                           const gchar* type,
                           const gchar* type_color_start,
                           const gchar* type_color_end,
 ...
 */
static void
bala_report_real_note (ValaReport* self,
                       ValaSourceReference* source,
                       const gchar* message)
{
	gboolean _tmp0_;
...
void
bala_report_note (ValaReport* self,
                  ValaSourceReference* source,
                  const gchar* message)
{
	g_return_if_fail (self != NULL);
 ...
 */
static void
bala_report_real_depr (ValaReport* self,
                       ValaSourceReference* source,
                       const gchar* message)
{
	gboolean _tmp0_;
...
void
bala_report_depr (ValaReport* self,
                  ValaSourceReference* source,
                  const gchar* message)
{
	g_return_if_fail (self != NULL);
 ...
 */
static void
bala_report_real_warn (ValaReport* self,
                       ValaSourceReference* source,
                       const gchar* message)
{
	gboolean _tmp0_;
...
void
bala_report_warn (ValaReport* self,
                  ValaSourceReference* source,
                  const gchar* message)
{
	g_return_if_fail (self != NULL);
 ...
 */
static void
bala_report_real_err (ValaReport* self,
                      ValaSourceReference* source,
                      const gchar* message)
{
	gint _tmp0_;
...
void
bala_report_err (ValaReport* self,
                 ValaSourceReference* source,
                 const gchar* message)
{
	g_return_if_fail (self != NULL);
...
void
bala_report_notice (ValaSourceReference* source,
                    const gchar* message)
{
...
void
bala_report_deprecated (ValaSourceReference* source,
                        const gchar* message)
{
	ValaCodeContext* _tmp0_;
	ValaCodeContext* _tmp1_;
...
void
bala_report_experimental (ValaSourceReference* source,
                          const gchar* message)
{
	ValaCodeContext* _tmp0_;
	ValaCodeContext* _tmp1_;
...
void
bala_report_warning (ValaSourceReference* source,
                     const gchar* message)
{
	ValaCodeContext* _tmp0_;
	ValaCodeContext* _tmp1_;
...
void
bala_report_error (ValaSourceReference* source,
                   const gchar* message)
{
	ValaCodeContext* _tmp0_;
	ValaCodeContext* _tmp1_;
...
static gboolean
bala_report_is_atty (ValaReport* self,
                     gint fd)
{
	GModule* module = NULL;
	GModule* _tmp0_;
...
static void
bala_report_class_init (ValaReportClass * klass,
                        gpointer klass_data)
{
	bala_report_parent_class = g_type_class_peek_parent (klass);
	((ValaReportClass *) klass)->finalize = bala_report_finalize;
	g_type_class_adjust_private_offset (klass, &ValaReport_private_offset);
	((ValaReportClass *) klass)->note = (void (*) (ValaReport*, ValaSourceReference*, const gchar*)) bala_report_real_note;
	((ValaReportClass *) klass)->depr = (void (*) (ValaReport*, ValaSourceReference*, const gchar*)) bala_report_real_depr;
	((ValaReportClass *) klass)->warn = (void (*) (ValaReport*, ValaSourceReference*, const gchar*)) bala_report_real_warn;
	((ValaReportClass *) klass)->err = (void (*) (ValaReport*, ValaSourceReference*, const gchar*)) bala_report_real_err;
}

static void
bala_report_instance_init (ValaReport * self,
                           gpointer klass)
{
	gchar* _tmp0_;
	gchar* _tmp1_;
...
static void
bala_report_finalize (ValaReport * obj)
{
	ValaReport * self;
...
bala_report_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (ValaReportClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_report_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaReport), 0, (GInstanceInitFunc) bala_report_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType bala_report_type_id;
	bala_report_type_id = g_type_register_fundamental (g_type_fundamental_next (), "ValaReport", &g_define_type_info, &g_define_type_fundamental_info, 0);
	ValaReport_private_offset = g_type_add_instance_private (bala_report_type_id, sizeof (ValaReportPrivate));
