                                           ...
                                           ValaCodeContext* context)
{
	...
	if (_tmp16_ == NULL) {
		...
		if (!BALA_IS_INTEGER_TYPE (_tmp25_)) {
			...
			ValaSourceReference* _tmp29_;
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			_tmp26_ = vala_array_creation_expression_get_length_type (self);
			_tmp27_ = _tmp26_;
			_tmp28_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp27_);
			_tmp29_ = _tmp28_;
			vala_report_error (_tmp29_, "Expected integer type as length type of array");
		}
	}
	{
		ValaList* _e_list = NULL;
		...
		while (TRUE) {
			...
			_tmp37_ = _e_list;
			_tmp38_ = vala_list_get (_tmp37_, _e_index);
	...
	if (_tmp42_ != NULL) {
		...
		_tmp48_ = _tmp47_;
		_tmp49_ = vala_array_type_new (_tmp45_, _tmp46_, _tmp48_);
		_tmp50_ = _tmp49_;
		vala_expression_set_target_type ((ValaExpression*) _tmp43_, (ValaDataType*) _tmp50_);
		_vala_code_node_unref0 (_tmp50_);
		_tmp51_ = initlist;
		_tmp52_ = vala_expression_get_target_type ((ValaExpression*) _tmp51_);
		_tmp53_ = _tmp52_;
		_tmp54_ = vala_array_creation_expression_get_length_type (self);
		_tmp55_ = _tmp54_;
		...
		_tmp61_ = calc_sizes;
		ret = vala_array_creation_expression_create_sizes_from_initializer_list (self, context, _tmp59_, _tmp60_, (ValaList*) _tmp61_);
		if (ret == -1) {
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		}
		_tmp62_ = calc_sizes;
		...
		if (_tmp64_ != _tmp65_) {
			...
			gchar* _tmp88_;
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			_tmp66_ = vala_array_creation_expression_get_element_type (self);
			_tmp67_ = _tmp66_;
			_tmp68_ = calc_sizes;
			...
			_tmp72_ = _tmp71_;
			_tmp73_ = vala_array_type_new (_tmp67_, _tmp70_, _tmp72_);
			actual_type = _tmp73_;
			_tmp74_ = actual_type;
			...
			_tmp79_ = _tmp78_;
			_tmp80_ = vala_expression_get_target_type ((ValaExpression*) self);
			_tmp81_ = _tmp80_;
			...
			_tmp88_ = _tmp87_;
			vala_report_error (_tmp79_, _tmp88_);
			_g_free0 (_tmp88_);
			_g_free0 (_tmp86_);
			_g_free0 (_tmp83_);
	...
	if (_tmp91_ > 0) {
		{
			...
			while (TRUE) {
				...
				_tmp99_ = _e_list;
				_tmp100_ = vala_list_get (_tmp99_, _e_index);
				...
				if (_tmp103_ == NULL) {
					...
					if (!_tmp104_) {
						...
						_tmp113_ = _tmp112_;
						vala_report_error (_tmp113_, "Expression of integer type expected");
					}
				}
				_vala_code_node_unref0 (e);
			}
		...
		if (_tmp114_ == NULL) {
			...
			_tmp116_ = _tmp115_;
			vala_report_error (_tmp116_, "internal error: initializer list expected");
		} else {
			{
