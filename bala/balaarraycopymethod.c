/* balaarraycopymethod.c generated by balac, the Vala compiler
                                  ...
                                  ValaSourceReference* source_reference)
{
	...
	_tmp1_ = _tmp0_;
	self = (ValaArrayCopyMethod*) bala_method_construct (object_type, "copy", (ValaDataType*) _tmp1_, source_reference, NULL);
...
ValaArrayCopyMethod*
bala_array_copy_method_new (ValaSourceReference* source_reference)
{
	return bala_array_copy_method_construct (BALA_TYPE_ARRAY_COPY_METHOD, source_reference);
}

static void
bala_array_copy_method_class_init (ValaArrayCopyMethodClass * klass,
                                   gpointer klass_data)
{
...
static void
bala_array_copy_method_instance_init (ValaArrayCopyMethod * self,
                                      gpointer klass)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaArrayCopyMethodClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_array_copy_method_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaArrayCopyMethod), 0, (GInstanceInitFunc) bala_array_copy_method_instance_init, NULL };
	GType bala_array_copy_method_type_id;
	bala_array_copy_method_type_id = g_type_register_static (BALA_TYPE_METHOD, "ValaArrayCopyMethod", &g_define_type_info, 0);
