...
#define BALA_GIR_PARSER_TYPE_NODE (vala_gir_parser_node_get_type ())
...
#define BALA_GIR_PARSER_TYPE_METADATA (vala_gir_parser_metadata_get_type ())
...
#define BALA_GIR_PARSER_TYPE_ARGUMENT_TYPE (vala_gir_parser_argument_type_get_type ())
...
#define BALA_GIR_PARSER_TYPE_PARAMETER_INFO (vala_gir_parser_parameter_info_get_type ())
...
#define BALA_GIR_PARSER_TYPE_METADATA_PARSER (vala_gir_parser_metadata_parser_get_type ())
...
#define BALA_GIR_PARSER_TYPE_ARGUMENT (vala_gir_parser_argument_get_type ())
...
#define BALA_GIR_PARSER_TYPE_METADATA_SET (vala_gir_parser_metadata_set_get_type ())
                       ...
                       ValaCodeContext* context)
{
	...
	_tmp7_ = vala_array_list_new (BALA_GIR_PARSER_TYPE_NODE, (GBoxedCopyFunc) vala_gir_parser_node_ref, (GDestroyNotify) vala_gir_parser_node_unref, _tmp6_);
			...
			if (_tmp18_ == NULL) {
				{
					...
					while (TRUE) {
						...
						if (BALA_IS_NAMESPACE (_tmp29_)) {
							...
							const gchar* _tmp34_;
							_tmp30_ = node;
							_tmp31_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp30_, BALA_TYPE_NAMESPACE, ValaNamespace));
			...
			}
			{
				...
				while (TRUE) {
					...
					if (vala_code_node_has_attribute_argument (_tmp61_, "GIR", "name")) {
						...
						_tmp68_ = map_from;
						_tmp69_ = node;
						vala_gir_parser_set_symbol_mapping (self, _tmp68_, G_TYPE_CHECK_INSTANCE_CAST (_tmp69_, BALA_TYPE_SYMBOL, ValaSymbol));
                            ...
                            ValaSourceFile* source_file)
{
	...
	_tmp5_ = vala_array_list_new (BALA_GIR_PARSER_TYPE_METADATA, (GBoxedCopyFunc) vala_gir_parser_metadata_ref, (GDestroyNotify) vala_gir_parser_metadata_unref, _tmp4_);
                                         ...
                                         ValaSymbol* sym)
{
	...
	if (BALA_IS_CLASS (container)) {
		...
		if (BALA_IS_CLASS (sym)) {
			ValaClass* _tmp0_;
			_tmp0_ = cl;
			vala_symbol_add_class ((ValaSymbol*) _tmp0_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_CLASS, ValaClass));
		} else {
			if (BALA_IS_CONSTANT (sym)) {
				ValaClass* _tmp1_;
				_tmp1_ = cl;
				vala_symbol_add_constant ((ValaSymbol*) _tmp1_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_CONSTANT, ValaConstant));
			} else {
				if (BALA_IS_ENUM (sym)) {
					ValaClass* _tmp2_;
					_tmp2_ = cl;
					vala_symbol_add_enum ((ValaSymbol*) _tmp2_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_ENUM, ValaEnum));
				} else {
					if (BALA_IS_FIELD (sym)) {
						ValaClass* _tmp3_;
						_tmp3_ = cl;
						vala_symbol_add_field ((ValaSymbol*) _tmp3_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_FIELD, ValaField));
					} else {
						if (BALA_IS_METHOD (sym)) {
							ValaClass* _tmp4_;
							_tmp4_ = cl;
							vala_symbol_add_method ((ValaSymbol*) _tmp4_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_METHOD, ValaMethod));
						} else {
							if (BALA_IS_PROPERTY (sym)) {
								ValaClass* _tmp5_;
								_tmp5_ = cl;
								vala_symbol_add_property ((ValaSymbol*) _tmp5_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_PROPERTY, ValaProperty));
							} else {
								if (BALA_IS_SIGNAL (sym)) {
									ValaClass* _tmp6_;
									_tmp6_ = cl;
									vala_symbol_add_signal ((ValaSymbol*) _tmp6_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_SIGNAL, ValaSignal));
								} else {
									if (BALA_IS_STRUCT (sym)) {
										ValaClass* _tmp7_;
										_tmp7_ = cl;
										vala_symbol_add_struct ((ValaSymbol*) _tmp7_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_STRUCT, ValaStruct));
									}
								}
							}
						}
		...
		if (BALA_IS_ENUM (container)) {
			...
			if (BALA_IS_ENUM_VALUE (sym)) {
				ValaEnum* _tmp8_;
				_tmp8_ = en;
				vala_enum_add_value (_tmp8_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_ENUM_VALUE, ValaEnumValue));
			} else {
				if (BALA_IS_CONSTANT (sym)) {
					ValaEnum* _tmp9_;
					_tmp9_ = en;
					vala_symbol_add_constant ((ValaSymbol*) _tmp9_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_CONSTANT, ValaConstant));
				} else {
					if (BALA_IS_METHOD (sym)) {
						ValaEnum* _tmp10_;
						_tmp10_ = en;
						vala_symbol_add_method ((ValaSymbol*) _tmp10_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_METHOD, ValaMethod));
					}
				}
			}
		} else {
			if (BALA_IS_INTERFACE (container)) {
				...
				if (BALA_IS_CLASS (sym)) {
					...
					_tmp11_ = iface;
					vala_symbol_add_class ((ValaSymbol*) _tmp11_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_CLASS, ValaClass));
				} else {
					if (BALA_IS_CONSTANT (sym)) {
						ValaInterface* _tmp12_;
						_tmp12_ = iface;
						vala_symbol_add_constant ((ValaSymbol*) _tmp12_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_CONSTANT, ValaConstant));
					} else {
						if (BALA_IS_ENUM (sym)) {
							ValaInterface* _tmp13_;
							_tmp13_ = iface;
							vala_symbol_add_enum ((ValaSymbol*) _tmp13_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_ENUM, ValaEnum));
						} else {
							if (BALA_IS_FIELD (sym)) {
								ValaInterface* _tmp14_;
								_tmp14_ = iface;
								vala_symbol_add_field ((ValaSymbol*) _tmp14_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_FIELD, ValaField));
							} else {
								if (BALA_IS_METHOD (sym)) {
									ValaInterface* _tmp15_;
									_tmp15_ = iface;
									vala_symbol_add_method ((ValaSymbol*) _tmp15_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_METHOD, ValaMethod));
								} else {
									if (BALA_IS_PROPERTY (sym)) {
										ValaInterface* _tmp16_;
										_tmp16_ = iface;
										vala_symbol_add_property ((ValaSymbol*) _tmp16_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_PROPERTY, ValaProperty));
									} else {
										if (BALA_IS_SIGNAL (sym)) {
											ValaInterface* _tmp17_;
											_tmp17_ = iface;
											vala_symbol_add_signal ((ValaSymbol*) _tmp17_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_SIGNAL, ValaSignal));
										} else {
											if (BALA_IS_STRUCT (sym)) {
												ValaInterface* _tmp18_;
												_tmp18_ = iface;
												vala_symbol_add_struct ((ValaSymbol*) _tmp18_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_STRUCT, ValaStruct));
											}
										}
									}
								}
				...
				if (BALA_IS_NAMESPACE (container)) {
					...
					if (BALA_IS_NAMESPACE (sym)) {
						...
						_tmp19_ = ns;
						vala_symbol_add_namespace ((ValaSymbol*) _tmp19_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_NAMESPACE, ValaNamespace));
					} else {
						if (BALA_IS_CLASS (sym)) {
							ValaNamespace* _tmp20_;
							_tmp20_ = ns;
							vala_symbol_add_class ((ValaSymbol*) _tmp20_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_CLASS, ValaClass));
						} else {
							if (BALA_IS_CONSTANT (sym)) {
								ValaNamespace* _tmp21_;
								_tmp21_ = ns;
								vala_symbol_add_constant ((ValaSymbol*) _tmp21_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_CONSTANT, ValaConstant));
							} else {
								if (BALA_IS_DELEGATE (sym)) {
									ValaNamespace* _tmp22_;
									_tmp22_ = ns;
									vala_symbol_add_delegate ((ValaSymbol*) _tmp22_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_DELEGATE, ValaDelegate));
								} else {
									if (BALA_IS_ENUM (sym)) {
										ValaNamespace* _tmp23_;
										_tmp23_ = ns;
										vala_symbol_add_enum ((ValaSymbol*) _tmp23_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_ENUM, ValaEnum));
									} else {
										if (BALA_IS_ERROR_DOMAIN (sym)) {
											ValaNamespace* _tmp24_;
											_tmp24_ = ns;
											vala_symbol_add_error_domain ((ValaSymbol*) _tmp24_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_ERROR_DOMAIN, ValaErrorDomain));
										} else {
											if (BALA_IS_FIELD (sym)) {
												...
												if (_tmp27_ == BALA_MEMBER_BINDING_INSTANCE) {
													ValaField* _tmp28_;
													_tmp28_ = field;
													vala_field_set_binding (_tmp28_, BALA_MEMBER_BINDING_STATIC);
												}
												_tmp29_ = ns;
												_tmp30_ = field;
												...
												if (BALA_IS_INTERFACE (sym)) {
													ValaNamespace* _tmp31_;
													_tmp31_ = ns;
													vala_symbol_add_interface ((ValaSymbol*) _tmp31_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_INTERFACE, ValaInterface));
												} else {
													if (BALA_IS_METHOD (sym)) {
														...
														if (_tmp34_ == BALA_MEMBER_BINDING_INSTANCE) {
															ValaMethod* _tmp35_;
															_tmp35_ = method;
															vala_method_set_binding (_tmp35_, BALA_MEMBER_BINDING_STATIC);
														}
														_tmp36_ = ns;
														_tmp37_ = method;
														...
														if (BALA_IS_STRUCT (sym)) {
															...
															_tmp38_ = ns;
															vala_symbol_add_struct ((ValaSymbol*) _tmp38_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_STRUCT, ValaStruct));
														}
													}
												}
											}
					...
					if (BALA_IS_STRUCT (container)) {
						...
						if (BALA_IS_CONSTANT (sym)) {
							ValaStruct* _tmp39_;
							_tmp39_ = st;
							vala_symbol_add_constant ((ValaSymbol*) _tmp39_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_CONSTANT, ValaConstant));
						} else {
							if (BALA_IS_FIELD (sym)) {
								ValaStruct* _tmp40_;
								_tmp40_ = st;
								vala_symbol_add_field ((ValaSymbol*) _tmp40_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_FIELD, ValaField));
							} else {
								if (BALA_IS_METHOD (sym)) {
									ValaStruct* _tmp41_;
									_tmp41_ = st;
									vala_symbol_add_method ((ValaSymbol*) _tmp41_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_METHOD, ValaMethod));
								} else {
									if (BALA_IS_PROPERTY (sym)) {
										ValaStruct* _tmp42_;
										_tmp42_ = st;
										vala_symbol_add_property ((ValaSymbol*) _tmp42_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_PROPERTY, ValaProperty));
									}
								}
							}
						}
						...
						if (BALA_IS_ERROR_DOMAIN (container)) {
							...
							if (BALA_IS_ERROR_CODE (sym)) {
								...
								_tmp43_ = ed;
								vala_error_domain_add_code (_tmp43_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_ERROR_CODE, ValaErrorCode));
							} else {
								if (BALA_IS_METHOD (sym)) {
									ValaErrorDomain* _tmp44_;
									_tmp44_ = ed;
									vala_symbol_add_method ((ValaSymbol*) _tmp44_, G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_METHOD, ValaMethod));
								}
							}
						} else {
                                    ...
                                    ValaSymbol* map_to)
{
	...
	if (BALA_IS_UNRESOLVED_SYMBOL (map_from)) {
		...
		vala_map_set ((ValaMap*) _tmp0_, G_TYPE_CHECK_INSTANCE_CAST (map_from, BALA_TYPE_UNRESOLVED_SYMBOL, ValaUnresolvedSymbol), map_to);
	}
}
                                        ...
                                        gboolean skip_first)
{
	...
	g_return_if_fail (sym != NULL);
	_tmp0_ = vala_callable_get_parameters (G_TYPE_CHECK_INSTANCE_CAST (sym, BALA_TYPE_CALLABLE, ValaCallable));
                              ...
                              ValaGirParserNode* node)
{
	...
	_tmp0_ = node->symbol;
	_tmp1_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, BALA_TYPE_METHOD, ValaMethod));
	m = _tmp1_;
	_tmp2_ = m;
	...
	prefix = _tmp5_;
	{
		...
		while (TRUE) {
			...
			_tmp21_ = _vala_code_node_ref0 (BALA_IS_METHOD (_tmp20_) ? ((ValaMethod*) _tmp20_) : NULL);
			invoker = _tmp21_;
			_tmp23_ = invoker;
			if (_tmp23_ == NULL) {
				_tmp22_ = TRUE;
...
vala_gir_parser_push_metadata (ValaGirParser* self)
{
	...
	new_metadata = _tmp0_;
	_tmp1_ = new_metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp1_, BALA_GIR_PARSER_ARGUMENT_TYPE_SKIP)) {
		ValaGirParserMetadata* _tmp2_;
		_tmp2_ = new_metadata;
		if (vala_gir_parser_metadata_get_bool (_tmp2_, BALA_GIR_PARSER_ARGUMENT_TYPE_SKIP, FALSE)) {
			result = FALSE;
                                  ...
                                  gboolean* changed)
{
	...
	type = _tmp0_;
	_tmp1_ = self->priv->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp1_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE)) {
		ValaGirParserMetadata* _tmp2_;
		gchar* _tmp3_;
		gchar* _tmp4_;
		...
		_tmp3_ = vala_gir_parser_metadata_get_string (_tmp2_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE);
		_tmp4_ = _tmp3_;
		_tmp5_ = self->priv->metadata;
		_tmp6_ = vala_gir_parser_metadata_get_source_reference (_tmp5_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE);
		_tmp7_ = _tmp6_;
		...
		if (!BALA_IS_VOID_TYPE (_tmp9_)) {
			...
			if (vala_gir_parser_metadata_has_argument (_tmp10_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE_ARGUMENTS)) {
				...
				_tmp14_ = vala_gir_parser_metadata_get_string (_tmp13_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE_ARGUMENTS);
				_tmp15_ = _tmp14_;
				_tmp16_ = self->priv->metadata;
				_tmp17_ = vala_gir_parser_metadata_get_source_reference (_tmp16_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE_ARGUMENTS);
				_tmp18_ = _tmp17_;
			...
			if (!BALA_IS_ARRAY_TYPE (_tmp20_)) {
				...
				_tmp19_ = vala_gir_parser_metadata_get_bool (_tmp21_, BALA_GIR_PARSER_ARGUMENT_TYPE_ARRAY, FALSE);
			} else {
				_tmp19_ = FALSE;
			}
			if (_tmp19_) {
			...
			if (owned_by_default) {
				...
				_tmp32_ = _tmp31_;
				vala_data_type_set_value_owned (_tmp28_, !vala_gir_parser_metadata_get_bool (_tmp29_, BALA_GIR_PARSER_ARGUMENT_TYPE_UNOWNED, !_tmp32_));
			} else {
				...
				_tmp37_ = _tmp36_;
				vala_data_type_set_value_owned (_tmp33_, vala_gir_parser_metadata_get_bool (_tmp34_, BALA_GIR_PARSER_ARGUMENT_TYPE_OWNED, _tmp37_));
			}
			_tmp38_ = type;
			...
			_tmp42_ = _tmp41_;
			vala_data_type_set_nullable (_tmp38_, vala_gir_parser_metadata_get_bool (_tmp39_, BALA_GIR_PARSER_ARGUMENT_TYPE_NULLABLE, _tmp42_));
		}
	}
	_tmp43_ = type;
	if (BALA_IS_ARRAY_TYPE (_tmp43_)) {
		...
		*array_null_terminated = vala_gir_parser_metadata_get_bool (_tmp44_, BALA_GIR_PARSER_ARGUMENT_TYPE_ARRAY_NULL_TERMINATED, *array_null_terminated);
	}
	result = type;
	if (changed) {
                                  ...
                                  const gchar* gir_name)
{
	...
	_tmp5_ = vala_gir_parser_metadata_get_string (_tmp4_, BALA_GIR_PARSER_ARGUMENT_TYPE_NAME);
	pattern = _tmp5_;
	_tmp6_ = pattern;
	if (_tmp6_ != NULL) {
		const gchar* _tmp7_;
...
vala_gir_parser_element_get_type_id (ValaGirParser* self)
{
	...
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = self->priv->metadata;
	_tmp1_ = vala_gir_parser_metadata_get_string (_tmp0_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE_ID);
	type_id = _tmp1_;
	_tmp2_ = type_id;
	if (_tmp2_ != NULL) {
		result = type_id;
                           ...
                           gboolean merge)
{
	...
	parent = _tmp1_;
	_tmp2_ = self->priv->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp2_, BALA_GIR_PARSER_ARGUMENT_TYPE_PARENT)) {
		...
		_tmp4_ = vala_gir_parser_metadata_get_string (_tmp3_, BALA_GIR_PARSER_ARGUMENT_TYPE_PARENT);
		_tmp5_ = _tmp4_;
		_tmp6_ = self->priv->metadata;
		_tmp7_ = vala_gir_parser_metadata_get_source_reference (_tmp6_, BALA_GIR_PARSER_ARGUMENT_TYPE_PARENT);
		_tmp8_ = _tmp7_;
...
vala_gir_parser_parse_namespace (ValaGirParser* self)
{
	...
	ns_metadata = _tmp48_;
	_tmp49_ = ns_metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp49_, BALA_GIR_PARSER_ARGUMENT_TYPE_NAME)) {
		ValaGirParserMetadata* _tmp50_;
		gchar* _tmp51_;
		_tmp50_ = ns_metadata;
		_tmp51_ = vala_gir_parser_metadata_get_string (_tmp50_, BALA_GIR_PARSER_ARGUMENT_TYPE_NAME);
		_g_free0 (vala_namespace);
	...
	if (_tmp60_->new_symbol) {
		...
		_tmp70_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp69_, BALA_TYPE_NAMESPACE, ValaNamespace));
		_vala_code_node_unref0 (ns);
		ns = _tmp70_;
		_tmp71_ = ns;
	...
	_tmp78_ = ns_metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp78_, BALA_GIR_PARSER_ARGUMENT_TYPE_CPREFIX)) {
		ValaGirParserMetadata* _tmp79_;
		gchar* _tmp80_;
		_tmp79_ = ns_metadata;
		_tmp80_ = vala_gir_parser_metadata_get_string (_tmp79_, BALA_GIR_PARSER_ARGUMENT_TYPE_CPREFIX);
		_g_free0 (cprefix);
		cprefix = _tmp80_;
	}
	_tmp81_ = ns_metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp81_, BALA_GIR_PARSER_ARGUMENT_TYPE_LOWER_CASE_CPREFIX)) {
		ValaGirParserMetadata* _tmp82_;
		gchar* _tmp83_;
		_tmp82_ = ns_metadata;
		_tmp83_ = vala_gir_parser_metadata_get_string (_tmp82_, BALA_GIR_PARSER_ARGUMENT_TYPE_LOWER_CASE_CPREFIX);
		_g_free0 (lower_case_cprefix);
	...
	while (TRUE) {
		...
		if (g_strcmp0 (_tmp112_, "alias") == 0) {
			...
			if (g_strcmp0 (_tmp115_, "enumeration") == 0) {
				...
				if (vala_gir_parser_metadata_has_argument (_tmp116_, BALA_GIR_PARSER_ARGUMENT_TYPE_ERRORDOMAIN)) {
					ValaGirParserMetadata* _tmp117_;
					_tmp117_ = self->priv->metadata;
					if (vala_gir_parser_metadata_get_bool (_tmp117_, BALA_GIR_PARSER_ARGUMENT_TYPE_ERRORDOMAIN, FALSE)) {
						...
						if (g_strcmp0 (_tmp134_, "function-macro") == 0) {
							...
							if (g_strcmp0 (_tmp137_, "callback") == 0) {
								...
								if (g_strcmp0 (_tmp140_, "record") == 0) {
									...
									if (vala_gir_parser_metadata_has_argument (_tmp141_, BALA_GIR_PARSER_ARGUMENT_TYPE_STRUCT)) {
										ValaGirParserMetadata* _tmp142_;
										_tmp142_ = self->priv->metadata;
										if (vala_gir_parser_metadata_get_bool (_tmp142_, BALA_GIR_PARSER_ARGUMENT_TYPE_STRUCT, FALSE)) {
											...
											if (g_strcmp0 (_tmp166_, "glib:boxed") == 0) {
												...
												if (g_strcmp0 (_tmp169_, "union") == 0) {
													...
													if (_tmp173_) {
														...
														_tmp170_ = !vala_gir_parser_metadata_get_bool (_tmp174_, BALA_GIR_PARSER_ARGUMENT_TYPE_STRUCT, FALSE);
													} else {
														_tmp170_ = FALSE;
													}
													if (_tmp170_) {
...
vala_gir_parser_parse_alias (ValaGirParser* self)
{
	...
	_tmp12_ = self->priv->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp12_, BALA_GIR_PARSER_ARGUMENT_TYPE_BASE_TYPE)) {
		ValaGirParserNode* _tmp13_;
		ValaGirParserMetadata* _tmp14_;
		gchar* _tmp15_;
		gchar* _tmp16_;
		...
		_tmp15_ = vala_gir_parser_metadata_get_string (_tmp14_, BALA_GIR_PARSER_ARGUMENT_TYPE_BASE_TYPE);
		_tmp16_ = _tmp15_;
		_tmp17_ = self->priv->metadata;
		_tmp18_ = vala_gir_parser_metadata_get_source_reference (_tmp17_, BALA_GIR_PARSER_ARGUMENT_TYPE_BASE_TYPE);
		_tmp19_ = _tmp18_;
                                   ...
                                   gboolean error_domain)
{
	...
	_tmp23_ = sym;
	vala_symbol_set_access (_tmp23_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
	common_prefix = NULL;
	explicit_prefix = FALSE;
	_tmp24_ = self->priv->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp24_, BALA_GIR_PARSER_ARGUMENT_TYPE_CPREFIX)) {
		ValaSymbol* _tmp25_;
		ValaGirParserMetadata* _tmp26_;
		gchar* _tmp27_;
		gchar* _tmp28_;
		_tmp25_ = sym;
		_tmp26_ = self->priv->metadata;
		_tmp27_ = vala_gir_parser_metadata_get_string (_tmp26_, BALA_GIR_PARSER_ARGUMENT_TYPE_CPREFIX);
		_tmp28_ = _tmp27_;
...
vala_gir_parser_parse_enumeration_member (ValaGirParser* self)
{
	...
	_tmp9_ = vala_gir_parser_metadata_get_expression (_tmp8_, BALA_GIR_PARSER_ARGUMENT_TYPE_DEFAULT);
	_tmp10_ = _tmp9_;
                                 ...
                                 const gchar* default_name)
{
	...
	_tmp13_ = self->priv->metadata;
	_tmp14_ = vala_gir_parser_metadata_get_string (_tmp13_, BALA_GIR_PARSER_ARGUMENT_TYPE_NAME);
	name = _tmp14_;
	_tmp15_ = name;
	if (_tmp15_ == NULL) {
		ValaMarkupReader* _tmp16_;
	...
	if (vala_gir_parser_metadata_has_argument (_tmp25_, BALA_GIR_PARSER_ARGUMENT_TYPE_OUT)) {
		ValaGirParserMetadata* _tmp26_;
		_tmp26_ = self->priv->metadata;
		if (vala_gir_parser_metadata_get_bool (_tmp26_, BALA_GIR_PARSER_ARGUMENT_TYPE_OUT, FALSE)) {
			gchar* _tmp27_;
		...
		if (vala_gir_parser_metadata_has_argument (_tmp28_, BALA_GIR_PARSER_ARGUMENT_TYPE_REF)) {
			ValaGirParserMetadata* _tmp29_;
			_tmp29_ = self->priv->metadata;
			if (vala_gir_parser_metadata_get_bool (_tmp29_, BALA_GIR_PARSER_ARGUMENT_TYPE_REF, FALSE)) {
				gchar* _tmp30_;
	...
	allow_none = _tmp38_;
	_tmp39_ = vala_gir_parser_element_get_string (self, "scope", BALA_GIR_PARSER_ARGUMENT_TYPE_SCOPE);
	...
	if (vala_gir_parser_metadata_has_argument (_tmp50_, BALA_GIR_PARSER_ARGUMENT_TYPE_CLOSURE)) {
		ValaGirParserMetadata* _tmp51_;
		_tmp51_ = self->priv->metadata;
		_vala_closure_idx = vala_gir_parser_metadata_get_integer (_tmp51_, BALA_GIR_PARSER_ARGUMENT_TYPE_CLOSURE);
	}
	_tmp52_ = self->priv->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp52_, BALA_GIR_PARSER_ARGUMENT_TYPE_DESTROY)) {
		ValaGirParserMetadata* _tmp53_;
		_tmp53_ = self->priv->metadata;
		_vala_destroy_idx = vala_gir_parser_metadata_get_integer (_tmp53_, BALA_GIR_PARSER_ARGUMENT_TYPE_DESTROY);
	}
	vala_gir_parser_next (self);
	...
	if (g_strcmp0 (_tmp57_, "varargs") == 0) {
		...
		if (g_strcmp0 (_tmp95_, "out") == 0) {
			...
			_tmp96_ = param;
			vala_parameter_set_direction (_tmp96_, BALA_PARAMETER_DIRECTION_OUT);
		} else {
			const gchar* _tmp97_;
			_tmp97_ = direction;
			if (g_strcmp0 (_tmp97_, "inout") == 0) {
				...
				_tmp98_ = param;
				vala_parameter_set_direction (_tmp98_, BALA_PARAMETER_DIRECTION_REF);
			}
		}
		_tmp100_ = type;
		if (BALA_IS_DELEGATE_TYPE (_tmp100_)) {
			...
			_tmp99_ = vala_gir_parser_metadata_has_argument (_tmp101_, BALA_GIR_PARSER_ARGUMENT_TYPE_DELEGATE_TARGET);
		} else {
			_tmp99_ = FALSE;
		}
		if (_tmp99_) {
			...
			vala_code_node_set_attribute_bool ((ValaCodeNode*) _tmp102_, "CCode", "delegate_target", vala_gir_parser_metadata_get_bool (_tmp103_, BALA_GIR_PARSER_ARGUMENT_TYPE_DELEGATE_TARGET, FALSE), NULL);
		}
		_tmp104_ = type;
		if (BALA_IS_ARRAY_TYPE (_tmp104_)) {
			ValaGirParserMetadata* _tmp105_;
			_tmp105_ = self->priv->metadata;
			if (vala_gir_parser_metadata_has_argument (_tmp105_, BALA_GIR_PARSER_ARGUMENT_TYPE_ARRAY_LENGTH_IDX)) {
				ValaGirParserMetadata* _tmp106_;
				_tmp106_ = self->priv->metadata;
				_vala_array_length_idx = vala_gir_parser_metadata_get_integer (_tmp106_, BALA_GIR_PARSER_ARGUMENT_TYPE_ARRAY_LENGTH_IDX);
			} else {
		...
		_tmp112_ = vala_gir_parser_metadata_get_expression (_tmp111_, BALA_GIR_PARSER_ARGUMENT_TYPE_DEFAULT);
		_tmp113_ = _tmp112_;
                            ...
                            gboolean* array_null_terminated)
{
	...
	if (g_strcmp0 (_tmp4_, "array") == 0) {
		...
		if (g_strcmp0 (_tmp45_, "callback") == 0) {
			...
			_tmp48_ = vala_delegate_type_new (G_TYPE_CHECK_INSTANCE_CAST (_tmp47_, BALA_TYPE_DELEGATE, ValaDelegate));
	...
	if (vala_gir_parser_metadata_has_argument (_tmp49_, BALA_GIR_PARSER_ARGUMENT_TYPE_CTYPE)) {
		ValaGirParserMetadata* _tmp50_;
		gchar* _tmp51_;
		_tmp50_ = self->priv->metadata;
		_tmp51_ = vala_gir_parser_metadata_get_string (_tmp50_, BALA_GIR_PARSER_ARGUMENT_TYPE_CTYPE);
		_g_free0 (_vala_ctype);
		_vala_ctype = _tmp51_;
	} else {
	...
	while (TRUE) {
		...
		if (BALA_IS_UNRESOLVED_TYPE (_tmp72_)) {
			...
			_tmp91_ = parent;
			vala_map_set ((ValaMap*) _tmp89_, G_TYPE_CHECK_INSTANCE_CAST (_tmp90_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType), _tmp91_);
			_vala_gir_parser_node_unref0 (parent);
		}
		_vala_code_node_unref0 (element_type);
	}
...
vala_gir_parser_parse_record (ValaGirParser* self)
{
	...
	if (_tmp2_->new_symbol) {
		...
		_tmp13_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp12_, BALA_TYPE_STRUCT, ValaStruct));
		_vala_code_node_unref0 (st);
		st = _tmp13_;
	}
	_tmp14_ = st;
	...
	_tmp16_ = st;
	vala_symbol_set_access ((ValaSymbol*) _tmp16_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
...
vala_gir_parser_parse_class (ValaGirParser* self)
{
	...
	if (_tmp4_->new_symbol) {
		...
		_tmp14_ = _tmp13_;
		vala_class_set_is_abstract (_tmp10_, vala_gir_parser_metadata_get_bool (_tmp11_, BALA_GIR_PARSER_ARGUMENT_TYPE_ABSTRACT, g_strcmp0 (_tmp14_, "1") == 0));
		_g_free0 (_tmp14_);
		_tmp15_ = cl;
		_tmp16_ = self->priv->metadata;
		vala_class_set_is_sealed (_tmp15_, vala_gir_parser_metadata_get_bool (_tmp16_, BALA_GIR_PARSER_ARGUMENT_TYPE_SEALED, FALSE));
		_tmp17_ = self->priv->metadata;
		if (vala_gir_parser_metadata_has_argument (_tmp17_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE_GET_FUNCTION)) {
			ValaClass* _tmp18_;
			...
			_tmp20_ = vala_gir_parser_metadata_get_string (_tmp19_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE_GET_FUNCTION);
			_tmp21_ = _tmp20_;
		...
		_tmp28_ = vala_markup_reader_get_attribute (_tmp27_, "glib:type-struct");
		type_struct = _tmp28_;
		_tmp29_ = type_struct;
		if (_tmp29_ != NULL) {
			...
			_tmp34_ = vala_gir_parser_parse_symbol_from_string (self, _tmp31_, _tmp33_);
			_vala_code_node_unref0 (_tmp30_->type_struct);
			_tmp30_->type_struct = _tmp34_;
			_tmp35_ = self->priv->unresolved_gir_symbols;
			_tmp36_ = self->priv->current;
			_tmp37_ = _tmp36_->type_struct;
			vala_collection_add ((ValaCollection*) _tmp35_, _tmp37_);
		}
		_tmp38_ = self->priv->current;
		_tmp39_ = cl;
		_tmp40_ = _vala_code_node_ref0 ((ValaSymbol*) _tmp39_);
		_vala_code_node_unref0 (_tmp38_->symbol);
		...
		_tmp43_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp42_, BALA_TYPE_CLASS, ValaClass));
		_vala_code_node_unref0 (cl);
		cl = _tmp43_;
	}
	_tmp44_ = cl;
	vala_gir_parser_set_type_id_ccode (self, (ValaSymbol*) _tmp44_);
	_tmp45_ = cl;
	vala_symbol_set_access ((ValaSymbol*) _tmp45_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
	vala_gir_parser_next (self);
	_tmp46_ = cl;
	_tmp47_ = vala_gir_parser_parse_symbol_doc (self);
	_tmp48_ = _tmp47_;
	vala_symbol_set_comment ((ValaSymbol*) _tmp46_, (ValaComment*) _tmp48_);
	_vala_comment_unref0 (_tmp48_);
	first_field = TRUE;
	while (TRUE) {
		...
		if (g_strcmp0 (_tmp56_, "implements") == 0) {
			...
			_tmp60_ = _tmp59_;
			_tmp61_ = vala_gir_parser_parse_type_from_gir_name (self, _tmp60_, NULL, NULL, NULL);
			_tmp62_ = _tmp61_;
			vala_class_add_base_type (_tmp57_, _tmp62_);
			...
			if (g_strcmp0 (_tmp65_, "constant") == 0) {
				...
				if (g_strcmp0 (_tmp68_, "field") == 0) {
					...
					if (g_strcmp0 (_tmp77_, "property") == 0) {
						...
						_tmp78_ = vala_gir_parser_parse_property (self);
						_tmp79_ = _tmp78_;
...
vala_gir_parser_parse_interface (ValaGirParser* self)
{
	...
	if (_tmp2_->new_symbol) {
		...
		iface = _tmp7_;
		_tmp8_ = self->priv->metadata;
		if (vala_gir_parser_metadata_has_argument (_tmp8_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE_GET_FUNCTION)) {
			...
			_tmp9_ = iface;
			_tmp10_ = self->priv->metadata;
			_tmp11_ = vala_gir_parser_metadata_get_string (_tmp10_, BALA_GIR_PARSER_ARGUMENT_TYPE_TYPE_GET_FUNCTION);
			_tmp12_ = _tmp11_;
		...
		_tmp18_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp17_, BALA_TYPE_INTERFACE, ValaInterface));
		_vala_code_node_unref0 (iface);
		iface = _tmp18_;
	}
	_tmp19_ = iface;
	...
	_tmp20_ = iface;
	vala_symbol_set_access ((ValaSymbol*) _tmp20_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
	vala_gir_parser_next (self);
	_tmp21_ = iface;
	_tmp22_ = vala_gir_parser_parse_symbol_doc (self);
	_tmp23_ = _tmp22_;
...
vala_gir_parser_parse_field (ValaGirParser* self)
{
	...
	field = _tmp23_;
	_tmp24_ = field;
	vala_symbol_set_access ((ValaSymbol*) _tmp24_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
	_tmp25_ = field;
	_tmp26_ = comment;
...
vala_gir_parser_parse_property (ValaGirParser* self)
{
	...
	is_abstract = vala_gir_parser_metadata_get_bool (_tmp4_, BALA_GIR_PARSER_ARGUMENT_TYPE_ABSTRACT, BALA_IS_INTERFACE (_tmp7_));
	_tmp8_ = self->priv->reader;
	...
	_tmp25_ = prop;
	vala_symbol_set_access ((ValaSymbol*) _tmp25_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
	_tmp26_ = prop;
                                ...
                                const gchar* element_name)
{
	...
	if (vala_gir_parser_metadata_has_argument (_tmp7_, BALA_GIR_PARSER_ARGUMENT_TYPE_SYMBOL_TYPE)) {
		ValaGirParserMetadata* _tmp8_;
		gchar* _tmp9_;
		_tmp8_ = self->priv->metadata;
		_tmp9_ = vala_gir_parser_metadata_get_string (_tmp8_, BALA_GIR_PARSER_ARGUMENT_TYPE_SYMBOL_TYPE);
	...
	ctype = NULL;
	_tmp11_ = self->priv->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp11_, BALA_GIR_PARSER_ARGUMENT_TYPE_CTYPE)) {
		ValaGirParserMetadata* _tmp12_;
		gchar* _tmp13_;
		_tmp12_ = self->priv->metadata;
		_tmp13_ = vala_gir_parser_metadata_get_string (_tmp12_, BALA_GIR_PARSER_ARGUMENT_TYPE_CTYPE);
		_g_free0 (ctype);
		ctype = _tmp13_;
	}
	...
	if (g_strcmp0 (_tmp41_, "callback") == 0) {
		...
		_tmp47_ = s;
		vala_delegate_set_has_target (G_TYPE_CHECK_INSTANCE_CAST (_tmp47_, BALA_TYPE_DELEGATE, ValaDelegate), FALSE);
	} else {
		const gchar* _tmp48_;
		_tmp48_ = symbol_type;
		if (g_strcmp0 (_tmp48_, "constructor") == 0) {
	...
	_tmp98_ = s;
	vala_symbol_set_access (_tmp98_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
	_tmp99_ = s;
	_tmp100_ = comment;
	vala_symbol_set_comment (_tmp99_, (ValaComment*) _tmp100_);
	_tmp101_ = return_type;
	_tmp102_ = _vala_code_node_ref0 (BALA_IS_ARRAY_TYPE (_tmp101_) ? ((ValaArrayType*) _tmp101_) : NULL);
	array_type = _tmp102_;
	_tmp104_ = array_type;
	if (_tmp104_ != NULL) {
	...
	if (_tmp103_) {
		...
		_tmp111_ = _tmp110_;
		_tmp112_ = vala_integer_literal_get_value (G_TYPE_CHECK_INSTANCE_CAST (_tmp111_, BALA_TYPE_INTEGER_LITERAL, ValaIntegerLiteral));
		_tmp113_ = _tmp112_;
	...
	if (BALA_IS_METHOD (_tmp130_)) {
		...
		_tmp131_ = s;
		_tmp132_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp131_, BALA_TYPE_METHOD, ValaMethod));
		m = _tmp132_;
		...
		if (_tmp133_) {
			...
			_tmp141_ = self->priv->metadata;
			if (vala_gir_parser_metadata_has_argument (_tmp141_, BALA_GIR_PARSER_ARGUMENT_TYPE_NO_WRAPPER)) {
				ValaSymbol* _tmp142_;
				...
				_tmp146_ = _tmp145_;
				vala_code_node_set_attribute ((ValaCodeNode*) _tmp142_, "NoWrapper", vala_gir_parser_metadata_get_bool (_tmp143_, BALA_GIR_PARSER_ARGUMENT_TYPE_NO_WRAPPER, FALSE), _tmp146_);
			} else {
				...
				if (_tmp148_ == NULL) {
					...
					_tmp147_ = !vala_gir_parser_metadata_has_argument (_tmp149_, BALA_GIR_PARSER_ARGUMENT_TYPE_VFUNC_NAME);
				} else {
					_tmp147_ = FALSE;
				}
				if (_tmp147_) {
			...
			if (g_strcmp0 (_tmp165_, "function") == 0) {
				ValaMethod* _tmp166_;
				_tmp166_ = m;
				vala_method_set_binding (_tmp166_, BALA_MEMBER_BINDING_STATIC);
			}
		}
		_tmp167_ = self->priv->metadata;
		if (vala_gir_parser_metadata_has_argument (_tmp167_, BALA_GIR_PARSER_ARGUMENT_TYPE_FLOATING)) {
			ValaMethod* _tmp168_;
			...
			vala_method_set_returns_floating_reference (_tmp168_, vala_gir_parser_metadata_get_bool (_tmp169_, BALA_GIR_PARSER_ARGUMENT_TYPE_FLOATING, FALSE));
			_tmp170_ = m;
		...
		if (vala_gir_parser_metadata_has_argument (_tmp173_, BALA_GIR_PARSER_ARGUMENT_TYPE_NEW)) {
			ValaMethod* _tmp174_;
			ValaGirParserMetadata* _tmp175_;
			_tmp174_ = m;
			_tmp175_ = self->priv->metadata;
			vala_symbol_set_hides ((ValaSymbol*) _tmp174_, vala_gir_parser_metadata_get_bool (_tmp175_, BALA_GIR_PARSER_ARGUMENT_TYPE_NEW, FALSE));
		}
		_vala_code_node_unref0 (m);
	}
	_tmp177_ = s;
	...
	if (_tmp176_) {
		...
		_tmp179_ = s;
		_tmp180_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp179_, BALA_TYPE_METHOD, ValaMethod));
		method = _tmp180_;
		_tmp181_ = self->priv->metadata;
		if (vala_gir_parser_metadata_has_argument (_tmp181_, BALA_GIR_PARSER_ARGUMENT_TYPE_VIRTUAL)) {
			ValaMethod* _tmp182_;
			ValaGirParserMetadata* _tmp183_;
			ValaMethod* _tmp184_;
			_tmp182_ = method;
			_tmp183_ = self->priv->metadata;
			vala_method_set_is_virtual (_tmp182_, vala_gir_parser_metadata_get_bool (_tmp183_, BALA_GIR_PARSER_ARGUMENT_TYPE_VIRTUAL, FALSE));
			_tmp184_ = method;
			vala_method_set_is_abstract (_tmp184_, FALSE);
		} else {
			ValaGirParserMetadata* _tmp185_;
			_tmp185_ = self->priv->metadata;
			if (vala_gir_parser_metadata_has_argument (_tmp185_, BALA_GIR_PARSER_ARGUMENT_TYPE_ABSTRACT)) {
				ValaMethod* _tmp186_;
				ValaGirParserMetadata* _tmp187_;
				ValaMethod* _tmp188_;
				_tmp186_ = method;
				_tmp187_ = self->priv->metadata;
				vala_method_set_is_abstract (_tmp186_, vala_gir_parser_metadata_get_bool (_tmp187_, BALA_GIR_PARSER_ARGUMENT_TYPE_ABSTRACT, FALSE));
				_tmp188_ = method;
				vala_method_set_is_virtual (_tmp188_, FALSE);
			}
		}
		_tmp189_ = self->priv->metadata;
		if (vala_gir_parser_metadata_has_argument (_tmp189_, BALA_GIR_PARSER_ARGUMENT_TYPE_VFUNC_NAME)) {
			ValaMethod* _tmp190_;
			...
			_tmp192_ = vala_gir_parser_metadata_get_string (_tmp191_, BALA_GIR_PARSER_ARGUMENT_TYPE_VFUNC_NAME);
			_tmp193_ = _tmp192_;
		...
		if (vala_gir_parser_metadata_has_argument (_tmp195_, BALA_GIR_PARSER_ARGUMENT_TYPE_FINISH_VFUNC_NAME)) {
			ValaMethod* _tmp196_;
			...
			_tmp198_ = vala_gir_parser_metadata_get_string (_tmp197_, BALA_GIR_PARSER_ARGUMENT_TYPE_FINISH_VFUNC_NAME);
			_tmp199_ = _tmp198_;
	...
	_tmp202_ = vala_gir_parser_metadata_get_expression (_tmp201_, BALA_GIR_PARSER_ARGUMENT_TYPE_THROWS);
	_tmp203_ = _tmp202_;
	...
	if (_tmp204_) {
		...
		if (vala_gir_parser_metadata_has_argument (_tmp205_, BALA_GIR_PARSER_ARGUMENT_TYPE_THROWS)) {
			...
			_tmp207_ = vala_gir_parser_metadata_get_string (_tmp206_, BALA_GIR_PARSER_ARGUMENT_TYPE_THROWS);
			_tmp208_ = _tmp207_;
			...
			_tmp212__length1 = error_types_length1;
			{
				...
				for (error_type_name_it = 0; error_type_name_it < error_type_name_collection_length1; error_type_name_it = error_type_name_it + 1) {
					...
					error_type_name = _tmp213_;
					{
						...
						_tmp216_ = vala_gir_parser_metadata_get_source_reference (_tmp215_, BALA_GIR_PARSER_ARGUMENT_TYPE_THROWS);
						_tmp217_ = _tmp216_;
						...
						if (BALA_IS_METHOD (_tmp220_)) {
							...
							_tmp221_ = s;
							_tmp222_ = error_type;
							vala_method_add_error_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp221_, BALA_TYPE_METHOD, ValaMethod), _tmp222_);
						} else {
							ValaSymbol* _tmp223_;
							ValaDataType* _tmp224_;
							_tmp223_ = s;
							_tmp224_ = error_type;
							vala_delegate_add_error_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp223_, BALA_TYPE_DELEGATE, ValaDelegate), _tmp224_);
						}
			...
			if (g_strcmp0 (_tmp225_, "1") == 0) {
				...
				if (BALA_IS_METHOD (_tmp226_)) {
					...
					_tmp229_ = _tmp228_;
					vala_method_add_error_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp227_, BALA_TYPE_METHOD, ValaMethod), (ValaDataType*) _tmp229_);
					...
					_tmp232_ = _tmp231_;
					vala_delegate_add_error_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp230_, BALA_TYPE_DELEGATE, ValaDelegate), (ValaDataType*) _tmp232_);
	...
	if (BALA_IS_METHOD (_tmp233_)) {
		...
		_tmp234_ = s;
		_tmp235_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp234_, BALA_TYPE_METHOD, ValaMethod));
		m = _tmp235_;
		_tmp236_ = m;
		_tmp237_ = self->priv->metadata;
		vala_code_node_set_attribute ((ValaCodeNode*) _tmp236_, "PrintfFormat", vala_gir_parser_metadata_get_bool (_tmp237_, BALA_GIR_PARSER_ARGUMENT_TYPE_PRINTF_FORMAT, FALSE), NULL);
		_tmp238_ = self->priv->metadata;
		if (vala_gir_parser_metadata_has_argument (_tmp238_, BALA_GIR_PARSER_ARGUMENT_TYPE_SENTINEL)) {
			ValaMethod* _tmp239_;
			...
			_tmp241_ = vala_gir_parser_metadata_get_string (_tmp240_, BALA_GIR_PARSER_ARGUMENT_TYPE_SENTINEL);
			_tmp242_ = _tmp241_;
	...
	if (BALA_IS_ARRAY_TYPE (_tmp244_)) {
		...
		_tmp243_ = vala_gir_parser_metadata_has_argument (_tmp245_, BALA_GIR_PARSER_ARGUMENT_TYPE_ARRAY_LENGTH_IDX);
	} else {
		_tmp243_ = FALSE;
	}
	if (_tmp243_) {
		...
		return_array_length_idx = vala_gir_parser_metadata_get_integer (_tmp246_, BALA_GIR_PARSER_ARGUMENT_TYPE_ARRAY_LENGTH_IDX);
	} else {
	...
	if (vala_gir_parser_metadata_has_argument (_tmp257_, BALA_GIR_PARSER_ARGUMENT_TYPE_FINISH_NAME)) {
		ValaSymbol* _tmp258_;
		...
		_tmp260_ = vala_gir_parser_metadata_get_string (_tmp259_, BALA_GIR_PARSER_ARGUMENT_TYPE_FINISH_NAME);
		_tmp261_ = _tmp260_;
		vala_code_node_set_attribute_string ((ValaCodeNode*) _tmp258_, "CCode", "finish_name", _tmp261_, NULL);
		_g_free0 (_tmp261_);
	}
	_tmp262_ = self->priv->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp262_, BALA_GIR_PARSER_ARGUMENT_TYPE_FINISH_INSTANCE)) {
		ValaSymbol* _tmp263_;
		ValaGirParserMetadata* _tmp264_;
		_tmp263_ = s;
		_tmp264_ = self->priv->metadata;
		vala_code_node_set_attribute_bool ((ValaCodeNode*) _tmp263_, "CCode", "finish_instance", vala_gir_parser_metadata_get_bool (_tmp264_, BALA_GIR_PARSER_ARGUMENT_TYPE_FINISH_INSTANCE, FALSE), NULL);
	}
	instance_idx = -2;
	...
	if (_tmp265_) {
		...
		if (vala_gir_parser_metadata_has_argument (_tmp267_, BALA_GIR_PARSER_ARGUMENT_TYPE_INSTANCE_IDX)) {
			ValaGirParserMetadata* _tmp268_;
			_tmp268_ = self->priv->metadata;
			instance_idx = vala_gir_parser_metadata_get_integer (_tmp268_, BALA_GIR_PARSER_ARGUMENT_TYPE_INSTANCE_IDX);
			if (instance_idx != 0) {
				ValaSymbol* _tmp269_;
				_tmp269_ = s;
	...
	_tmp273_ = vala_array_list_new (BALA_GIR_PARSER_TYPE_PARAMETER_INFO, (GBoxedCopyFunc) vala_gir_parser_parameter_info_ref, (GDestroyNotify) vala_gir_parser_parameter_info_unref, _tmp272_);
	parameters = _tmp273_;
			...
			if (is_instance_parameter) {
				...
				if (_tmp310_ != NULL) {
					...
					if (_tmp313_ == BALA_PARAMETER_DIRECTION_IN) {
						...
						ValaMethod* _tmp320_;
						_tmp320_ = m;
						vala_method_set_binding (_tmp320_, BALA_MEMBER_BINDING_STATIC);
					}
				}
			}
                             ...
                             const gchar* element_name)
{
	...
	if (_tmp8_->new_symbol) {
		...
		cl = _tmp13_;
		_tmp14_ = self->priv->metadata;
		if (vala_gir_parser_metadata_has_argument (_tmp14_, BALA_GIR_PARSER_ARGUMENT_TYPE_COMPACT)) {
			ValaClass* _tmp15_;
			ValaGirParserMetadata* _tmp16_;
			_tmp15_ = cl;
			_tmp16_ = self->priv->metadata;
			vala_class_set_is_compact (_tmp15_, vala_gir_parser_metadata_get_bool (_tmp16_, BALA_GIR_PARSER_ARGUMENT_TYPE_COMPACT, FALSE));
		} else {
			ValaClass* _tmp17_;
			_tmp17_ = cl;
		...
		_tmp23_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp22_, BALA_TYPE_CLASS, ValaClass));
		_vala_code_node_unref0 (cl);
		cl = _tmp23_;
	}
	_tmp24_ = cl;
	...
	_tmp26_ = cl;
	vala_symbol_set_access ((ValaSymbol*) _tmp26_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
	_tmp27_ = self->priv->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp27_, BALA_GIR_PARSER_ARGUMENT_TYPE_BASE_TYPE)) {
		ValaClass* _tmp28_;
		ValaGirParserMetadata* _tmp29_;
		gchar* _tmp30_;
		gchar* _tmp31_;
		...
		_tmp28_ = cl;
		_tmp29_ = self->priv->metadata;
		_tmp30_ = vala_gir_parser_metadata_get_string (_tmp29_, BALA_GIR_PARSER_ARGUMENT_TYPE_BASE_TYPE);
		_tmp31_ = _tmp30_;
		_tmp32_ = self->priv->metadata;
		_tmp33_ = vala_gir_parser_metadata_get_source_reference (_tmp32_, BALA_GIR_PARSER_ARGUMENT_TYPE_BASE_TYPE);
		_tmp34_ = _tmp33_;
...
vala_gir_parser_parse_union (ValaGirParser* self)
{
	...
	if (_tmp16_->new_symbol) {
		...
		_tmp28_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp27_, BALA_TYPE_STRUCT, ValaStruct));
		_vala_code_node_unref0 (st);
		st = _tmp28_;
	}
	_tmp29_ = st;
	vala_symbol_set_access ((ValaSymbol*) _tmp29_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
	vala_gir_parser_next (self);
	_tmp30_ = st;
...
vala_gir_parser_parse_constant (ValaGirParser* self)
{
	...
	_tmp18_ = c;
	vala_symbol_set_access ((ValaSymbol*) _tmp18_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
	_tmp19_ = c;
	_tmp20_ = comment;
			...
			while (TRUE) {
				...
				if (_tmp13_ != NULL) {
					...
					if (BALA_IS_UNRESOLVED_SYMBOL (_tmp19_)) {
						...
						_tmp20_ = map_to;
						_tmp21_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp20_, BALA_TYPE_UNRESOLVED_SYMBOL, ValaUnresolvedSymbol));
						umap_to = _tmp21_;
						while (TRUE) {
...
vala_gir_parser_resolve_type_arguments (ValaGirParser* self)
{
	...
	while (TRUE) {
		...
		_tmp12_ = sym;
		_tmp13_ = _vala_code_node_ref0 (BALA_IS_STRUCT (_tmp12_) ? ((ValaStruct*) _tmp12_) : NULL);
		st = _tmp13_;
		_tmp16_ = st;
		if (_tmp16_ != NULL) {
			ValaStruct* _tmp17_;
                                   ...
                                   ValaGirParserNode* iface_node)
{
	...
	_tmp1_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp0_, BALA_TYPE_INTERFACE, ValaInterface));
	iface = _tmp1_;
	has_instantiable_prereq = FALSE;
	{
		...
		while (TRUE) {
			...
			if (BALA_IS_UNRESOLVED_TYPE (_tmp12_)) {
				...
				ValaSymbol* _tmp19_;
				_tmp13_ = prereq;
				_tmp14_ = vala_unresolved_type_get_unresolved_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp13_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType));
				_tmp15_ = _tmp14_;
                               ...
                               ValaGirParserNode* alias)
{
	...
	if (BALA_IS_UNRESOLVED_TYPE (_tmp0_)) {
		...
		_tmp3_ = alias->parent;
		_tmp4_ = base_type;
		_tmp5_ = vala_unresolved_type_get_unresolved_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp4_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType));
		_tmp6_ = _tmp5_;
		...
		if (BALA_IS_POINTER_TYPE (_tmp13_)) {
			...
			_tmp15_ = vala_pointer_type_get_base_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp14_, BALA_TYPE_POINTER_TYPE, ValaPointerType));
			_tmp16_ = _tmp15_;
	...
	if (BALA_IS_STRUCT (_tmp33_)) {
		ValaSymbol* _tmp34_;
		_tmp34_ = type_sym;
		_tmp32_ = vala_struct_is_simple_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp34_, BALA_TYPE_STRUCT, ValaStruct));
	} else {
		_tmp32_ = FALSE;
	}
	if (_tmp32_) {
	...
	if (_tmp35_) {
		...
		st = _tmp42_;
		_tmp43_ = st;
		vala_symbol_set_access ((ValaSymbol*) _tmp43_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
		_tmp44_ = base_type;
		if (_tmp44_ != NULL) {
			ValaStruct* _tmp45_;
		...
		if (BALA_IS_CLASS (_tmp52_)) {
			...
			cl = _tmp55_;
			_tmp56_ = cl;
			vala_symbol_set_access ((ValaSymbol*) _tmp56_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
			_tmp57_ = base_type;
			if (_tmp57_ != NULL) {
				ValaClass* _tmp58_;
				ValaDataType* _tmp59_;
			...
			_tmp62_ = cl;
			_tmp63_ = type_sym;
			_tmp64_ = vala_class_get_is_compact (G_TYPE_CHECK_INSTANCE_CAST (_tmp63_, BALA_TYPE_CLASS, ValaClass));
			_tmp65_ = _tmp64_;
			...
			if (BALA_IS_INTERFACE (_tmp68_)) {
				...
				iface = _tmp71_;
				_tmp72_ = iface;
				vala_symbol_set_access ((ValaSymbol*) _tmp72_, BALA_SYMBOL_ACCESSIBILITY_PUBLIC);
				_tmp73_ = base_type;
				if (_tmp73_ != NULL) {
				...
				if (BALA_IS_DELEGATE (_tmp80_)) {
					...
					ValaSymbol* _tmp140_;
					_tmp81_ = type_sym;
					_tmp82_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp81_, BALA_TYPE_DELEGATE, ValaDelegate));
					orig = _tmp82_;
					_tmp83_ = base_node;
					if (_tmp83_ != NULL) {
						ValaGirParserNode* _tmp84_;
						...
						_tmp87_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp86_, BALA_TYPE_DELEGATE, ValaDelegate));
					...
					_tmp116_ = vala_array_list_new (BALA_TYPE_DATA_TYPE, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, _tmp115_);
                                  ...
                                  ValaGirParserNode* node)
{
	...
	if (BALA_IS_CALLABLE (_tmp7_)) {
		...
		ValaDataType* _tmp11_;
		_tmp8_ = s;
		_tmp9_ = vala_callable_get_return_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp8_, BALA_TYPE_CALLABLE, ValaCallable));
		_tmp10_ = _tmp9_;
		_tmp11_ = _vala_code_node_ref0 (_tmp10_);
		_vala_code_node_unref0 (return_type);
		return_type = _tmp11_;
	...
	if (_tmp12_) {
		...
		if (_tmp24_) {
			...
			if (n_out_parameters == 1) {
				...
				if (_tmp51_ == BALA_PARAMETER_DIRECTION_OUT) {
					...
					if (BALA_IS_UNRESOLVED_TYPE (_tmp55_)) {
						...
						_tmp60_ = _tmp59_;
						_tmp61_ = vala_unresolved_type_get_unresolved_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp60_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType));
						_tmp62_ = _tmp61_;
						...
						if (_tmp65_) {
							...
							if (!vala_gir_parser_metadata_get_bool (_tmp75_, BALA_GIR_PARSER_ARGUMENT_TYPE_RETURN_VOID, FALSE)) {
			...
			if (_tmp82_) {
				...
				_tmp87_ = node->parent;
				_tmp88_ = return_type;
				_tmp89_ = vala_unresolved_type_get_unresolved_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp88_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType));
				_tmp90_ = _tmp89_;
				...
				if (_tmp93_ != NULL) {
					...
					while (TRUE) {
						...
						if (BALA_IS_UNRESOLVED_TYPE (_tmp100_)) {
							...
							_tmp104_ = _tmp103_;
							_tmp105_ = vala_unresolved_type_get_unresolved_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp104_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType));
							_tmp106_ = _tmp105_;
		...
		while (TRUE) {
			...
			if (_tmp127_) {
				...
				if (BALA_IS_UNRESOLVED_TYPE (_tmp135_)) {
					...
					_tmp137_ = type;
					_tmp138_ = vala_unresolved_type_get_unresolved_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp137_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType));
					_tmp139_ = _tmp138_;
					...
					if (BALA_IS_VALUE_TYPE (_tmp142_)) {
						...
						_tmp145_ = _tmp144_;
						_tmp146_ = _vala_code_node_ref0 (BALA_IS_STRUCT (_tmp145_) ? ((ValaStruct*) _tmp145_) : NULL);
						_vala_code_node_unref0 (st);
						st = _tmp146_;
					}
				}
			...
			if (BALA_IS_METHOD (_tmp151_)) {
				...
				if (_tmp163_->is_async) {
					...
					if (_tmp164_) {
						...
						_tmp175_ = s;
						vala_method_set_coroutine (G_TYPE_CHECK_INSTANCE_CAST (_tmp175_, BALA_TYPE_METHOD, ValaMethod), TRUE);
						_tmp176_ = info;
						_tmp176_->keep = FALSE;
					}
				}
			...
			if (_tmp189_) {
				...
				if (_tmp200_) {
					...
					_tmp209_ = _tmp208_;
					vala_delegate_add_error_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp207_, BALA_TYPE_DELEGATE, ValaDelegate), (ValaDataType*) _tmp209_);
	...
	last = -1;
	{
		...
		while (TRUE) {
			...
			if (_tmp271_) {
				...
				_tmp274_ = s;
				_tmp275_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp274_, BALA_TYPE_DELEGATE, ValaDelegate));
				d = _tmp275_;
				_tmp276_ = d;
			...
			if (_tmp304_) {
				...
				ValaSymbol* _tmp312_;
				_tmp309_ = s;
				_tmp310_ = vala_method_get_binding (G_TYPE_CHECK_INSTANCE_CAST (_tmp309_, BALA_TYPE_METHOD, ValaMethod));
				_tmp311_ = _tmp310_;
	...
	}
	{
		...
		while (TRUE) {
			...
			if (BALA_IS_CALLABLE (_tmp329_)) {
				...
				vala_callable_add_parameter (G_TYPE_CHECK_INSTANCE_CAST (_tmp330_, BALA_TYPE_CALLABLE, ValaCallable), _tmp332_);
			}
			_tmp333_ = info;
			...
			if (_tmp398_->is_async) {
				...
				if (BALA_IS_UNRESOLVED_TYPE (_tmp404_)) {
					...
					_tmp407_ = vala_unresolved_type_get_unresolved_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp406_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType));
					_tmp408_ = _tmp407_;
					...
					if (BALA_IS_DELEGATE (_tmp410_)) {
						...
						_tmp412_ = vala_delegate_type_new (G_TYPE_CHECK_INSTANCE_CAST (_tmp411_, BALA_TYPE_DELEGATE, ValaDelegate));
				...
				if (BALA_IS_DELEGATE_TYPE (_tmp413_)) {
					...
					_tmp415_ = vala_delegate_type_get_delegate_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp414_, BALA_TYPE_DELEGATE_TYPE, ValaDelegateType));
					_tmp416_ = _tmp415_;
	...
	if (BALA_IS_CALLABLE (_tmp455_)) {
		...
		vala_callable_set_return_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp456_, BALA_TYPE_CALLABLE, ValaCallable), _tmp457_);
	}
	_vala_code_node_unref0 (return_type);
	_vala_iterable_unref0 (parameters);
	_vala_code_node_unref0 (s);
                                          ...
                                          ValaGirParserNode* node)
{
	...
	ns_cprefix = _tmp0_;
	_tmp1_ = node->symbol;
	_tmp2_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, BALA_TYPE_METHOD, ValaMethod));
	method = _tmp2_;
	...
	if (_tmp12_) {
		...
		_tmp23_ = _tmp22_;
		_tmp24_ = vala_unresolved_type_get_unresolved_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp23_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType));
		_tmp25_ = _tmp24_;
		...
		if (_tmp29_) {
			...
			if (_tmp62_) {
				...
				_tmp71_ = method;
				vala_method_set_binding (_tmp71_, BALA_MEMBER_BINDING_INSTANCE);
				_tmp72_ = parent;
	...
	}
	{
		...
		while (TRUE) {
			...
			if (BALA_IS_SIGNAL (_tmp43_)) {
				...
				ValaSignal* _tmp47_;
				_tmp44_ = sym;
				_tmp45_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp44_, BALA_TYPE_SIGNAL, ValaSignal));
				sig = _tmp45_;
				_tmp46_ = sig;
				...
				if (BALA_IS_PROPERTY (_tmp48_)) {
					...
					_tmp49_ = sym;
					_tmp50_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp49_, BALA_TYPE_PROPERTY, ValaProperty));
					prop = _tmp50_;
					_tmp51_ = prop;
                                      ...
                                      ValaGirParserNode* node)
{
		...
		while (TRUE) {
			...
			if (_tmp14_ == BALA_PARAMETER_DIRECTION_IN) {
				...
				if (requires_pointer) {
					...
					_tmp15_ = param;
					vala_parameter_set_direction (_tmp15_, BALA_PARAMETER_DIRECTION_IN);
					_tmp16_ = param;
	...
	if (_tmp30_ == NULL) {
		...
		gchar* _tmp32_;
		_tmp31_ = m;
		_vala_assert (BALA_IS_CREATION_METHOD (_tmp31_), "m is CreationMethod");
	...
	if (_tmp80_) {
		...
		_tmp86_ = _tmp85_->symbol;
		_tmp87_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp86_, BALA_TYPE_METHOD, ValaMethod));
		...
		if (BALA_IS_CREATION_METHOD (_tmp88_)) {
			...
			_tmp90_ = vala_creation_method_get_class_name (G_TYPE_CHECK_INSTANCE_CAST (_tmp89_, BALA_TYPE_CREATION_METHOD, ValaCreationMethod));
			_tmp91_ = _tmp90_;
			_tmp92_ = m;
		...
		_tmp193_ = vala_array_list_new (BALA_TYPE_DATA_TYPE, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, _tmp192_);
                                         ...
                                         ValaGirParserNode* prop_node)
{
	...
	_tmp2_ = _vala_code_node_ref0 (BALA_IS_CLASS (_tmp1_) ? ((ValaClass*) _tmp1_) : NULL);
	cl = _tmp2_;
	_tmp3_ = cl;
	if (_tmp3_ == NULL) {
		result = NULL;
	...
	}
	{
		...
		while (TRUE) {
			...
			_tmp16_ = type;
			_tmp17_ = vala_unresolved_type_get_unresolved_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp16_, BALA_TYPE_UNRESOLVED_TYPE, ValaUnresolvedType));
			_tmp18_ = _tmp17_;
			...
			if (_tmp20_) {
				...
				if (_tmp27_) {
					...
					_tmp33_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp32_, BALA_TYPE_PROPERTY, ValaProperty));
...
{
	return vala_gir_parser_construct (BALA_TYPE_GIR_PARSER);
}
...
vala_gir_parser_argument_new (ValaExpression* expression,
                              ValaSourceReference* source_reference)
{
	return vala_gir_parser_argument_construct (BALA_GIR_PARSER_TYPE_ARGUMENT, expression, source_reference);
}
...
{
	return vala_gir_parser_metadata_set_construct (BALA_GIR_PARSER_TYPE_METADATA_SET, selector);
}
...
vala_gir_parser_metadata_set_get_type_once (void)
{
	...
	vala_gir_parser_metadata_set_type_id = g_type_register_static (BALA_GIR_PARSER_TYPE_METADATA, "ValaGirParserMetadataSet", &g_define_type_info, 0);
...
vala_gir_parser_metadata_new (const gchar* pattern,
                              ...
                              ValaSourceReference* source_reference)
{
	return vala_gir_parser_metadata_construct (BALA_GIR_PARSER_TYPE_METADATA, pattern, selector, source_reference);
}
		...
		while (TRUE) {
			...
			if (_tmp12_) {
				...
				if (_tmp22_ == _tmp24_) {
					...
					ValaGirParserMetadata* _tmp36_;
					_tmp27_ = _result_;
					_tmp28_ = _vala_gir_parser_metadata_ref0 (BALA_GIR_PARSER_IS_METADATA_SET (_tmp27_) ? ((ValaGirParserMetadataSet*) _tmp27_) : NULL);
					ms = _tmp28_;
					_tmp29_ = ms;
					if (_tmp29_ == NULL) {
                                      ...
                                      ValaGirParserArgumentType arg)
{
	...
	if (_tmp2_) {
		...
		_tmp9_ = _tmp8_;
		_tmp10_ = _vala_code_node_ref0 (BALA_IS_INTEGER_LITERAL (_tmp9_) ? ((ValaIntegerLiteral*) _tmp9_) : NULL);
		lit = _tmp10_;
		_tmp11_ = lit;
		if (_tmp11_ != NULL) {
			ValaIntegerLiteral* _tmp12_;
                                        ...
                                        gpointer klass)
{
	...
	_tmp3_ = vala_hash_map_new (BALA_GIR_PARSER_TYPE_ARGUMENT_TYPE, NULL, NULL, BALA_GIR_PARSER_TYPE_ARGUMENT, (GBoxedCopyFunc) vala_gir_parser_argument_ref, (GDestroyNotify) vala_gir_parser_argument_unref, _tmp0_, _tmp1_, _tmp2_);
...
{
	return vala_gir_parser_metadata_parser_construct (BALA_GIR_PARSER_TYPE_METADATA_PARSER);
}
	...
	switch (_tmp2_) {
		...
		case BALA_TOKEN_TYPE_MINUS:
		{
			...
			if (_tmp10_ == NULL) {
				...
				_tmp19_ = _tmp18_;
				_tmp20_ = vala_unary_expression_new (BALA_UNARY_OPERATOR_MINUS, _tmp16_, _tmp19_);
				_vala_code_node_unref0 (expr);
		...
		case BALA_TOKEN_TYPE_IDENTIFIER:
		{
			...
			while (TRUE) {
				...
				if (!(vala_gir_parser_metadata_parser_next (self) == BALA_TOKEN_TYPE_DOT)) {
					break;
				}
				if (vala_gir_parser_metadata_parser_next (self) != BALA_TOKEN_TYPE_IDENTIFIER) {
					ValaSourceReference* _tmp37_;
					ValaSourceReference* _tmp38_;
		...
		case BALA_TOKEN_TYPE_OPEN_PARENS:
		{
			...
			ValaTuple* _tmp56_;
			if (vala_gir_parser_metadata_parser_next (self) != BALA_TOKEN_TYPE_CLOSE_PARENS) {
...
{
	return vala_gir_parser_node_construct (BALA_GIR_PARSER_TYPE_NODE, name);
}
                                 ...
                                 ValaGirParserNode* node)
{
	...
	if (_tmp3_ == NULL) {
		...
		ValaArrayList* _tmp8_;
		_tmp4_ = g_direct_equal;
		_tmp5_ = vala_array_list_new (BALA_GIR_PARSER_TYPE_NODE, (GBoxedCopyFunc) vala_gir_parser_node_ref, (GDestroyNotify) vala_gir_parser_node_unref, _tmp4_);
		_vala_iterable_unref0 (nodes);
		nodes = _tmp5_;
		_tmp6_ = self->scope;
		_tmp7_ = node->name;
...
vala_gir_parser_node_get_lower_case_cprefix (ValaGirParserNode* self)
{
	...
	if (_tmp4_) {
		...
		if (vala_gir_parser_metadata_has_argument (_tmp9_, BALA_GIR_PARSER_ARGUMENT_TYPE_LOWER_CASE_CPREFIX)) {
			ValaGirParserMetadata* _tmp10_;
			gchar* _tmp11_;
			_tmp10_ = self->metadata;
			_tmp11_ = vala_gir_parser_metadata_get_string (_tmp10_, BALA_GIR_PARSER_ARGUMENT_TYPE_LOWER_CASE_CPREFIX);
			_g_free0 (prefix);
			prefix = _tmp11_;
		} else {
			ValaGirParserMetadata* _tmp12_;
			_tmp12_ = self->metadata;
			if (vala_gir_parser_metadata_has_argument (_tmp12_, BALA_GIR_PARSER_ARGUMENT_TYPE_CPREFIX)) {
				ValaGirParserMetadata* _tmp13_;
				gchar* _tmp14_;
				_tmp13_ = self->metadata;
				_tmp14_ = vala_gir_parser_metadata_get_string (_tmp13_, BALA_GIR_PARSER_ARGUMENT_TYPE_CPREFIX);
				_g_free0 (prefix);
				prefix = _tmp14_;
			} else {
				ValaSymbol* _tmp15_;
...
vala_gir_parser_node_get_lower_case_csuffix (ValaGirParserNode* self)
{
	...
	if (vala_gir_parser_metadata_has_argument (_tmp2_, BALA_GIR_PARSER_ARGUMENT_TYPE_LOWER_CASE_CSUFFIX)) {
		ValaGirParserMetadata* _tmp3_;
		gchar* _tmp4_;
		_tmp3_ = self->metadata;
		_tmp4_ = vala_gir_parser_metadata_get_string (_tmp3_, BALA_GIR_PARSER_ARGUMENT_TYPE_LOWER_CASE_CSUFFIX);
		_g_free0 (suffix);
		suffix = _tmp4_;
	}
	_tmp8_ = suffix;
	...
	if (_tmp6_) {
		ValaGirParserMetadata* _tmp13_;
		_tmp13_ = self->metadata;
		_tmp5_ = !vala_gir_parser_metadata_has_argument (_tmp13_, BALA_GIR_PARSER_ARGUMENT_TYPE_NAME);
	} else {
		_tmp5_ = FALSE;
	}
	if (_tmp5_) {
...
vala_gir_parser_node_get_cprefix (ValaGirParserNode* self)
{
	...
	_tmp2_ = self->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp2_, BALA_GIR_PARSER_ARGUMENT_TYPE_CPREFIX)) {
		ValaGirParserMetadata* _tmp3_;
		gchar* _tmp4_;
		_tmp3_ = self->metadata;
		_tmp4_ = vala_gir_parser_metadata_get_string (_tmp3_, BALA_GIR_PARSER_ARGUMENT_TYPE_CPREFIX);
		_g_free0 (prefix);
		prefix = _tmp4_;
	} else {
		ValaSymbol* _tmp5_;
...
vala_gir_parser_node_get_cname (ValaGirParserNode* self)
{
	...
	_tmp2_ = self->metadata;
	if (vala_gir_parser_metadata_has_argument (_tmp2_, BALA_GIR_PARSER_ARGUMENT_TYPE_CNAME)) {
		ValaGirParserMetadata* _tmp3_;
		gchar* _tmp4_;
		_tmp3_ = self->metadata;
		_tmp4_ = vala_gir_parser_metadata_get_string (_tmp3_, BALA_GIR_PARSER_ARGUMENT_TYPE_CNAME);
		_g_free0 (cname);
		cname = _tmp4_;
	} else {
		ValaSymbol* _tmp5_;
...
vala_gir_parser_node_get_default_cname (ValaGirParserNode* self)
{
	...
	if (BALA_IS_FIELD (_tmp2_)) {
		...
		_tmp3_ = self->symbol;
		_tmp4_ = vala_field_get_binding (G_TYPE_CHECK_INSTANCE_CAST (_tmp3_, BALA_TYPE_FIELD, ValaField));
		_tmp5_ = _tmp4_;
...
vala_gir_parser_node_get_cheader_filename (ValaGirParserNode* self)
{
	...
	if (vala_gir_parser_metadata_has_argument (_tmp0_, BALA_GIR_PARSER_ARGUMENT_TYPE_CHEADER_FILENAME)) {
		ValaGirParserMetadata* _tmp1_;
		gchar* _tmp2_;
		_tmp1_ = self->metadata;
		_tmp2_ = vala_gir_parser_metadata_get_string (_tmp1_, BALA_GIR_PARSER_ARGUMENT_TYPE_CHEADER_FILENAME);
		result = _tmp2_;
		return result;
	}
	_tmp3_ = self->symbol;
                                         ...
                                         ValaGirParserNode* source)
{
	...
	while (TRUE) {
		...
		if (BALA_IS_METHOD (_tmp6_)) {
			...
			_tmp9_ = node;
			_tmp10_ = _tmp9_->symbol;
			vala_method_set_binding (G_TYPE_CHECK_INSTANCE_CAST (_tmp10_, BALA_TYPE_METHOD, ValaMethod), BALA_MEMBER_BINDING_CLASS);
		} else {
			gint _tmp11_;
			_tmp11_ = i;
			i = _tmp11_ + 1;
                              ...
                              ValaGirParser* parser)
{
	...
	if (_tmp65_ != NULL) {
		...
		if (BALA_IS_METHOD (_tmp66_)) {
			...
			gboolean _tmp204_;
			_tmp67_ = self->symbol;
			_tmp68_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp67_, BALA_TYPE_METHOD, ValaMethod));
			m = _tmp68_;
			...
			colliding = _tmp71_;
			{
				...
				while (TRUE) {
					...
					if (BALA_IS_FIELD (_tmp84_)) {
						...
						_tmp88_ = _tmp87_;
						_tmp89_ = sym;
						_tmp90_ = vala_variable_get_variable_type ((ValaVariable*) G_TYPE_CHECK_INSTANCE_CAST (_tmp89_, BALA_TYPE_FIELD, ValaField));
						_tmp91_ = _tmp90_;
						...
						if (BALA_IS_SIGNAL (_tmp103_)) {
							...
							_tmp105_ = sym;
							_tmp106_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp105_, BALA_TYPE_SIGNAL, ValaSignal));
							sig = _tmp106_;
							_tmp108_ = m;
			...
			if (!BALA_IS_CREATION_METHOD (_tmp180_)) {
				...
				if (vala_gir_parser_metadata_has_argument (_tmp181_, BALA_GIR_PARSER_ARGUMENT_TYPE_DESTROYS_INSTANCE)) {
					ValaMethod* _tmp182_;
					ValaGirParserMetadata* _tmp183_;
					_tmp182_ = m;
					_tmp183_ = self->metadata;
					vala_code_node_set_attribute ((ValaCodeNode*) _tmp182_, "DestroysInstance", vala_gir_parser_metadata_get_bool (_tmp183_, BALA_GIR_PARSER_ARGUMENT_TYPE_DESTROYS_INSTANCE, FALSE), NULL);
				}
				_tmp184_ = self->metadata;
				if (vala_gir_parser_metadata_has_argument (_tmp184_, BALA_GIR_PARSER_ARGUMENT_TYPE_RETURNS_MODIFIED_POINTER)) {
					ValaMethod* _tmp185_;
					ValaGirParserMetadata* _tmp186_;
					_tmp185_ = m;
					_tmp186_ = self->metadata;
					vala_code_node_set_attribute ((ValaCodeNode*) _tmp185_, "ReturnsModifiedPointer", vala_gir_parser_metadata_get_bool (_tmp186_, BALA_GIR_PARSER_ARGUMENT_TYPE_RETURNS_MODIFIED_POINTER, FALSE), NULL);
				}
				_tmp187_ = self->metadata;
				if (vala_gir_parser_metadata_has_argument (_tmp187_, BALA_GIR_PARSER_ARGUMENT_TYPE_VFUNC_NAME)) {
					...
					_tmp190_ = vala_gir_parser_metadata_get_string (_tmp189_, BALA_GIR_PARSER_ARGUMENT_TYPE_VFUNC_NAME);
					_tmp191_ = _tmp190_;
			...
			if (vala_gir_parser_metadata_has_argument (_tmp199_, BALA_GIR_PARSER_ARGUMENT_TYPE_DELEGATE_TARGET)) {
				ValaMethod* _tmp200_;
				ValaGirParserMetadata* _tmp201_;
				_tmp200_ = m;
				_tmp201_ = self->metadata;
				vala_code_node_set_attribute_bool ((ValaCodeNode*) _tmp200_, "CCode", "delegate_target", vala_gir_parser_metadata_get_bool (_tmp201_, BALA_GIR_PARSER_ARGUMENT_TYPE_DELEGATE_TARGET, FALSE), NULL);
			}
			_tmp202_ = m;
			...
			if (BALA_IS_PROPERTY (_tmp205_)) {
				...
				_tmp233_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp232_, BALA_TYPE_PROPERTY, ValaProperty));
				prop = _tmp233_;
				...
				if (_tmp467_ != NULL) {
					...
					if (_tmp468_) {
						...
						if (_tmp475_ != NULL) {
							...
							_tmp479_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp478_, BALA_TYPE_PROPERTY, ValaProperty));
				...
				if (vala_gir_parser_metadata_has_argument (_tmp513_, BALA_GIR_PARSER_ARGUMENT_TYPE_NO_ACCESSOR_METHOD)) {
					ValaProperty* _tmp514_;
					ValaGirParserMetadata* _tmp515_;
					_tmp514_ = prop;
					_tmp515_ = self->metadata;
					vala_code_node_set_attribute ((ValaCodeNode*) _tmp514_, "NoAccessorMethod", vala_gir_parser_metadata_get_bool (_tmp515_, BALA_GIR_PARSER_ARGUMENT_TYPE_NO_ACCESSOR_METHOD, FALSE), NULL);
				}
				_tmp516_ = prop;
				...
				if (BALA_IS_FIELD (_tmp534_)) {
					...
					_tmp536_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp535_, BALA_TYPE_FIELD, ValaField));
					field = _tmp536_;
					...
					if (vala_gir_parser_metadata_has_argument (_tmp543_, BALA_GIR_PARSER_ARGUMENT_TYPE_DELEGATE_TARGET)) {
						ValaField* _tmp544_;
						ValaGirParserMetadata* _tmp545_;
						_tmp544_ = field;
						_tmp545_ = self->metadata;
						vala_code_node_set_attribute_bool ((ValaCodeNode*) _tmp544_, "CCode", "delegate_target", vala_gir_parser_metadata_get_bool (_tmp545_, BALA_GIR_PARSER_ARGUMENT_TYPE_DELEGATE_TARGET, FALSE), NULL);
					}
					_tmp546_ = self->metadata;
					if (vala_gir_parser_metadata_has_argument (_tmp546_, BALA_GIR_PARSER_ARGUMENT_TYPE_DELEGATE_TARGET_CNAME)) {
						ValaField* _tmp547_;
						...
						_tmp549_ = vala_gir_parser_metadata_get_string (_tmp548_, BALA_GIR_PARSER_ARGUMENT_TYPE_DELEGATE_TARGET_CNAME);
						_tmp550_ = _tmp549_;
					...
					if (vala_gir_parser_metadata_has_argument (_tmp551_, BALA_GIR_PARSER_ARGUMENT_TYPE_DESTROY_NOTIFY_CNAME)) {
						ValaField* _tmp552_;
						...
						_tmp554_ = vala_gir_parser_metadata_get_string (_tmp553_, BALA_GIR_PARSER_ARGUMENT_TYPE_DESTROY_NOTIFY_CNAME);
						_tmp555_ = _tmp554_;
					...
					if (_tmp556_) {
						...
						_tmp564_ = _tmp563_;
						_tmp565_ = vala_delegate_type_get_delegate_symbol (G_TYPE_CHECK_INSTANCE_CAST (_tmp564_, BALA_TYPE_DELEGATE_TYPE, ValaDelegateType));
						_tmp566_ = _tmp565_;
						...
						if (BALA_IS_ARRAY_TYPE (_tmp573_)) {
							...
							if (vala_gir_parser_metadata_has_argument (_tmp574_, BALA_GIR_PARSER_ARGUMENT_TYPE_ARRAY_LENGTH_FIELD)) {
								...
								_tmp577_ = vala_gir_parser_metadata_get_string (_tmp576_, BALA_GIR_PARSER_ARGUMENT_TYPE_ARRAY_LENGTH_FIELD);
								_tmp578_ = _tmp577_;
							...
							if (_tmp619_) {
								...
								_tmp625_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp624_, BALA_TYPE_FIELD, ValaField));
								...
								if (_tmp650_) {
									{
										...
										while (TRUE) {
											...
											_tmp666_ = _vala_code_node_ref0 (BALA_IS_FIELD (_tmp665_) ? ((ValaField*) _tmp665_) : NULL);
											f = _tmp666_;
											_tmp667_ = f;
											if (_tmp667_ != NULL) {
												ValaField* _tmp668_;
		...
		if (vala_gir_parser_metadata_has_argument (_tmp730_, BALA_GIR_PARSER_ARGUMENT_TYPE_REPLACEMENT)) {
			ValaGirParserMetadata* _tmp731_;
			gchar* _tmp732_;
			self->deprecated = TRUE;
			_tmp731_ = self->metadata;
			_tmp732_ = vala_gir_parser_metadata_get_string (_tmp731_, BALA_GIR_PARSER_ARGUMENT_TYPE_REPLACEMENT);
			_g_free0 (self->deprecated_replacement);
			self->deprecated_replacement = _tmp732_;
		}
		_tmp733_ = self->metadata;
		if (vala_gir_parser_metadata_has_argument (_tmp733_, BALA_GIR_PARSER_ARGUMENT_TYPE_DEPRECATED_SINCE)) {
			ValaGirParserMetadata* _tmp734_;
			gchar* _tmp735_;
			self->deprecated = TRUE;
			_tmp734_ = self->metadata;
			_tmp735_ = vala_gir_parser_metadata_get_string (_tmp734_, BALA_GIR_PARSER_ARGUMENT_TYPE_DEPRECATED_SINCE);
		...
		if (vala_gir_parser_metadata_has_argument (_tmp742_, BALA_GIR_PARSER_ARGUMENT_TYPE_DEPRECATED)) {
			ValaGirParserMetadata* _tmp743_;
			_tmp743_ = self->metadata;
			self->deprecated = vala_gir_parser_metadata_get_bool (_tmp743_, BALA_GIR_PARSER_ARGUMENT_TYPE_DEPRECATED, TRUE);
			if (!self->deprecated) {
				_g_free0 (self->deprecated_since);
		...
		if (vala_gir_parser_metadata_has_argument (_tmp750_, BALA_GIR_PARSER_ARGUMENT_TYPE_EXPERIMENTAL)) {
			ValaSymbol* _tmp751_;
			ValaGirParserMetadata* _tmp752_;
			_tmp751_ = self->symbol;
			_tmp752_ = self->metadata;
			vala_code_node_set_attribute_bool ((ValaCodeNode*) _tmp751_, "Version", "experimental", vala_gir_parser_metadata_get_bool (_tmp752_, BALA_GIR_PARSER_ARGUMENT_TYPE_EXPERIMENTAL, FALSE), NULL);
		}
		_tmp753_ = self->metadata;
		if (vala_gir_parser_metadata_has_argument (_tmp753_, BALA_GIR_PARSER_ARGUMENT_TYPE_SINCE)) {
			ValaSymbol* _tmp754_;
			...
			_tmp758_ = vala_gir_parser_metadata_get_string (_tmp757_, BALA_GIR_PARSER_ARGUMENT_TYPE_SINCE);
			_tmp759_ = _tmp758_;
		...
		if (BALA_IS_NAMESPACE (_tmp772_)) {
			...
			if (vala_gir_parser_metadata_has_argument (_tmp776_, BALA_GIR_PARSER_ARGUMENT_TYPE_CHEADER_FILENAME)) {
				ValaSymbol* _tmp777_;
				...
				_tmp779_ = vala_gir_parser_metadata_get_string (_tmp778_, BALA_GIR_PARSER_ARGUMENT_TYPE_CHEADER_FILENAME);
				_tmp780_ = _tmp779_;
		...
		if (vala_gir_parser_metadata_has_argument (_tmp789_, BALA_GIR_PARSER_ARGUMENT_TYPE_FEATURE_TEST_MACRO)) {
			ValaSymbol* _tmp790_;
			...
			_tmp792_ = vala_gir_parser_metadata_get_string (_tmp791_, BALA_GIR_PARSER_ARGUMENT_TYPE_FEATURE_TEST_MACRO);
			_tmp793_ = _tmp792_;
	...
	if (_tmp823_) {
		...
		ValaClass* _tmp874_;
		{
			...
			while (TRUE) {
				...
				if (_tmp863_) {
					...
					_tmp862_ = !vala_gir_parser_metadata_get_bool (_tmp866_, BALA_GIR_PARSER_ARGUMENT_TYPE_HIDDEN, FALSE);
				} else {
					_tmp862_ = FALSE;
				}
				if (_tmp862_) {
		...
		_tmp871_ = _vala_code_node_ref0 (BALA_IS_CLASS (_tmp870_) ? ((ValaClass*) _tmp870_) : NULL);
		cl = _tmp871_;
		_tmp874_ = cl;
		if (_tmp874_ != NULL) {
			ValaClass* _tmp875_;
		...
		if (_tmp872_) {
			...
			_tmp886_ = cm;
			vala_symbol_set_access ((ValaSymbol*) _tmp886_, BALA_SYMBOL_ACCESSIBILITY_PROTECTED);
			_tmp887_ = cl;
			_tmp888_ = cm;
                                 ...
                                 gpointer klass_data)
{
	...
	_tmp1_ = vala_array_list_new (BALA_GIR_PARSER_TYPE_NODE, (GBoxedCopyFunc) vala_gir_parser_node_ref, (GDestroyNotify) vala_gir_parser_node_unref, _tmp0_);
                                    ...
                                    gpointer klass)
{
	...
	_tmp4_ = vala_array_list_new (BALA_GIR_PARSER_TYPE_NODE, (GBoxedCopyFunc) vala_gir_parser_node_ref, (GDestroyNotify) vala_gir_parser_node_unref, _tmp3_);
	self->members = _tmp4_;
	_tmp5_ = g_str_hash;
	_tmp6_ = g_str_equal;
	_tmp7_ = g_direct_equal;
	_tmp8_ = vala_hash_map_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, (GDestroyNotify) g_free, BALA_TYPE_ARRAY_LIST, (GBoxedCopyFunc) vala_iterable_ref, (GDestroyNotify) vala_iterable_unref, _tmp5_, _tmp6_, _tmp7_);
	self->scope = _tmp8_;
...
vala_gir_parser_parameter_info_new (ValaParameter* param,
                                    ...
                                    gboolean is_async)
{
	return vala_gir_parser_parameter_info_construct (BALA_GIR_PARSER_TYPE_PARAMETER_INFO, param, array_length_idx, closure_idx, destroy_idx, is_async);
}
                               ...
                               gpointer klass)
{
	...
	_tmp0_ = g_direct_equal;
	_tmp1_ = vala_array_list_new (BALA_GIR_PARSER_TYPE_METADATA, (GBoxedCopyFunc) vala_gir_parser_metadata_ref, (GDestroyNotify) vala_gir_parser_metadata_unref, _tmp0_);
	...
	_tmp6_ = vala_hash_map_new (BALA_TYPE_UNRESOLVED_SYMBOL, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, BALA_TYPE_SYMBOL, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, _vala_gir_parser_unresolved_symbol_hash_ghash_func, _vala_gir_parser_unresolved_symbol_equal_gequal_func, _tmp5_);
	self->priv->unresolved_symbols_map = _tmp6_;
	_tmp7_ = g_direct_equal;
	_tmp8_ = vala_array_list_new (BALA_TYPE_UNRESOLVED_SYMBOL, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, _tmp7_);
	self->priv->unresolved_gir_symbols = _tmp8_;
	_tmp9_ = g_direct_hash;
	_tmp10_ = g_direct_equal;
	_tmp11_ = g_direct_equal;
	_tmp12_ = vala_hash_map_new (BALA_TYPE_UNRESOLVED_TYPE, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, BALA_GIR_PARSER_TYPE_NODE, (GBoxedCopyFunc) vala_gir_parser_node_ref, (GDestroyNotify) vala_gir_parser_node_unref, _tmp9_, _tmp10_, _tmp11_);
	self->priv->unresolved_type_arguments = _tmp12_;
	_tmp13_ = g_direct_equal;
	_tmp14_ = vala_array_list_new (BALA_TYPE_INTERFACE, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, _tmp13_);
...
vala_gir_parser_finalize (ValaCodeVisitor * obj)
{
	...
	BALA_CODE_VISITOR_CLASS (vala_gir_parser_parent_class)->finalize (obj);
}
...
vala_gir_parser_get_type_once (void)
{
	...
	vala_gir_parser_type_id = g_type_register_static (BALA_TYPE_CODE_VISITOR, "ValaGirParser", &g_define_type_info, 0);
