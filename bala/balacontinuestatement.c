/* balacontinuestatement.c generated by balac, the Vala compiler
...
static ValaStatementIface * bala_continue_statement_bala_statement_parent_iface = NULL;

static void bala_continue_statement_real_accept (ValaCodeNode* base,
                                          ValaCodeVisitor* visitor);
static void bala_continue_statement_real_emit (ValaCodeNode* base,
                                   ...
                                   ValaSourceReference* source)
{
	...
	self = (ValaContinueStatement*) bala_code_node_construct (object_type);
	bala_code_node_set_source_reference ((ValaCodeNode*) self, source);
	return self;
}

ValaContinueStatement*
bala_continue_statement_new (ValaSourceReference* source)
{
	return bala_continue_statement_construct (BALA_TYPE_CONTINUE_STATEMENT, source);
}

static void
bala_continue_statement_real_accept (ValaCodeNode* base,
                                     ValaCodeVisitor* visitor)
{
...
static void
bala_continue_statement_real_emit (ValaCodeNode* base,
                                   ValaCodeGenerator* codegen)
{
	ValaContinueStatement * self;
	self = (ValaContinueStatement*) base;
	g_return_if_fail (codegen != NULL);
	bala_code_visitor_visit_continue_statement ((ValaCodeVisitor*) codegen, self);
}

static void
bala_continue_statement_class_init (ValaContinueStatementClass * klass,
                                    gpointer klass_data)
{
	bala_continue_statement_parent_class = g_type_class_peek_parent (klass);
	((ValaCodeNodeClass *) klass)->accept = (void (*) (ValaCodeNode*, ValaCodeVisitor*)) bala_continue_statement_real_accept;
	((ValaCodeNodeClass *) klass)->emit = (void (*) (ValaCodeNode*, ValaCodeGenerator*)) bala_continue_statement_real_emit;
}

static void
bala_continue_statement_bala_statement_interface_init (ValaStatementIface * iface,
                                                       gpointer iface_data)
{
...
static void
bala_continue_statement_instance_init (ValaContinueStatement * self,
                                       gpointer klass)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaContinueStatementClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_continue_statement_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaContinueStatement), 0, (GInstanceInitFunc) bala_continue_statement_instance_init, NULL };
	...
	bala_continue_statement_type_id = g_type_register_static (BALA_TYPE_CODE_NODE, "ValaContinueStatement", &g_define_type_info, 0);
