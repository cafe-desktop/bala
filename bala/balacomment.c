/* balacomment.c generated by balac, the Bala compiler
...
typedef struct _BalaParamSpecComment BalaParamSpecComment;

struct _BalaCommentPrivate {
	gchar* _content;
	BalaSourceReference* _source_reference;
};

struct _BalaParamSpecComment {
	GParamSpec parent_instance;
};

static gint BalaComment_private_offset;
static gpointer bala_comment_parent_class = NULL;

static void bala_comment_finalize (BalaComment * obj);
static GType bala_comment_get_type_once (void);

static inline gpointer
bala_comment_get_instance_private (BalaComment* self)
{
	return G_STRUCT_MEMBER_P (self, BalaComment_private_offset);
}
...
bala_comment_construct (GType object_type,
                        ...
                        BalaSourceReference* _source_reference)
{
	BalaComment* self = NULL;
	g_return_val_if_fail (comment != NULL, NULL);
	g_return_val_if_fail (_source_reference != NULL, NULL);
	self = (BalaComment*) g_type_create_instance (object_type);
...
const gchar*
bala_comment_get_content (BalaComment* self)
{
	const gchar* result;
	const gchar* _tmp0_;
...
void
bala_comment_set_content (BalaComment* self,
                          const gchar* value)
{
	gchar* _tmp0_;
...
BalaSourceReference*
bala_comment_get_source_reference (BalaComment* self)
{
...
void
bala_comment_set_source_reference (BalaComment* self,
...
static void
bala_comment_class_init (BalaCommentClass * klass,
                         gpointer klass_data)
{
	bala_comment_parent_class = g_type_class_peek_parent (klass);
	((BalaCommentClass *) klass)->finalize = bala_comment_finalize;
	g_type_class_adjust_private_offset (klass, &BalaComment_private_offset);
}

static void
bala_comment_instance_init (BalaComment * self,
                            gpointer klass)
{
...
static void
bala_comment_finalize (BalaComment * obj)
{
	BalaComment * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALA_TYPE_COMMENT, BalaComment);
...
bala_comment_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (BalaCommentClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_comment_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (BalaComment), 0, (GInstanceInitFunc) bala_comment_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType bala_comment_type_id;
	bala_comment_type_id = g_type_register_fundamental (g_type_fundamental_next (), "BalaComment", &g_define_type_info, &g_define_type_fundamental_info, 0);
	BalaComment_private_offset = g_type_add_instance_private (bala_comment_type_id, sizeof (BalaCommentPrivate));
