/* balatokentype.c generated by balac, the Bala compiler
 * generated from balatokentype.bala, do not modify */
...
const gchar*
bala_token_type_to_string (BalaTokenType self)
{
...
static GType
bala_token_type_get_type_once (void)
{
	...
	GType bala_token_type_type_id;
	bala_token_type_type_id = g_enum_register_static ("BalaTokenType", values);
	return bala_token_type_type_id;
}

GType
bala_token_type_get_type (void)
{
	static volatile gsize bala_token_type_type_id__volatile = 0;
	if (g_once_init_enter (&bala_token_type_type_id__volatile)) {
		GType bala_token_type_type_id;
		bala_token_type_type_id = bala_token_type_get_type_once ();
		g_once_init_leave (&bala_token_type_type_id__volatile, bala_token_type_type_id);
	}
	return bala_token_type_type_id__volatile;
}
