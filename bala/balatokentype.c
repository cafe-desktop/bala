/* balatokentype.c generated by balac, the Vala compiler
...
const gchar*
bala_token_type_to_string (ValaTokenType self)
{
...
bala_token_type_get_type_once (void)
{
	...
	bala_token_type_type_id = g_enum_register_static ("ValaTokenType", values);
