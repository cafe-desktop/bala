/* baladelegatetype.c generated by balac, the Vala compiler
...
static ValaSymbol* bala_delegate_type_real_get_member (ValaDataType* base,
                                                const gchar* member_name);
static ValaDelegateTargetField* bala_delegate_type_get_target_field (ValaDelegateType* self);
static ValaDelegateDestroyField* bala_delegate_type_get_destroy_field (ValaDelegateType* self);
static ValaDataType* bala_delegate_type_real_copy (ValaDataType* base);
static gboolean bala_delegate_type_real_equals (ValaDataType* base,
                                         ValaDataType* type2);
static gboolean bala_delegate_type_real_is_accessible (ValaDataType* base,
                                                ValaSymbol* sym);
static gboolean bala_delegate_type_real_check (ValaCodeNode* base,
                                        ValaCodeContext* context);
static gboolean bala_delegate_type_real_compatible (ValaDataType* base,
                                             ValaDataType* target_type);
static gboolean bala_delegate_type_real_is_disposable (ValaDataType* base);
static void bala_delegate_type_finalize (ValaCodeNode * obj);
static GType bala_delegate_type_get_type_once (void);

static inline gpointer
bala_delegate_type_get_instance_private (ValaDelegateType* self)
{
	return G_STRUCT_MEMBER_P (self, ValaDelegateType_private_offset);
}

ValaDelegate*
bala_delegate_type_get_delegate_symbol (ValaDelegateType* self)
{
	ValaDelegate* result;
	ValaSymbol* _tmp0_;
	ValaSymbol* _tmp1_;
	...
	_tmp1_ = _tmp0_;
	result = G_TYPE_CHECK_INSTANCE_CAST (_tmp1_, BALA_TYPE_DELEGATE, ValaDelegate);
	return result;
}

gboolean
bala_delegate_type_get_is_called_once (ValaDelegateType* self)
{
	gboolean result;
...
void
bala_delegate_type_set_is_called_once (ValaDelegateType* self,
                                       gboolean value)
{
                              ...
                              ValaDelegate* delegate_symbol)
{
	...
	self = (ValaDelegateType*) bala_callable_type_construct (object_type, (ValaSymbol*) delegate_symbol);
	_tmp0_ = bala_code_node_get_attribute_string ((ValaCodeNode*) delegate_symbol, "CCode", "scope", NULL);
	_tmp1_ = _tmp0_;
...
ValaDelegateType*
bala_delegate_type_new (ValaDelegate* delegate_symbol)
{
...
static ValaSymbol*
bala_delegate_type_real_get_member (ValaDataType* base,
                                    const gchar* member_name)
{
...
bala_delegate_type_get_target_field (ValaDelegateType* self)
{
	ValaDelegateTargetField* _tmp0_;
...
bala_delegate_type_get_destroy_field (ValaDelegateType* self)
{
...
static ValaDataType*
bala_delegate_type_real_copy (ValaDataType* base)
{
	ValaDelegateType * self;
...
static gboolean
bala_delegate_type_real_equals (ValaDataType* base,
                                ValaDataType* type2)
{
	ValaDelegateType * self;
...
static gboolean
bala_delegate_type_real_is_accessible (ValaDataType* base,
                                       ValaSymbol* sym)
{
	ValaDelegateType * self;
	ValaDelegate* _tmp0_;
	...
	_tmp0_ = bala_delegate_type_get_delegate_symbol (self);
	_tmp1_ = _tmp0_;
	result = bala_symbol_is_accessible ((ValaSymbol*) _tmp1_, sym);
	return result;
}

static gboolean
bala_delegate_type_real_check (ValaCodeNode* base,
                               ValaCodeContext* context)
{
	ValaDelegateType * self;
	...
	if (_tmp1_) {
		gboolean _tmp2_;
		gboolean _tmp3_;
		_tmp2_ = bala_data_type_get_value_owned ((ValaDataType*) self);
		_tmp3_ = _tmp2_;
		_tmp0_ = !_tmp3_;
	} else {
		_tmp0_ = FALSE;
	...
	if (!bala_data_type_check_type_arguments ((ValaDataType*) self, context, TRUE)) {
		result = FALSE;
		return result;
	}
	result = TRUE;
...
static gboolean
bala_delegate_type_real_compatible (ValaDataType* base,
                                    ValaDataType* target_type)
{
	ValaDelegateType * self;
	...
	dt_target = BALA_IS_DELEGATE_TYPE (target_type) ? ((ValaDelegateType*) target_type) : NULL;
	_tmp0_ = dt_target;
	if (_tmp0_ == NULL) {
		result = FALSE;
		return result;
	...
	_tmp15_ = bala_data_type_get_return_type ((ValaDataType*) self);
	_tmp16_ = dt_target;
	_tmp17_ = bala_data_type_get_return_type ((ValaDataType*) _tmp16_);
	_tmp18_ = dt_target;
	_tmp19_ = bala_data_type_get_actual_type (_tmp17_, (ValaDataType*) _tmp18_, NULL, (ValaCodeNode*) self);
	_tmp20_ = _tmp19_;
	...
	_tmp22_ = bala_data_type_get_parameters ((ValaDataType*) self);
	_tmp23_ = _bala_iterable_ref0 (_tmp22_);
	parameters = _tmp23_;
	_tmp24_ = parameters;
	_tmp25_ = bala_iterable_iterator ((ValaIterable*) _tmp24_);
	params_it = _tmp25_;
	_tmp28_ = dt_target;
	_tmp29_ = bala_delegate_type_get_delegate_symbol (_tmp28_);
	_tmp30_ = _tmp29_;
	_tmp31_ = bala_symbol_get_parent_symbol ((ValaSymbol*) _tmp30_);
	_tmp32_ = _tmp31_;
	...
	if (_tmp27_) {
		...
		_tmp40_ = _tmp39_;
		_tmp41_ = dt_target;
		_tmp42_ = bala_data_type_get_parameters ((ValaDataType*) _tmp41_);
	...
	}
	{
		...
		gint _param_index = 0;
		_tmp56_ = dt_target;
		_tmp57_ = bala_data_type_get_parameters ((ValaDataType*) _tmp56_);
		...
		while (TRUE) {
			...
			_tmp69_ = param;
			_tmp70_ = bala_variable_get_variable_type ((ValaVariable*) _tmp69_);
			_tmp71_ = _tmp70_;
			_tmp72_ = bala_data_type_get_actual_type (_tmp71_, (ValaDataType*) self, NULL, (ValaCodeNode*) self);
			_tmp73_ = _tmp72_;
			_tmp74_ = p;
			_tmp75_ = bala_variable_get_variable_type ((ValaVariable*) _tmp74_);
			_tmp76_ = _tmp75_;
	...
	error_types = _tmp80_;
	_tmp81_ = error_types;
	bala_code_node_get_error_types ((ValaCodeNode*) self, (ValaCollection*) _tmp81_, NULL);
	{
		...
		while (TRUE) {
			...
			_tmp90_ = bala_list_get ((ValaList*) _tmp89_, _error_type_index);
			...
			bala_code_node_get_error_types ((ValaCodeNode*) _tmp93_, (ValaCollection*) _tmp94_, NULL);
			{
				...
				while (TRUE) {
					...
					_tmp103_ = bala_list_get ((ValaList*) _tmp102_, _delegate_error_type_index);
...
static gboolean
bala_delegate_type_real_is_disposable (ValaDataType* base)
{
	ValaDelegateType * self;
	gboolean _tmp0_ = FALSE;
	...
	if (_tmp5_) {
		gboolean _tmp6_;
		gboolean _tmp7_;
		_tmp6_ = bala_data_type_get_value_owned ((ValaDataType*) self);
		_tmp7_ = _tmp6_;
		_tmp1_ = _tmp7_;
	} else {
		_tmp1_ = FALSE;
...
static void
bala_delegate_type_class_init (ValaDelegateTypeClass * klass,
                               gpointer klass_data)
{
	bala_delegate_type_parent_class = g_type_class_peek_parent (klass);
	((ValaCodeNodeClass *) klass)->finalize = bala_delegate_type_finalize;
	g_type_class_adjust_private_offset (klass, &ValaDelegateType_private_offset);
	((ValaDataTypeClass *) klass)->get_member = (ValaSymbol* (*) (ValaDataType*, const gchar*)) bala_delegate_type_real_get_member;
	((ValaDataTypeClass *) klass)->copy = (ValaDataType* (*) (ValaDataType*)) bala_delegate_type_real_copy;
	((ValaDataTypeClass *) klass)->equals = (gboolean (*) (ValaDataType*, ValaDataType*)) bala_delegate_type_real_equals;
	((ValaDataTypeClass *) klass)->is_accessible = (gboolean (*) (ValaDataType*, ValaSymbol*)) bala_delegate_type_real_is_accessible;
	((ValaCodeNodeClass *) klass)->check = (gboolean (*) (ValaCodeNode*, ValaCodeContext*)) bala_delegate_type_real_check;
	((ValaDataTypeClass *) klass)->compatible = (gboolean (*) (ValaDataType*, ValaDataType*)) bala_delegate_type_real_compatible;
	((ValaDataTypeClass *) klass)->is_disposable = (gboolean (*) (ValaDataType*)) bala_delegate_type_real_is_disposable;
}

static void
bala_delegate_type_instance_init (ValaDelegateType * self,
                                  gpointer klass)
{
...
static void
bala_delegate_type_finalize (ValaCodeNode * obj)
{
	ValaDelegateType * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALA_TYPE_DELEGATE_TYPE, ValaDelegateType);
	_bala_code_node_unref0 (self->priv->target_field);
	_bala_code_node_unref0 (self->priv->destroy_field);
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaDelegateTypeClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_delegate_type_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaDelegateType), 0, (GInstanceInitFunc) bala_delegate_type_instance_init, NULL };
	GType bala_delegate_type_type_id;
	bala_delegate_type_type_id = g_type_register_static (BALA_TYPE_CALLABLE_TYPE, "ValaDelegateType", &g_define_type_info, 0);
	ValaDelegateType_private_offset = g_type_add_instance_private (bala_delegate_type_type_id, sizeof (ValaDelegateTypePrivate));
