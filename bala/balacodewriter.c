...
{
	return vala_code_writer_construct (BALA_TYPE_CODE_WRITER, type);
}
                                             ...
                                             ValaUsingDirective* ns)
{
	...
	if (_tmp0_ == BALA_CODE_WRITER_TYPE_FAST) {
		...
		_tmp2_ = _tmp1_;
		_tmp3_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp2_, BALA_TYPE_UNRESOLVED_SYMBOL, ValaUnresolvedSymbol));
		sym = _tmp3_;
		_tmp4_ = sym;
                               ...
                               ValaList* symbols)
{
	...
	_tmp13_ = vala_array_list_new (BALA_TYPE_SYMBOL, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, _tmp12_);
                                      ...
                                      ValaDelegate* cb)
{
	...
	_tmp17_ = vala_array_list_new (BALA_TYPE_DATA_TYPE, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, _tmp16_);
	error_types = _tmp17_;
	_tmp18_ = error_types;
                                        ...
                                        ValaDestructor* d)
{
	...
	_tmp14_ = _tmp13_;
	_tmp15_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp14_, BALA_TYPE_TYPESYMBOL, ValaTypeSymbol));
	datatype = _tmp15_;
	_tmp16_ = datatype;
                                    ...
                                    ValaMethod* m)
{
	...
	if (BALA_IS_CREATION_METHOD (m)) {
		...
		_tmp23_ = _tmp22_;
		_tmp24_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp23_, BALA_TYPE_TYPESYMBOL, ValaTypeSymbol));
		datatype = _tmp24_;
		_tmp25_ = datatype;
	...
	_tmp53_ = vala_array_list_new (BALA_TYPE_DATA_TYPE, (GBoxedCopyFunc) vala_code_node_ref, (GDestroyNotify) vala_code_node_unref, _tmp52_);
	error_types = _tmp53_;
	_tmp54_ = error_types;
                                   ...
                                   const gchar* s)
{
	...
	_tmp3_ = id;
	if (vala_scanner_get_identifier_or_keyword (_tmp3_, id_length) != BALA_TOKEN_TYPE_IDENTIFIER) {
		_tmp2_ = TRUE;
	} else {
...
vala_code_writer_finalize (ValaCodeVisitor * obj)
{
	...
	_g_free0 (self->priv->override_header);
	_g_free0 (self->priv->header_to_override);
	BALA_CODE_VISITOR_CLASS (vala_code_writer_parent_class)->finalize (obj);
}
...
vala_code_writer_get_type_once (void)
{
	...
	vala_code_writer_type_id = g_type_register_static (BALA_TYPE_CODE_VISITOR, "ValaCodeWriter", &g_define_type_info, 0);
