/* balamarkupreader.c generated by balac, the Vala compiler
...
static void bala_markup_reader_set_filename (ValaMarkupReader* self,
                                      const gchar* value);
static void bala_markup_reader_set_name (ValaMarkupReader* self,
                                  const gchar* value);
static void bala_markup_reader_set_content (ValaMarkupReader* self,
                                     const gchar* value);
static gchar* bala_markup_reader_read_name (ValaMarkupReader* self);
static void bala_markup_reader_space (ValaMarkupReader* self);
static gchar* bala_markup_reader_text (ValaMarkupReader* self,
                                gchar end_char,
                                gboolean rm_trailing_whitespace);
static void bala_markup_reader_finalize (ValaMarkupReader * obj);
static GType bala_markup_reader_get_type_once (void);

static inline gpointer
bala_markup_reader_get_instance_private (ValaMarkupReader* self)
{
	return G_STRUCT_MEMBER_P (self, ValaMarkupReader_private_offset);
}

const gchar*
bala_markup_reader_get_filename (ValaMarkupReader* self)
{
	const gchar* result;
	const gchar* _tmp0_;
...
static void
bala_markup_reader_set_filename (ValaMarkupReader* self,
                                 const gchar* value)
{
	gchar* _tmp0_;
...
const gchar*
bala_markup_reader_get_name (ValaMarkupReader* self)
{
	const gchar* result;
	const gchar* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
static void
bala_markup_reader_set_name (ValaMarkupReader* self,
                             const gchar* value)
{
	gchar* _tmp0_;
	g_return_if_fail (self != NULL);
...
const gchar*
bala_markup_reader_get_content (ValaMarkupReader* self)
{
	const gchar* result;
	const gchar* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
static void
bala_markup_reader_set_content (ValaMarkupReader* self,
                                const gchar* value)
{
	gchar* _tmp0_;
	g_return_if_fail (self != NULL);
...
gchar*
bala_markup_reader_get_attribute (ValaMarkupReader* self,
                                  const gchar* attr)
{
	ValaMap* _tmp0_;
	gpointer _tmp1_;
...
ValaMap*
bala_markup_reader_get_attributes (ValaMarkupReader* self)
{
	...
	_result_ = _tmp3_;
	{
		...
		while (TRUE) {
			...
			bala_map_set ((ValaMap*) _tmp12_, _tmp13_, _tmp17_);
			_g_free0 (_tmp17_);
			_g_free0 (key);
		}
...
static gchar*
bala_markup_reader_read_name (ValaMarkupReader* self)
{
	gchar* begin = NULL;
	gchar* _tmp0_;
	gchar* _tmp24_;
...
ValaMarkupTokenType
bala_markup_reader_read_token (ValaMarkupReader* self,
...
static gchar*
bala_markup_reader_text (ValaMarkupReader* self,
                         gchar end_char,
                         gboolean rm_trailing_whitespace)
{
...
static void
bala_markup_reader_space (ValaMarkupReader* self)
{
	g_return_if_fail (self != NULL);
	while (TRUE) {
		gboolean _tmp0_ = FALSE;
...
static void
bala_markup_reader_class_init (ValaMarkupReaderClass * klass,
                               gpointer klass_data)
{
	bala_markup_reader_parent_class = g_type_class_peek_parent (klass);
	((ValaMarkupReaderClass *) klass)->finalize = bala_markup_reader_finalize;
	g_type_class_adjust_private_offset (klass, &ValaMarkupReader_private_offset);
}

static void
bala_markup_reader_instance_init (ValaMarkupReader * self,
                                  gpointer klass)
{
	GHashFunc _tmp0_;
	GEqualFunc _tmp1_;
...
static void
bala_markup_reader_finalize (ValaMarkupReader * obj)
{
...
bala_markup_reader_get_type_once (void)
{
	...
	static const GTypeInfo g_define_type_info = { sizeof (ValaMarkupReaderClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_markup_reader_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaMarkupReader), 0, (GInstanceInitFunc) bala_markup_reader_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType bala_markup_reader_type_id;
	bala_markup_reader_type_id = g_type_register_fundamental (g_type_fundamental_next (), "ValaMarkupReader", &g_define_type_info, &g_define_type_fundamental_info, 0);
	ValaMarkupReader_private_offset = g_type_add_instance_private (bala_markup_reader_type_id, sizeof (ValaMarkupReaderPrivate));
...
const gchar*
bala_markup_token_type_to_string (ValaMarkupTokenType self)
{
...
bala_markup_token_type_get_type_once (void)
{
	...
	bala_markup_token_type_type_id = g_enum_register_static ("ValaMarkupTokenType", values);
