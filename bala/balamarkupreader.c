/* balamarkupreader.c generated by balac, the Bala compiler
 * generated from balamarkupreader.bala, do not modify */
...
typedef struct _BalaParamSpecMarkupReader BalaParamSpecMarkupReader;

struct _BalaMarkupReaderPrivate {
	gchar* _filename;
	gchar* _name;
	gchar* _content;
...
struct _BalaParamSpecMarkupReader {
	GParamSpec parent_instance;
};

static gint BalaMarkupReader_private_offset;
static gpointer bala_markup_reader_parent_class = NULL;

static void bala_markup_reader_set_filename (BalaMarkupReader* self,
                                      const gchar* value);
static void bala_markup_reader_set_name (BalaMarkupReader* self,
                                  const gchar* value);
static void bala_markup_reader_set_content (BalaMarkupReader* self,
                                     const gchar* value);
static gchar* bala_markup_reader_read_name (BalaMarkupReader* self);
static void bala_markup_reader_space (BalaMarkupReader* self);
static gchar* bala_markup_reader_text (BalaMarkupReader* self,
                                gchar end_char,
                                gboolean rm_trailing_whitespace);
static void bala_markup_reader_finalize (BalaMarkupReader * obj);
static GType bala_markup_reader_get_type_once (void);

static inline gpointer
bala_markup_reader_get_instance_private (BalaMarkupReader* self)
{
	return G_STRUCT_MEMBER_P (self, BalaMarkupReader_private_offset);
}

const gchar*
bala_markup_reader_get_filename (BalaMarkupReader* self)
{
	const gchar* result;
	const gchar* _tmp0_;
...
static void
bala_markup_reader_set_filename (BalaMarkupReader* self,
                                 const gchar* value)
{
	gchar* _tmp0_;
...
const gchar*
bala_markup_reader_get_name (BalaMarkupReader* self)
{
	const gchar* result;
	const gchar* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
static void
bala_markup_reader_set_name (BalaMarkupReader* self,
                             const gchar* value)
{
	gchar* _tmp0_;
	g_return_if_fail (self != NULL);
...
const gchar*
bala_markup_reader_get_content (BalaMarkupReader* self)
{
	const gchar* result;
	const gchar* _tmp0_;
	g_return_val_if_fail (self != NULL, NULL);
...
static void
bala_markup_reader_set_content (BalaMarkupReader* self,
                                const gchar* value)
{
	gchar* _tmp0_;
	g_return_if_fail (self != NULL);
...
BalaMarkupReader*
bala_markup_reader_construct (GType object_type,
                              const gchar* filename)
{
	BalaMarkupReader* self = NULL;
	GError* _inner_error0_ = NULL;
	g_return_val_if_fail (filename != NULL, NULL);
	self = (BalaMarkupReader*) g_type_create_instance (object_type);
	bala_markup_reader_set_filename (self, filename);
	{
	...
	__catch0_g_file_error:
	{
		...
		_tmp11_ = _tmp10_;
		bala_report_error (NULL, _tmp11_);
		_g_free0 (_tmp11_);
		_g_error_free0 (e);
	}
	__finally0:
...
BalaMarkupReader*
bala_markup_reader_new (const gchar* filename)
{
	return bala_markup_reader_construct (BALA_TYPE_MARKUP_READER, filename);
}

BalaMarkupReader*
bala_markup_reader_construct_from_string (GType object_type,
                                          const gchar* filename,
                                          const gchar* content)
{
	BalaMarkupReader* self = NULL;
...
BalaMarkupReader*
bala_markup_reader_new_from_string (const gchar* filename,
                                    const gchar* content)
{
	return bala_markup_reader_construct_from_string (BALA_TYPE_MARKUP_READER, filename, content);
}

gchar*
bala_markup_reader_get_attribute (BalaMarkupReader* self,
                                  const gchar* attr)
{
	BalaMap* _tmp0_;
	gpointer _tmp1_;
	...
	_tmp1_ = bala_map_get (_tmp0_, attr);
	result = (gchar*) _tmp1_;
	return result;
}

BalaMap*
bala_markup_reader_get_attributes (BalaMarkupReader* self)
{
	BalaHashMap* _result_ = NULL;
	GHashFunc _tmp0_;
	GEqualFunc _tmp1_;
	GEqualFunc _tmp2_;
	BalaHashMap* _tmp3_;
	...
	_tmp3_ = bala_hash_map_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, (GDestroyNotify) g_free, G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, (GDestroyNotify) g_free, _tmp0_, _tmp1_, _tmp2_);
	_result_ = _tmp3_;
	{
		...
		_tmp5_ = bala_map_get_keys (_tmp4_);
		_tmp6_ = _tmp5_;
		...
		while (TRUE) {
			...
			_tmp15_ = key;
			_tmp16_ = bala_map_get (_tmp14_, _tmp15_);
			_tmp17_ = (gchar*) _tmp16_;
			bala_map_set ((BalaMap*) _tmp12_, _tmp13_, _tmp17_);
			_g_free0 (_tmp17_);
			_g_free0 (key);
		}
		_bala_iterator_unref0 (_key_it);
	}
	result = (BalaMap*) _result_;
	return result;
}
...
static gchar*
bala_markup_reader_read_name (BalaMarkupReader* self)
{
	gchar* begin = NULL;
	gchar* _tmp0_;
	gchar* _tmp24_;
	...
	while (TRUE) {
		...
		if (u != ((gunichar) -1)) {
			...
			bala_report_error (NULL, "invalid UTF-8 character");
		}
	}
...
BalaMarkupTokenType
bala_markup_reader_read_token (BalaMarkupReader* self,
                               ...
                               BalaSourceLocation* token_end)
{
	...
	gchar* _tmp6_;
	gchar* _tmp109_;
	BalaMarkupTokenType result = 0;
	g_return_val_if_fail (self != NULL, 0);
	_tmp0_ = self->priv->attributes;
	bala_map_clear (_tmp0_);
	...
	bala_markup_reader_set_content (self, NULL);
	bala_markup_reader_set_name (self, NULL);
	bala_markup_reader_space (self);
	...
	if (_tmp5_ >= _tmp6_) {
		...
		if (_tmp8_ == '<') {
				...
				if (_tmp13_ == '?') {
					...
					if (_tmp15_ == '!') {
						...
						if (_tmp17_) {
							...
							BalaSourceLocation _tmp42_ = {0};
							BalaMarkupTokenType _tmp43_;
							...
							_tmp43_ = bala_markup_reader_read_token (self, &_tmp41_, &_tmp42_);
							_bala_token_begin = _tmp41_;
							_bala_token_end = _tmp42_;
							result = _tmp43_;
							if (token_begin) {
								*token_begin = _bala_token_begin;
							}
						...
						if (_tmp45_ == '/') {
							...
							_tmp47_ = bala_markup_reader_read_name (self);
							_tmp48_ = _tmp47_;
							bala_markup_reader_set_name (self, _tmp48_);
							_g_free0 (_tmp48_);
							...
							_tmp55_ = bala_markup_reader_read_name (self);
							_tmp56_ = _tmp55_;
							bala_markup_reader_set_name (self, _tmp56_);
							_g_free0 (_tmp56_);
							bala_markup_reader_space (self);
							while (TRUE) {
								...
								_tmp65_ = bala_markup_reader_read_name (self);
								attr_name = _tmp65_;
								bala_markup_reader_space (self);
								...
								_tmp83_ = bala_markup_reader_text (self, quote, FALSE);
								attr_value = _tmp83_;
								...
								_tmp91_ = attr_name;
								_tmp92_ = attr_value;
								bala_map_set (_tmp90_, _tmp91_, _tmp92_);
								bala_markup_reader_space (self);
								_g_free0 (attr_value);
								_g_free0 (attr_name);
							}
			...
			if (_tmp103_ != '<') {
				gchar* _tmp104_;
				gchar* _tmp105_;
				_tmp104_ = bala_markup_reader_text (self, '<', TRUE);
				_tmp105_ = _tmp104_;
				bala_markup_reader_set_content (self, _tmp105_);
				_g_free0 (_tmp105_);
			} else {
				BalaSourceLocation _tmp106_ = {0};
				BalaSourceLocation _tmp107_ = {0};
				BalaMarkupTokenType _tmp108_;
				_tmp108_ = bala_markup_reader_read_token (self, &_tmp106_, &_tmp107_);
	...
	bala_source_location_init (&_bala_token_end, _tmp109_, self->priv->line, self->priv->column - 1);
	result = type;
	if (token_begin) {
		*token_begin = _bala_token_begin;
	}
...
static gchar*
bala_markup_reader_text (BalaMarkupReader* self,
                         gchar end_char,
                         gboolean rm_trailing_whitespace)
{
...
static void
bala_markup_reader_space (BalaMarkupReader* self)
{
	g_return_if_fail (self != NULL);
	while (TRUE) {
		gboolean _tmp0_ = FALSE;
...
static void
bala_value_markup_reader_init (GValue* value)
{
	value->data[0].v_pointer = NULL;
}

static void
bala_value_markup_reader_free_value (GValue* value)
{
	if (value->data[0].v_pointer) {
		bala_markup_reader_unref (value->data[0].v_pointer);
	}
}

static void
bala_value_markup_reader_copy_value (const GValue* src_value,
                                     GValue* dest_value)
{
	if (src_value->data[0].v_pointer) {
		dest_value->data[0].v_pointer = bala_markup_reader_ref (src_value->data[0].v_pointer);
	} else {
...
static gpointer
bala_value_markup_reader_peek_pointer (const GValue* value)
{
	return value->data[0].v_pointer;
}

static gchar*
bala_value_markup_reader_collect_value (GValue* value,
                                        guint n_collect_values,
                                        GTypeCValue* collect_values,
                                        guint collect_flags)
{
	if (collect_values[0].v_pointer) {
		BalaMarkupReader * object;
		...
		value->data[0].v_pointer = bala_markup_reader_ref (object);
	} else {
		value->data[0].v_pointer = NULL;
	}
	return NULL;
...
static gchar*
bala_value_markup_reader_lcopy_value (const GValue* value,
                                      guint n_collect_values,
                                      GTypeCValue* collect_values,
                                      guint collect_flags)
{
	BalaMarkupReader ** object_p;
	...
	if (!value->data[0].v_pointer) {
		...
		*object_p = bala_markup_reader_ref (value->data[0].v_pointer);
	}
	return NULL;
}

GParamSpec*
bala_param_spec_markup_reader (const gchar* name,
                               const gchar* nick,
                               const gchar* blurb,
                               GType object_type,
                               GParamFlags flags)
{
	BalaParamSpecMarkupReader* spec;
...
gpointer
bala_value_get_markup_reader (const GValue* value)
{
...
void
bala_value_set_markup_reader (GValue* value,
                              gpointer v_object)
{
	BalaMarkupReader * old;
	...
	if (v_object) {
		...
		bala_markup_reader_ref (value->data[0].v_pointer);
	} else {
		value->data[0].v_pointer = NULL;
	}
	if (old) {
		bala_markup_reader_unref (old);
	}
}

void
bala_value_take_markup_reader (GValue* value,
                               gpointer v_object)
{
	BalaMarkupReader * old;
	g_return_if_fail (G_TYPE_CHECK_VALUE_TYPE (value, BALA_TYPE_MARKUP_READER));
...
static void
bala_markup_reader_class_init (BalaMarkupReaderClass * klass,
                               gpointer klass_data)
{
	bala_markup_reader_parent_class = g_type_class_peek_parent (klass);
	((BalaMarkupReaderClass *) klass)->finalize = bala_markup_reader_finalize;
	g_type_class_adjust_private_offset (klass, &BalaMarkupReader_private_offset);
}

static void
bala_markup_reader_instance_init (BalaMarkupReader * self,
                                  gpointer klass)
{
	GHashFunc _tmp0_;
	GEqualFunc _tmp1_;
	GEqualFunc _tmp2_;
	BalaHashMap* _tmp3_;
	self->priv = bala_markup_reader_get_instance_private (self);
	_tmp0_ = g_str_hash;
	_tmp1_ = g_str_equal;
	_tmp2_ = g_direct_equal;
	_tmp3_ = bala_hash_map_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, (GDestroyNotify) g_free, G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, (GDestroyNotify) g_free, _tmp0_, _tmp1_, _tmp2_);
	self->priv->attributes = (BalaMap*) _tmp3_;
	self->ref_count = 1;
}

static void
bala_markup_reader_finalize (BalaMarkupReader * obj)
{
	BalaMarkupReader * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, BALA_TYPE_MARKUP_READER, BalaMarkupReader);
	g_signal_handlers_destroy (self);
	_g_free0 (self->priv->_filename);
	_g_free0 (self->priv->_name);
	_g_free0 (self->priv->_content);
	_g_mapped_file_unref0 (self->priv->mapped_file);
	_bala_map_unref0 (self->priv->attributes);
}
 ...
 */
static GType
bala_markup_reader_get_type_once (void)
{
	static const GTypeValueTable g_define_type_value_table = { bala_value_markup_reader_init, bala_value_markup_reader_free_value, bala_value_markup_reader_copy_value, bala_value_markup_reader_peek_pointer, "p", bala_value_markup_reader_collect_value, "p", bala_value_markup_reader_lcopy_value };
	static const GTypeInfo g_define_type_info = { sizeof (BalaMarkupReaderClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_markup_reader_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (BalaMarkupReader), 0, (GInstanceInitFunc) bala_markup_reader_instance_init, &g_define_type_value_table };
	static const GTypeFundamentalInfo g_define_type_fundamental_info = { (G_TYPE_FLAG_CLASSED | G_TYPE_FLAG_INSTANTIATABLE | G_TYPE_FLAG_DERIVABLE | G_TYPE_FLAG_DEEP_DERIVABLE) };
	GType bala_markup_reader_type_id;
	bala_markup_reader_type_id = g_type_register_fundamental (g_type_fundamental_next (), "BalaMarkupReader", &g_define_type_info, &g_define_type_fundamental_info, 0);
	BalaMarkupReader_private_offset = g_type_add_instance_private (bala_markup_reader_type_id, sizeof (BalaMarkupReaderPrivate));
	return bala_markup_reader_type_id;
}

GType
bala_markup_reader_get_type (void)
{
	static volatile gsize bala_markup_reader_type_id__volatile = 0;
	if (g_once_init_enter (&bala_markup_reader_type_id__volatile)) {
		GType bala_markup_reader_type_id;
		bala_markup_reader_type_id = bala_markup_reader_get_type_once ();
		g_once_init_leave (&bala_markup_reader_type_id__volatile, bala_markup_reader_type_id);
	}
	return bala_markup_reader_type_id__volatile;
}

gpointer
bala_markup_reader_ref (gpointer instance)
{
	BalaMarkupReader * self;
	self = instance;
...
void
bala_markup_reader_unref (gpointer instance)
{
	BalaMarkupReader * self;
	self = instance;
...
const gchar*
bala_markup_token_type_to_string (BalaMarkupTokenType self)
{
...
static GType
bala_markup_token_type_get_type_once (void)
{
	...
	GType bala_markup_token_type_type_id;
	bala_markup_token_type_type_id = g_enum_register_static ("BalaMarkupTokenType", values);
	return bala_markup_token_type_type_id;
}

GType
bala_markup_token_type_get_type (void)
{
	static volatile gsize bala_markup_token_type_type_id__volatile = 0;
	if (g_once_init_enter (&bala_markup_token_type_type_id__volatile)) {
		GType bala_markup_token_type_type_id;
		bala_markup_token_type_type_id = bala_markup_token_type_get_type_once ();
		g_once_init_leave (&bala_markup_token_type_type_id__volatile, bala_markup_token_type_type_id);
	}
	return bala_markup_token_type_type_id__volatile;
}
