/* balacallabletype.c generated by balac, the Vala compiler
...
static gboolean bala_callable_type_real_is_invokable (ValaDataType* base);
static ValaDataType* bala_callable_type_real_get_return_type (ValaDataType* base);
static ValaList* bala_callable_type_real_get_parameters (ValaDataType* base);
static gchar* bala_callable_type_real_to_prototype_string (ValaDataType* base,
                                                    const gchar* override_name);
static GType bala_callable_type_get_type_once (void);

ValaCallable*
bala_callable_type_get_callable_symbol (ValaCallableType* self)
{
	ValaCallable* result;
	ValaSymbol* _tmp0_;
	ValaSymbol* _tmp1_;
                              ...
                              ValaSymbol* symbol)
{
	...
	self = (ValaCallableType*) bala_data_type_construct_with_symbol (object_type, symbol);
	return self;
}

static gboolean
bala_callable_type_real_is_invokable (ValaDataType* base)
{
...
static ValaDataType*
bala_callable_type_real_get_return_type (ValaDataType* base)
{
	ValaCallableType * self;
	ValaCallable* _tmp0_;
	ValaCallable* _tmp1_;
...
static ValaList*
bala_callable_type_real_get_parameters (ValaDataType* base)
{
	ValaCallableType * self;
	ValaCallable* _tmp0_;
	ValaCallable* _tmp1_;
...
static gchar*
bala_callable_type_real_to_prototype_string (ValaDataType* base,
                                             const gchar* override_name)
{
	ValaCallableType * self;
	...
	if (_tmp13_) {
		...
		gchar* _tmp21_;
		_tmp18_ = builder;
		_tmp19_ = bala_data_type_get_return_type ((ValaDataType*) self);
	...
	if (_tmp23_ == NULL) {
		gchar* _tmp25_;
		_tmp25_ = bala_code_node_to_string ((ValaCodeNode*) self);
		_g_free0 (_tmp23_);
		_tmp23_ = _tmp25_;
	}
	_tmp26_ = builder;
	...
	if (_tmp29_ != NULL) {
		...
		_tmp35_ = bala_symbol_get_parent_symbol ((ValaSymbol*) _tmp34_);
		_tmp36_ = _tmp35_;
	...
	}
	{
		...
		gint _tmp51_;
		gint _param_index = 0;
		_tmp47_ = bala_data_type_get_parameters ((ValaDataType*) self);
		...
		while (TRUE) {
			...
			if (_tmp67_ == BALA_PARAMETER_DIRECTION_IN) {
				...
				gboolean _tmp72_;
				_tmp68_ = param;
				_tmp69_ = bala_variable_get_variable_type ((ValaVariable*) _tmp68_);
				_tmp70_ = _tmp69_;
				...
				if (!_tmp87_) {
					...
					_tmp88_ = param;
					_tmp89_ = bala_variable_get_variable_type ((ValaVariable*) _tmp88_);
					_tmp90_ = _tmp89_;
			...
			_tmp92_ = builder;
			_tmp93_ = param;
			_tmp94_ = bala_variable_get_variable_type ((ValaVariable*) _tmp93_);
			_tmp95_ = _tmp94_;
			...
			if (_tmp100_ != NULL) {
				...
				_tmp102_ = builder;
				_tmp103_ = param;
				_tmp104_ = bala_variable_get_initializer ((ValaVariable*) _tmp103_);
				_tmp105_ = _tmp104_;
				_tmp106_ = bala_code_node_to_string ((ValaCodeNode*) _tmp105_);
				_tmp107_ = _tmp106_;
	...
	bala_code_node_get_error_types ((ValaCodeNode*) self, (ValaCollection*) _tmp112_, NULL);
	_tmp113_ = error_types;
	_tmp114_ = bala_collection_get_size ((ValaCollection*) _tmp113_);
	_tmp115_ = _tmp114_;
	if (_tmp115_ > 0) {
		GString* _tmp116_;
		...
		first = TRUE;
		{
			...
			while (TRUE) {
				...
				_tmp124_ = _type_list;
				_tmp125_ = bala_list_get ((ValaList*) _tmp124_, _type_index);
...
static void
bala_callable_type_class_init (ValaCallableTypeClass * klass,
                               gpointer klass_data)
{
	bala_callable_type_parent_class = g_type_class_peek_parent (klass);
	((ValaDataTypeClass *) klass)->is_invokable = (gboolean (*) (ValaDataType*)) bala_callable_type_real_is_invokable;
	((ValaDataTypeClass *) klass)->get_return_type = (ValaDataType* (*) (ValaDataType*)) bala_callable_type_real_get_return_type;
	((ValaDataTypeClass *) klass)->get_parameters = (ValaList* (*) (ValaDataType*)) bala_callable_type_real_get_parameters;
	((ValaDataTypeClass *) klass)->to_prototype_string = (gchar* (*) (ValaDataType*, const gchar*)) bala_callable_type_real_to_prototype_string;
}

static void
bala_callable_type_instance_init (ValaCallableType * self,
                                  gpointer klass)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaCallableTypeClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_callable_type_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaCallableType), 0, (GInstanceInitFunc) bala_callable_type_instance_init, NULL };
	GType bala_callable_type_type_id;
	bala_callable_type_type_id = g_type_register_static (BALA_TYPE_DATA_TYPE, "ValaCallableType", &g_define_type_info, G_TYPE_FLAG_ABSTRACT);
