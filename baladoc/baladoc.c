/* baladoc.c generated by balac, the Vala compiler
...
static gchar** bala_doc_vapi_directories;
...
static gchar** bala_doc_vapi_directories = NULL;
...
static gboolean bala_doc_option_deprecated (const gchar* option_name,
                                     ...
                                     void* data,
                                     GError** error);
static gint bala_doc_quit (ValadocErrorReporter* reporter,
                    gboolean pop_context);
static gboolean bala_doc_check_pkg_name (void);
static gchar* bala_doc_get_pkg_name (ValaDoc* self);
static ValadocModuleLoader* bala_doc_create_module_loader (ValaDoc* self,
                                                    ValadocErrorReporter* reporter,
                                                    ValadocDoclet* * doclet);
static gint bala_doc_run (ValaDoc* self,
                   ValadocErrorReporter* reporter);
...
static gint bala_doc_main (gchar** args,
                    gint args_length1);
ValaDoc* bala_doc_new (void);
ValaDoc* bala_doc_construct (GType object_type);
...
static gint
bala_doc_quit (ValadocErrorReporter* reporter,
               gboolean pop_context)
{
...
static gchar*
bala_doc_get_pkg_name (ValaDoc* self)
{
	const gchar* _tmp0_;
	const gchar* _tmp6_;
	gchar* _tmp7_;
...
bala_doc_create_module_loader (ValaDoc* self,
                               ValadocErrorReporter* reporter,
                               ValadocDoclet* * doclet)
{
	ValadocDoclet* _bala_doclet = NULL;
              ...
              ValadocErrorReporter* reporter)
{
	...
	_tmp48_ = settings;
	_tmp49_ = bala_doc_vapi_directories;
	_tmp49__length1 = _bala_array_length (bala_doc_vapi_directories);
	_tmp50_ = (_tmp49_ != NULL) ? _bala_array_dup2 (_tmp49_, _tmp49__length1) : ((gpointer) _tmp49_);
	_tmp50__length1 = _tmp49__length1;
	_tmp48_->vapi_directories = (_bala_array_free (_tmp48_->vapi_directories, _tmp48_->vapi_directories_length1, (GDestroyNotify) g_free), NULL);
	...
	_tmp92_ = doctree;
	_tmp93_ = resolver;
	baladoc_api_tree_accept (_tmp92_, (ValadocApiVisitor*) _tmp93_);
	_tmp94_ = baladoc_api_child_symbol_registrar_new ();
	registrar = _tmp94_;
	_tmp95_ = doctree;
	_tmp96_ = registrar;
	baladoc_api_tree_accept (_tmp95_, (ValadocApiVisitor*) _tmp96_);
	_tmp97_ = settings;
	_tmp98_ = doctree;
	_tmp99_ = modules;
	...
	if (_tmp127_ != NULL) {
		...
		bala_gir_writer_write_file ((ValaGIRWriter*) _tmp130_, _tmp133_, _tmp135_, _tmp141_, _tmp143_, _tmp145_, _tmp147_, NULL);
		_g_free0 (_tmp141_);
...
static void
bala_doc_class_init (ValaDocClass * klass,
                     gpointer klass_data)
{
...
static void
bala_doc_instance_init (ValaDoc * self,
                        gpointer klass)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaDocClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_doc_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaDoc), 0, (GInstanceInitFunc) bala_doc_instance_init, NULL };
	GType bala_doc_type_id;
	bala_doc_type_id = g_type_register_static (G_TYPE_OBJECT, "ValaDoc", &g_define_type_info, 0);
