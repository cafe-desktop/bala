/* generator.c generated by balac, the Vala compiler
                          ...
                          ValadocErrorReporter* reporter)
{
	...
	baladoc_api_tree_accept (tree, (ValadocApiVisitor*) self);
	...
	}
	{
		...
		_tmp19_ = _tmp18_;
		_tmp20_ = bala_iterable_iterator ((ValaIterable*) _tmp19_);
		_tmp21_ = _tmp20_;
		...
		while (TRUE) {
			...
			}
			{
				...
				_tmp77_ = bala_collection_get_size ((ValaCollection*) _tmp76_);
				_tmp78_ = _tmp77_;
			...
			_tmp104_ = bala_collection_get_size ((ValaCollection*) _tmp103_);
			_tmp105_ = _tmp104_;
			if (_tmp105_ > 0) {
				...
				gtkdoc_text_writer_write_line (_tmp106_, "<SUBSECTION Private>");
				{
					...
					_tmp111_ = bala_collection_get_size ((ValaCollection*) _tmp110_);
					_tmp112_ = _tmp111_;
		...
		while (TRUE) {
			...
			found = FALSE;
			{
				...
				while (TRUE) {
					...
					_tmp64_ = bala_list_get ((ValaList*) _tmp63_, _header_index);
			...
			if (_tmp69_) {
				...
				_tmp72_ = headers;
				_tmp73_ = lang_header;
				bala_collection_add ((ValaCollection*) _tmp72_, _tmp73_);
			}
			_gtkdoc_header_unref0 (lang_header);
		}
		_bala_iterable_unref0 (_lang_header_list);
                                  ...
                                  gboolean is_dbus)
{
	...
	_tmp25_ = _tmp24_;
	bala_collection_add_all ((ValaCollection*) _tmp20_, (ValaCollection*) _tmp25_);
	_bala_iterable_unref0 (_tmp25_);
	_tmp26_ = gcomment->versioning;
	_tmp27_ = converter;
	_tmp28_ = _tmp27_->versioning;
	bala_collection_add_all ((ValaCollection*) _tmp26_, (ValaCollection*) _tmp28_);
	result = gcomment;
                              ...
                              ValadocContentComment* comment)
{
	...
	bala_collection_add ((ValaCollection*) _tmp2_, gcomment);
	result = gcomment;
	_gtkdoc_generator_file_data_unref0 (file_data);
	return result;
}
                             ...
                             gint returns_annotations_length1)
{
	...
	bala_collection_add ((ValaCollection*) _tmp5_, gcomment);
	result = gcomment;
	_gtkdoc_generator_file_data_unref0 (file_data);
	return result;
}
                                  ...
                                  ValadocApiTree* tree)
{
	...
	baladoc_api_tree_accept_children (tree, (ValadocApiVisitor*) self);
}
                                     ...
                                     ValadocApiPackage* package)
{
	...
	baladoc_api_node_accept_all_children ((ValadocApiNode*) package, (ValadocApiVisitor*) self, TRUE);
}
                                       ...
                                       ValadocApiNamespace* ns)
{
	...
	_tmp1_ = baladoc_documentation_get_filename ((ValadocDocumentation*) ns);
	_tmp2_ = _tmp1_;
	_tmp3_ = _tmp2_ != NULL;
	_g_free0 (_tmp2_);
	if (_tmp3_) {
		...
		_tmp4_ = baladoc_api_node_get_documentation ((ValadocApiNode*) ns);
		_tmp5_ = _tmp4_;
		_tmp0_ = _tmp5_ != NULL;
	} else {
		_tmp0_ = FALSE;
	...
	if (_tmp0_) {
		...
		gchar* _tmp14_;
		gchar* _tmp15_;
		_tmp6_ = baladoc_documentation_get_filename ((ValadocDocumentation*) ns);
		_tmp7_ = _tmp6_;
		_tmp8_ = baladoc_documentation_get_filename ((ValadocDocumentation*) ns);
		_tmp9_ = _tmp8_;
		_tmp10_ = gtkdoc_get_section (_tmp9_);
		_tmp11_ = _tmp10_;
		_tmp12_ = baladoc_api_node_get_documentation ((ValadocApiNode*) ns);
		_tmp13_ = _tmp12_;
		_tmp14_ = baladoc_api_node_get_full_name ((ValadocApiNode*) ns);
		_tmp15_ = _tmp14_;
	...
	baladoc_api_node_accept_all_children ((ValadocApiNode*) ns, (ValadocApiVisitor*) self, TRUE);
}
                                       ...
                                       ValadocApiInterface* iface)
{
	...
	baladoc_api_node_accept_all_children ((ValadocApiNode*) iface, (ValadocApiVisitor*) self, TRUE);
	_tmp17_ = baladoc_documentation_get_filename ((ValadocDocumentation*) iface);
	_tmp18_ = _tmp17_;
	_tmp19_ = baladoc_api_interface_get_cname (iface);
	_tmp20_ = _tmp19_;
	_tmp21_ = baladoc_api_node_get_documentation ((ValadocApiNode*) iface);
	_tmp22_ = _tmp21_;
	...
	_g_free0 (_tmp18_);
	gcomment = _tmp24_;
	_tmp25_ = baladoc_documentation_get_filename ((ValadocDocumentation*) iface);
	_tmp26_ = _tmp25_;
	_tmp27_ = baladoc_api_interface_get_cname (iface);
	_tmp28_ = _tmp27_;
	_tmp29_ = baladoc_api_node_get_documentation ((ValadocApiNode*) iface);
	_tmp30_ = _tmp29_;
	_tmp31_ = baladoc_api_node_get_full_name ((ValadocApiNode*) iface);
	_tmp32_ = _tmp31_;
	...
	if (_tmp33_ != NULL) {
		...
		bala_collection_add ((ValaCollection*) _tmp37_, _tmp38_);
	}
	_tmp39_ = gcomment;
	gtkdoc_generator_process_attributes (self, (ValadocApiSymbol*) iface, _tmp39_);
	_tmp40_ = self->priv->current_headers;
	bala_collection_clear ((ValaCollection*) _tmp40_);
	_tmp41_ = g_new0 (ValadocApiNodeType, 1);
	_tmp41_[0] = BALADOC_API_NODE_TYPE_METHOD;
	_tmp42_ = _tmp41_;
	_tmp42__length1 = 1;
	_tmp43_ = baladoc_api_node_get_children_by_types ((ValadocApiNode*) iface, _tmp42_, (gint) 1, FALSE);
	_tmp44_ = _tmp43_;
	...
	abstract_methods = _tmp44_;
	{
		...
		while (TRUE) {
			...
			if (baladoc_api_node_is_browsable (_tmp55_, _tmp56_)) {
				...
				gboolean _tmp59_;
				_tmp57_ = m;
				_tmp58_ = baladoc_api_symbol_get_is_protected (G_TYPE_CHECK_INSTANCE_CAST (_tmp57_, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol));
				_tmp59_ = _tmp58_;
				_tmp54_ = _tmp59_;
			}
			if (_tmp54_) {
				...
				_tmp60_ = m;
				gtkdoc_generator_visit_abstract_method (self, G_TYPE_CHECK_INSTANCE_CAST (_tmp60_, BALADOC_API_TYPE_METHOD, ValadocApiMethod));
			}
			_g_object_unref0 (m);
		}
	...
	_tmp62_ = _tmp61_;
	_tmp62__length1 = 1;
	_tmp63_ = baladoc_api_node_get_children_by_types ((ValadocApiNode*) iface, _tmp62_, (gint) 1, FALSE);
	_tmp64_ = _tmp63_;
	...
	abstract_properties = _tmp64_;
	{
		...
		_prop_list = _tmp66_;
		_tmp67_ = _prop_list;
		_tmp68_ = bala_collection_get_size ((ValaCollection*) _tmp67_);
		_tmp69_ = _tmp68_;
		_prop_size = _tmp69_;
		_prop_index = -1;
		while (TRUE) {
			...
			if (baladoc_api_node_is_browsable (_tmp75_, _tmp76_)) {
				...
				gboolean _tmp79_;
				_tmp77_ = prop;
				_tmp78_ = baladoc_api_symbol_get_is_protected (G_TYPE_CHECK_INSTANCE_CAST (_tmp77_, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol));
				_tmp79_ = _tmp78_;
				_tmp74_ = _tmp79_;
			}
			if (_tmp74_) {
				...
				_tmp80_ = prop;
				gtkdoc_generator_visit_abstract_property (self, G_TYPE_CHECK_INSTANCE_CAST (_tmp80_, BALADOC_API_TYPE_PROPERTY, ValadocApiProperty));
			}
	...
	_tmp83_ = baladoc_api_symbol_get_attribute ((ValadocApiSymbol*) iface, "GenericAccessors");
	_tmp84_ = _tmp83_;
	...
	if (_tmp85_) {
		...
		ValaList* _tmp86_;
		_tmp86_ = baladoc_api_node_get_children_by_type ((ValadocApiNode*) iface, BALADOC_API_NODE_TYPE_TYPE_PARAMETER, FALSE);
		type_parameters = _tmp86_;
		{
			...
			while (TRUE) {
				...
				_tmp96_ = _type;
				_tmp97_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp96_, BALADOC_API_TYPE_TYPEPARAMETER) ? ((ValadocApiTypeParameter*) _tmp96_) : NULL);
				type = _tmp97_;
				_tmp98_ = type;
				_tmp99_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp98_);
				_tmp100_ = _tmp99_;
	...
	_tmp130_ = baladoc_documentation_get_filename ((ValadocDocumentation*) iface);
	_tmp131_ = _tmp130_;
	...
	_g_free0 (_tmp139_);
	_tmp141_ = baladoc_documentation_get_filename ((ValadocDocumentation*) iface);
	_tmp142_ = _tmp141_;
	_tmp143_ = gtkdoc_generator_get_file_data (self, _tmp142_);
	_tmp144_ = _tmp143_;
	_g_free0 (_tmp142_);
	file_data = _tmp144_;
	_tmp145_ = baladoc_api_typesymbol_get_type_cast_macro_name ((ValadocApiTypeSymbol*) iface);
	_tmp146_ = _tmp145_;
	...
	_g_free0 (_tmp148_);
	_tmp149_ = baladoc_api_typesymbol_get_is_type_macro_name ((ValadocApiTypeSymbol*) iface);
	_tmp150_ = _tmp149_;
	gtkdoc_generator_file_data_register_standard_section_line (file_data, _tmp150_);
	_g_free0 (_tmp150_);
	_tmp151_ = baladoc_api_typesymbol_get_type_macro_name ((ValadocApiTypeSymbol*) iface);
	_tmp152_ = _tmp151_;
	gtkdoc_generator_file_data_register_standard_section_line (file_data, _tmp152_);
	_g_free0 (_tmp152_);
	_tmp153_ = baladoc_api_typesymbol_get_type_function_name ((ValadocApiTypeSymbol*) iface);
	_tmp154_ = _tmp153_;
                                   ...
                                   ValadocApiClass* cl)
{
	...
	_tmp20_ = baladoc_documentation_get_filename ((ValadocDocumentation*) cl);
	_tmp21_ = _tmp20_;
	...
	_g_free0 (_tmp28_);
	baladoc_api_node_accept_all_children ((ValadocApiNode*) cl, (ValadocApiVisitor*) self, TRUE);
	_tmp30_ = baladoc_documentation_get_filename ((ValadocDocumentation*) cl);
	_tmp31_ = _tmp30_;
	_tmp32_ = baladoc_api_class_get_cname (cl);
	_tmp33_ = _tmp32_;
	_tmp34_ = baladoc_api_node_get_documentation ((ValadocApiNode*) cl);
	_tmp35_ = _tmp34_;
	...
	_tmp41_ = _tmp40_;
	_tmp42_ = baladoc_api_node_get_documentation ((ValadocApiNode*) cl);
	_tmp43_ = _tmp42_;
	_tmp44_ = baladoc_api_node_get_full_name ((ValadocApiNode*) cl);
	_tmp45_ = _tmp44_;
	...
	if (_tmp46_ != NULL) {
		...
		bala_collection_add ((ValaCollection*) _tmp50_, _tmp51_);
	}
	_tmp52_ = gcomment;
	...
	if (_tmp53_) {
		...
		gchar* _tmp183_;
		gchar* _tmp184_;
		_tmp58_ = baladoc_documentation_get_filename ((ValadocDocumentation*) cl);
		filename = _tmp58_;
		_tmp59_ = self->priv->current_headers;
		bala_collection_clear ((ValaCollection*) _tmp59_);
		...
		bala_collection_clear ((ValaCollection*) _tmp74_);
...
"ps to 0, the object is finalized (i.e. its memory is freed).");
		...
		bala_collection_clear ((ValaCollection*) _tmp87_);
...
"ernal()</function></link> for details on property names.");
		...
		bala_collection_clear ((ValaCollection*) _tmp112_);
...
"nkend=\"GValue\"><type>GValue</type></link> still exists).", _tmp133_, _tmp135_, _tmp139_, _tmp141_);
		...
		bala_collection_clear ((ValaCollection*) _tmp143_);
...
"</type></link>.", _tmp156_);
		...
		bala_collection_clear ((ValaCollection*) _tmp160_);
...
"nk linkend=\"%s\"><function>%s()</function></link> instead.", _tmp181_, _tmp183_);
	...
	bala_collection_clear ((ValaCollection*) _tmp185_);
	_tmp186_ = g_new0 (ValadocApiNodeType, 1);
	_tmp186_[0] = BALADOC_API_NODE_TYPE_METHOD;
	_tmp187_ = _tmp186_;
	_tmp187__length1 = 1;
	_tmp188_ = baladoc_api_node_get_children_by_types ((ValadocApiNode*) cl, _tmp187_, (gint) 1, FALSE);
	_tmp189_ = _tmp188_;
	...
	abstract_methods = _tmp189_;
	{
		...
		_m_list = _tmp191_;
		_tmp192_ = _m_list;
		_tmp193_ = bala_collection_get_size ((ValaCollection*) _tmp192_);
		_tmp194_ = _tmp193_;
		_m_size = _tmp194_;
		_m_index = -1;
		while (TRUE) {
			...
			if (baladoc_api_node_is_browsable (_tmp200_, _tmp201_)) {
				...
				gboolean _tmp204_;
				_tmp202_ = m;
				_tmp203_ = baladoc_api_symbol_get_is_protected (G_TYPE_CHECK_INSTANCE_CAST (_tmp202_, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol));
				_tmp204_ = _tmp203_;
				_tmp199_ = _tmp204_;
			}
			if (_tmp199_) {
				...
				_tmp205_ = m;
				gtkdoc_generator_visit_abstract_method (self, G_TYPE_CHECK_INSTANCE_CAST (_tmp205_, BALADOC_API_TYPE_METHOD, ValadocApiMethod));
			}
			_g_object_unref0 (m);
		}
		_bala_iterable_unref0 (_m_list);
	...
	_tmp207_ = _tmp206_;
	_tmp207__length1 = 1;
	_tmp208_ = baladoc_api_node_get_children_by_types ((ValadocApiNode*) cl, _tmp207_, (gint) 1, FALSE);
	_tmp209_ = _tmp208_;
	...
	abstract_properties = _tmp209_;
	{
		...
		while (TRUE) {
			...
			if (baladoc_api_node_is_browsable (_tmp220_, _tmp221_)) {
				...
				gboolean _tmp224_;
				_tmp222_ = prop;
				_tmp223_ = baladoc_api_symbol_get_is_protected (G_TYPE_CHECK_INSTANCE_CAST (_tmp222_, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol));
				_tmp224_ = _tmp223_;
				_tmp219_ = _tmp224_;
			}
			if (_tmp219_) {
				...
				_tmp225_ = prop;
				gtkdoc_generator_visit_abstract_property (self, G_TYPE_CHECK_INSTANCE_CAST (_tmp225_, BALADOC_API_TYPE_PROPERTY, ValadocApiProperty));
			}
			_g_object_unref0 (prop);
		}
		_bala_iterable_unref0 (_prop_list);
	...
	_tmp228_ = baladoc_documentation_get_filename ((ValadocDocumentation*) cl);
	_tmp229_ = _tmp228_;
...
"te and should never be accessed directly.", _tmp237_);
	...
	_g_free0 (_tmp237_);
	_tmp239_ = baladoc_documentation_get_filename ((ValadocDocumentation*) cl);
	_tmp240_ = _tmp239_;
	...
	file_data = _tmp242_;
	_tmp243_ = file_data;
	_tmp244_ = baladoc_api_typesymbol_get_is_type_macro_name ((ValadocApiTypeSymbol*) cl);
	_tmp245_ = _tmp244_;
	...
	_g_free0 (_tmp248_);
	_tmp249_ = file_data;
	_tmp250_ = baladoc_api_typesymbol_get_type_cast_macro_name ((ValadocApiTypeSymbol*) cl);
	_tmp251_ = _tmp250_;
	...
	_g_free0 (_tmp257_);
	_tmp258_ = file_data;
	_tmp259_ = baladoc_api_typesymbol_get_type_function_name ((ValadocApiTypeSymbol*) cl);
	_tmp260_ = _tmp259_;
	...
	_g_free0 (_tmp263_);
	_tmp265_ = baladoc_api_node_get_nspace ((ValadocApiNode*) cl);
	_tmp266_ = _tmp265_;
	_tmp267_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp266_);
	_tmp268_ = _tmp267_;
	if (_tmp268_ != NULL) {
		...
		gchar* _tmp274_;
		gchar* _tmp275_;
		_tmp269_ = baladoc_api_node_get_nspace ((ValadocApiNode*) cl);
		_tmp270_ = _tmp269_;
		_tmp271_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp270_);
		_tmp272_ = _tmp271_;
	...
	_tmp277_ = file_data;
	_tmp278_ = baladoc_api_node_get_name ((ValadocApiNode*) cl);
	_tmp279_ = _tmp278_;
                                    ...
                                    ValadocApiStruct* st)
{
	...
	baladoc_api_node_accept_all_children ((ValadocApiNode*) st, (ValadocApiVisitor*) self, TRUE);
	_tmp7_ = baladoc_documentation_get_filename ((ValadocDocumentation*) st);
	_tmp8_ = _tmp7_;
	_tmp9_ = baladoc_api_struct_get_cname (st);
	_tmp10_ = _tmp9_;
	_tmp11_ = baladoc_api_node_get_documentation ((ValadocApiNode*) st);
	_tmp12_ = _tmp11_;
	...
	_tmp20_ = baladoc_documentation_get_filename ((ValadocDocumentation*) st);
	_tmp21_ = _tmp20_;
	...
	file_data = _tmp23_;
	_tmp24_ = file_data;
	_tmp25_ = baladoc_api_typesymbol_get_type_macro_name ((ValadocApiTypeSymbol*) st);
	_tmp26_ = _tmp25_;
	gtkdoc_generator_file_data_register_standard_section_line (_tmp24_, _tmp26_);
	_g_free0 (_tmp26_);
	_tmp27_ = file_data;
	_tmp28_ = baladoc_api_typesymbol_get_type_function_name ((ValadocApiTypeSymbol*) st);
	_tmp29_ = _tmp28_;
	...
	if (_tmp34_ != NULL) {
		...
		gint _tmp61_ = 0;
		gchar** _tmp62_;
		_tmp35_ = baladoc_documentation_get_filename ((ValadocDocumentation*) st);
		_tmp36_ = _tmp35_;
		...
		_tmp43_ = _tmp42_;
		bala_collection_add ((ValaCollection*) _tmp41_, _tmp43_);
	...
	if (_tmp63_ != NULL) {
		...
		gint _tmp84_ = 0;
		gchar** _tmp85_;
		_tmp64_ = baladoc_documentation_get_filename ((ValadocDocumentation*) st);
		_tmp65_ = _tmp64_;
		...
		_tmp72_ = _tmp71_;
		bala_collection_add ((ValaCollection*) _tmp70_, _tmp72_);
	...
	if (_tmp86_ != NULL) {
		...
		gint _tmp119_ = 0;
		gchar** _tmp120_;
		_tmp87_ = baladoc_documentation_get_filename ((ValadocDocumentation*) st);
		_tmp88_ = _tmp87_;
		...
		_tmp95_ = _tmp94_;
		bala_collection_add ((ValaCollection*) _tmp93_, _tmp95_);
		...
		if (_tmp96_ != NULL) {
			...
			_tmp103_ = _tmp102_;
			bala_collection_add ((ValaCollection*) _tmp98_, _tmp103_);
			...
			_tmp107_ = _tmp106_;
			bala_collection_add ((ValaCollection*) _tmp105_, _tmp107_);
	...
	if (_tmp121_ != NULL) {
		...
		gint _tmp142_ = 0;
		gchar** _tmp143_;
		_tmp122_ = baladoc_documentation_get_filename ((ValadocDocumentation*) st);
		_tmp123_ = _tmp122_;
		...
		_tmp130_ = _tmp129_;
		bala_collection_add ((ValaCollection*) _tmp128_, _tmp130_);
                                            ...
                                            ValadocApiNode* _error_)
{
	...
	_tmp13_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_error_, BALADOC_API_TYPE_ERROR_DOMAIN) ? ((ValadocApiErrorDomain*) _error_) : NULL);
	edomain = _tmp13_;
	_tmp14_ = edomain;
	if (_tmp14_ != NULL) {
                                          ...
                                          ValadocApiErrorDomain* edomain)
{
	...
	baladoc_api_node_accept_all_children ((ValadocApiNode*) edomain, (ValadocApiVisitor*) self, TRUE);
	_tmp4_ = baladoc_documentation_get_filename ((ValadocDocumentation*) edomain);
	_tmp5_ = _tmp4_;
	_tmp6_ = baladoc_api_error_domain_get_cname (edomain);
	_tmp7_ = _tmp6_;
	_tmp8_ = baladoc_api_node_get_documentation ((ValadocApiNode*) edomain);
	_tmp9_ = _tmp8_;
	...
	_tmp12_ = baladoc_documentation_get_filename ((ValadocDocumentation*) edomain);
	_tmp13_ = _tmp12_;
                                        ...
                                        ValadocApiErrorCode* ecode)
{
	...
	_tmp1_ = _tmp0_;
	_tmp2_ = baladoc_api_node_get_documentation ((ValadocApiNode*) ecode);
	_tmp3_ = _tmp2_;
	_tmp4_ = gtkdoc_generator_add_header (self, _tmp1_, _tmp3_, NULL, (gint) 0, DBL_MAX);
	_tmp5_ = _tmp4_;
	_gtkdoc_header_unref0 (_tmp5_);
	_g_free0 (_tmp1_);
	baladoc_api_node_accept_all_children ((ValadocApiNode*) ecode, (ValadocApiVisitor*) self, TRUE);
}
                                  ...
                                  ValadocApiEnum* en)
{
	...
	_bala_iterable_unref0 (self->priv->current_headers);
	self->priv->current_headers = (ValaList*) _tmp3_;
	baladoc_api_node_accept_all_children ((ValadocApiNode*) en, (ValadocApiVisitor*) self, TRUE);
	_tmp4_ = baladoc_documentation_get_filename ((ValadocDocumentation*) en);
	_tmp5_ = _tmp4_;
	_tmp6_ = baladoc_api_enum_get_cname (en);
	_tmp7_ = _tmp6_;
	_tmp8_ = baladoc_api_node_get_documentation ((ValadocApiNode*) en);
	_tmp9_ = _tmp8_;
	_tmp10_ = gtkdoc_generator_add_symbol (self, _tmp5_, _tmp7_, _tmp9_, NULL, NULL, (gint) 0);
	_tmp11_ = _tmp10_;
	_g_free0 (_tmp7_);
	...
	_tmp12_ = baladoc_documentation_get_filename ((ValadocDocumentation*) en);
	_tmp13_ = _tmp12_;
	_tmp14_ = gtkdoc_generator_get_file_data (self, _tmp13_);
	_tmp15_ = _tmp14_;
	_g_free0 (_tmp13_);
	file_data = _tmp15_;
	_tmp16_ = baladoc_api_typesymbol_get_type_macro_name ((ValadocApiTypeSymbol*) en);
	_tmp17_ = _tmp16_;
	gtkdoc_generator_file_data_register_standard_section_line (file_data, _tmp17_);
	_g_free0 (_tmp17_);
	_tmp18_ = baladoc_api_typesymbol_get_type_function_name ((ValadocApiTypeSymbol*) en);
	_tmp19_ = _tmp18_;
	gtkdoc_generator_file_data_register_standard_section_line (file_data, _tmp19_);
	_g_free0 (_tmp19_);
	_tmp20_ = _bala_iterable_ref0 (old_headers);
                                        ...
                                        ValadocApiEnumValue* eval)
{
	...
	_tmp1_ = _tmp0_;
	_tmp2_ = baladoc_api_node_get_documentation ((ValadocApiNode*) eval);
	_tmp3_ = _tmp2_;
	_tmp4_ = gtkdoc_generator_add_header (self, _tmp1_, _tmp3_, NULL, (gint) 0, DBL_MAX);
	_tmp5_ = _tmp4_;
	_gtkdoc_header_unref0 (_tmp5_);
	_g_free0 (_tmp1_);
	baladoc_api_node_accept_all_children ((ValadocApiNode*) eval, (ValadocApiVisitor*) self, TRUE);
}
                                      ...
                                      ValadocApiProperty* prop)
{
	...
	if (_tmp3_) {
		...
		gboolean _tmp4_;
		gboolean _tmp5_;
		_tmp4_ = baladoc_api_symbol_get_is_private ((ValadocApiSymbol*) prop);
		_tmp5_ = _tmp4_;
		_tmp1_ = _tmp5_;
	}
	if (_tmp1_) {
	...
	_tmp14_ = baladoc_documentation_get_filename ((ValadocDocumentation*) prop);
	_tmp15_ = _tmp14_;
	...
	_tmp20_ = _tmp19_;
	_tmp21_ = baladoc_api_node_get_documentation ((ValadocApiNode*) prop);
	_tmp22_ = _tmp21_;
	...
	_g_free0 (_tmp15_);
	gcomment = _tmp24_;
	baladoc_api_node_accept_all_children ((ValadocApiNode*) prop, (ValadocApiVisitor*) self, TRUE);
	_tmp25_ = baladoc_api_property_get_property_type (prop);
	_tmp26_ = _tmp25_;
	_tmp27_ = baladoc_api_typereference_get_data_type (_tmp26_);
	_tmp28_ = _tmp27_;
	_tmp29_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp28_, BALADOC_API_TYPE_TYPEPARAMETER) ? ((ValadocApiTypeParameter*) _tmp28_) : NULL);
	...
	if (_tmp30_ != NULL) {
		...
		_tmp32_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp31_);
		_tmp33_ = _tmp32_;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp33_, BALADOC_API_TYPE_CLASS)) {
			...
			gchar* _tmp42_;
			gchar* _tmp43_;
			_tmp34_ = baladoc_api_item_get_parent ((ValadocApiItem*) prop);
			_tmp35_ = _tmp34_;
			_tmp36_ = gtkdoc_get_cname (_tmp35_);
			_tmp37_ = _tmp36_;
			_tmp38_ = type_parameter;
			_tmp39_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp38_);
			_tmp40_ = _tmp39_;
			...
			_tmp46_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp45_);
			_tmp47_ = _tmp46_;
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp47_, BALADOC_API_TYPE_INTERFACE)) {
				...
				_tmp49_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp48_);
				_tmp50_ = _tmp49_;
				_tmp51_ = baladoc_api_symbol_get_attribute (G_TYPE_CHECK_INSTANCE_CAST (_tmp50_, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol), "GenericAccessors");
				_tmp52_ = _tmp51_;
			...
			if (_tmp44_) {
				...
				_tmp54_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp53_);
				_tmp55_ = _tmp54_;
				_tmp56_ = gtkdoc_get_cname (_tmp55_);
				_tmp57_ = _tmp56_;
				_tmp58_ = type_parameter;
				_tmp59_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp58_);
				_tmp60_ = _tmp59_;
	...
	if (_tmp68_ != NULL) {
		...
		_tmp70_ = _tmp69_;
		_tmp71_ = baladoc_api_symbol_get_is_private ((ValadocApiSymbol*) _tmp70_);
		_tmp72_ = _tmp71_;
		_tmp66_ = !_tmp72_;
	} else {
		_tmp66_ = FALSE;
	...
	if (_tmp65_) {
		...
		ValaList* _tmp146_;
		ValaList* _tmp147_;
		_tmp77_ = baladoc_documentation_get_filename ((ValadocDocumentation*) prop);
		_tmp78_ = _tmp77_;
		...
		_tmp87_ = baladoc_api_item_get_parent ((ValadocApiItem*) prop);
		_tmp88_ = _tmp87_;
		...
		_tmp94_ = _tmp93_;
		bala_collection_add ((ValaCollection*) _tmp86_, _tmp94_);
				...
				dim = (guint) 1;
				{
					...
					while (TRUE) {
						...
						if (!_tmp129_) {
							...
							dim = _tmp130_ + 1;
							_tmp131_ = array_type;
							_tmp132_ = baladoc_api_array_get_data_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp131_, BALADOC_API_TYPE_ARRAY, ValadocApiArray));
							_tmp133_ = _tmp132_;
						...
						_tmp143_ = _tmp142_;
						bala_collection_add ((ValaCollection*) _tmp139_, _tmp143_);
	...
	if (_tmp151_ != NULL) {
		...
		_tmp153_ = _tmp152_;
		_tmp154_ = baladoc_api_symbol_get_is_private ((ValadocApiSymbol*) _tmp153_);
		_tmp155_ = _tmp154_;
		_tmp149_ = !_tmp155_;
	} else {
		_tmp149_ = FALSE;
	...
	if (_tmp148_) {
		...
		ValaList* _tmp232_;
		ValaList* _tmp233_;
		_tmp160_ = baladoc_documentation_get_filename ((ValadocDocumentation*) prop);
		_tmp161_ = _tmp160_;
		...
		_tmp170_ = baladoc_api_item_get_parent ((ValadocApiItem*) prop);
		_tmp171_ = _tmp170_;
		...
		_tmp177_ = _tmp176_;
		bala_collection_add ((ValaCollection*) _tmp169_, _tmp177_);
		...
		_tmp192_ = _tmp191_;
		bala_collection_add ((ValaCollection*) _tmp185_, _tmp192_);
				...
				dim = (guint) 1;
				{
					...
					while (TRUE) {
						...
						if (!_tmp215_) {
							...
							dim = _tmp216_ + 1;
							_tmp217_ = array_type;
							_tmp218_ = baladoc_api_array_get_data_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp217_, BALADOC_API_TYPE_ARRAY, ValadocApiArray));
							_tmp219_ = _tmp218_;
						...
						_tmp229_ = _tmp228_;
						bala_collection_add ((ValaCollection*) _tmp225_, _tmp229_);
	...
	if (_tmp234_ != NULL) {
		...
		gchar* _tmp250_;
		_tmp235_ = baladoc_api_item_get_parent ((ValadocApiItem*) prop);
		_tmp236_ = _tmp235_;
		_tmp237_ = gtkdoc_get_cname (_tmp236_);
		_tmp238_ = _tmp237_;
		_tmp239_ = type_parameter;
		_tmp240_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp239_);
		_tmp241_ = _tmp240_;
                                   ...
                                   ValadocApiField* f)
{
	...
	_tmp0_ = baladoc_api_symbol_get_is_private ((ValadocApiSymbol*) f);
	_tmp1_ = _tmp0_;
	if (_tmp1_) {
		return;
	}
	...
	if (_tmp2_ == NULL) {
		...
		GtkdocGComment* _tmp10_;
		GtkdocGComment* _tmp11_;
		_tmp3_ = baladoc_documentation_get_filename ((ValadocDocumentation*) f);
		_tmp4_ = _tmp3_;
		_tmp5_ = baladoc_api_field_get_cname (f);
		_tmp6_ = _tmp5_;
		_tmp7_ = baladoc_api_node_get_documentation ((ValadocApiNode*) f);
		_tmp8_ = _tmp7_;
		...
		_g_free0 (_tmp4_);
		gcomment = _tmp10_;
		baladoc_api_node_accept_all_children ((ValadocApiNode*) f, (ValadocApiVisitor*) self, TRUE);
		_tmp11_ = gcomment;
		...
		_tmp13_ = _tmp12_;
		_tmp14_ = baladoc_api_node_get_documentation ((ValadocApiNode*) f);
		_tmp15_ = _tmp14_;
                                      ...
                                      ValadocApiConstant* c)
{
	...
	_tmp0_ = baladoc_documentation_get_filename ((ValadocDocumentation*) c);
	_tmp1_ = _tmp0_;
	_tmp2_ = baladoc_api_constant_get_cname (c);
	_tmp3_ = _tmp2_;
	_tmp4_ = baladoc_api_node_get_documentation ((ValadocApiNode*) c);
	_tmp5_ = _tmp4_;
	...
	_g_free0 (_tmp1_);
	gcomment = _tmp7_;
	baladoc_api_node_accept_all_children ((ValadocApiNode*) c, (ValadocApiVisitor*) self, TRUE);
                                      ...
                                      ValadocApiDelegate* d)
{
	...
	_tmp8_ = _tmp7_;
	_tmp8__length1 = 2;
	baladoc_api_node_accept_children ((ValadocApiNode*) d, _tmp8_, (gint) 2, (ValadocApiVisitor*) self, TRUE);
	...
	_tmp10_ = _tmp9_;
	_tmp10__length1 = 2;
	_tmp11_ = baladoc_api_node_get_children_by_types ((ValadocApiNode*) d, _tmp10_, (gint) 2, TRUE);
	_tmp12_ = _tmp11_;
	...
	_tmp30_ = baladoc_documentation_get_filename ((ValadocDocumentation*) d);
	_tmp31_ = _tmp30_;
	_tmp32_ = baladoc_api_delegate_get_cname (d);
	_tmp33_ = _tmp32_;
	_tmp34_ = baladoc_api_node_get_documentation ((ValadocApiNode*) d);
	_tmp35_ = _tmp34_;
	_tmp36_ = gtkdoc_generator_add_symbol (self, _tmp31_, _tmp33_, _tmp35_, NULL, NULL, (gint) 0);
	_tmp37_ = _tmp36_;
	_g_free0 (_tmp33_);
	_g_free0 (_tmp31_);
	gcomment = _tmp37_;
	_tmp38_ = baladoc_api_callable_get_return_type ((ValadocApiCallable*) d);
	_tmp39_ = _tmp38_;
	_tmp40_ = baladoc_api_typereference_get_data_type (_tmp39_);
	_tmp41_ = _tmp40_;
	_tmp42_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp41_, BALADOC_API_TYPE_TYPEPARAMETER) ? ((ValadocApiTypeParameter*) _tmp41_) : NULL);
	...
	if (_tmp43_ != NULL) {
		...
		_tmp45_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp44_);
		_tmp46_ = _tmp45_;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp46_, BALADOC_API_TYPE_CLASS)) {
			...
			const gchar* _tmp61_;
			gchar* _tmp62_;
			_tmp47_ = baladoc_api_item_get_parent ((ValadocApiItem*) d);
			_tmp48_ = _tmp47_;
			...
			_tmp65_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp64_);
			_tmp66_ = _tmp65_;
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp66_, BALADOC_API_TYPE_INTERFACE)) {
				...
				_tmp68_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp67_);
				_tmp69_ = _tmp68_;
				_tmp70_ = baladoc_api_symbol_get_attribute (G_TYPE_CHECK_INSTANCE_CAST (_tmp69_, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol), "GenericAccessors");
				_tmp71_ = _tmp70_;
			...
			if (_tmp63_) {
				...
				const gchar* _tmp86_;
				gchar* _tmp87_;
				_tmp72_ = baladoc_api_item_get_parent ((ValadocApiItem*) d);
				_tmp73_ = _tmp72_;
                                    ...
                                    ValadocApiSignal* sig)
{
	...
	baladoc_api_node_accept_all_children ((ValadocApiNode*) sig, (ValadocApiVisitor*) self, TRUE);
	...
	_g_free0 (_tmp17_);
	name = _tmp19_;
	_tmp20_ = baladoc_documentation_get_filename ((ValadocDocumentation*) sig);
	_tmp21_ = _tmp20_;
	_tmp22_ = self->priv->current_cname;
	_tmp23_ = name;
	_tmp24_ = g_strdup_printf ("%s::%s", _tmp22_, _tmp23_);
	_tmp25_ = _tmp24_;
	_tmp26_ = baladoc_api_node_get_documentation ((ValadocApiNode*) sig);
	_tmp27_ = _tmp26_;
	...
	_tmp32_ = baladoc_api_item_get_parent ((ValadocApiItem*) sig);
	_tmp33_ = _tmp32_;
	_tmp34_ = baladoc_api_node_get_name (G_TYPE_CHECK_INSTANCE_CAST (_tmp33_, BALADOC_API_TYPE_NODE, ValadocApiNode));
	_tmp35_ = _tmp34_;
	_tmp36_ = gtkdoc_to_lower_case (_tmp35_);
	_tmp37_ = _tmp36_;
	_tmp38_ = baladoc_api_item_get_parent ((ValadocApiItem*) sig);
	_tmp39_ = _tmp38_;
	...
	if (_tmp46_) {
		...
		_tmp51_ = _tmp50_;
		_tmp52_ = baladoc_api_node_get_documentation ((ValadocApiNode*) sig);
		_tmp53_ = _tmp52_;
	...
	_tmp61_ = baladoc_api_callable_get_return_type ((ValadocApiCallable*) sig);
	_tmp62_ = _tmp61_;
	_tmp63_ = baladoc_api_typereference_get_data_type (_tmp62_);
	_tmp64_ = _tmp63_;
	_tmp65_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp64_, BALADOC_API_TYPE_TYPEPARAMETER) ? ((ValadocApiTypeParameter*) _tmp64_) : NULL);
	...
	if (_tmp66_ != NULL) {
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp69_, BALADOC_API_TYPE_CLASS)) {
			...
			_tmp71_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp70_);
			_tmp72_ = _tmp71_;
			...
			_tmp89_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp88_);
			_tmp90_ = _tmp89_;
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp90_, BALADOC_API_TYPE_INTERFACE)) {
				...
				_tmp92_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp91_);
				_tmp93_ = _tmp92_;
				_tmp94_ = baladoc_api_symbol_get_attribute (G_TYPE_CHECK_INSTANCE_CAST (_tmp93_, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol), "GenericAccessors");
				_tmp95_ = _tmp94_;
			...
			if (_tmp87_) {
				...
				_tmp97_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp96_);
				_tmp98_ = _tmp97_;
				_tmp99_ = gtkdoc_get_cname (_tmp98_);
				_tmp100_ = _tmp99_;
				_tmp101_ = type_parameter;
				_tmp102_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp101_);
				_tmp103_ = _tmp102_;
                                    ...
                                    ValadocApiMethod* m)
{
	...
	if (_tmp2_) {
		...
		gboolean _tmp13_;
		gboolean _tmp14_;
		_tmp13_ = baladoc_api_symbol_get_is_private ((ValadocApiSymbol*) m);
		_tmp14_ = _tmp13_;
		_tmp1_ = _tmp14_;
	}
	if (_tmp1_) {
	...
	_tmp24_ = baladoc_api_callable_get_return_type ((ValadocApiCallable*) m);
	_tmp25_ = _tmp24_;
	if (_tmp25_ != NULL) {
		ValadocApiTypeReference* _tmp26_;
		...
		gboolean _tmp33_;
		gboolean _tmp34_;
		_tmp26_ = baladoc_api_callable_get_return_type ((ValadocApiCallable*) m);
		_tmp27_ = _tmp26_;
		...
		_tmp31_ = baladoc_api_callable_get_return_type ((ValadocApiCallable*) m);
		_tmp32_ = _tmp31_;
	...
	if (_tmp55_) {
		...
		GtkdocHeader* _tmp67_;
		_tmp60_ = baladoc_api_item_get_parent ((ValadocApiItem*) m);
		_tmp61_ = _tmp60_;
	...
	if (_tmp69_) {
		...
		ValadocApiItem* _tmp71_;
		ValaList* _tmp72_;
		_tmp70_ = baladoc_api_item_get_parent ((ValadocApiItem*) m);
		_tmp71_ = _tmp70_;
		_tmp72_ = baladoc_api_node_get_children_by_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp71_, BALADOC_API_TYPE_NODE, ValadocApiNode), BALADOC_API_NODE_TYPE_TYPE_PARAMETER, FALSE);
		type_parameters = _tmp72_;
		{
			...
			__type_list = _tmp74_;
			_tmp75_ = __type_list;
			_tmp76_ = bala_collection_get_size ((ValaCollection*) _tmp75_);
			_tmp77_ = _tmp76_;
			__type_size = _tmp77_;
			__type_index = -1;
			while (TRUE) {
				...
				_tmp82_ = _type;
				_tmp83_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp82_, BALADOC_API_TYPE_TYPEPARAMETER) ? ((ValadocApiTypeParameter*) _tmp82_) : NULL);
				type = _tmp83_;
				_tmp84_ = type;
				_tmp85_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp84_);
				_tmp86_ = _tmp85_;
	...
	_tmp109_ = baladoc_api_node_get_children_by_type ((ValadocApiNode*) m, BALADOC_API_NODE_TYPE_TYPE_PARAMETER, FALSE);
	type_parameters = _tmp109_;
	{
		...
		_tmp113_ = bala_collection_get_size ((ValaCollection*) _tmp112_);
		_tmp114_ = _tmp113_;
		...
		while (TRUE) {
			...
			_tmp119_ = _type;
			_tmp120_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp119_, BALADOC_API_TYPE_TYPEPARAMETER) ? ((ValadocApiTypeParameter*) _tmp119_) : NULL);
			type = _tmp120_;
			_tmp121_ = type;
			_tmp122_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp121_);
			_tmp123_ = _tmp122_;
	...
	_tmp150_ = _tmp149_;
	_tmp150__length1 = 2;
	baladoc_api_node_accept_children ((ValadocApiNode*) m, _tmp150_, (gint) 2, (ValadocApiVisitor*) self, TRUE);
	...
	_tmp152_ = _tmp151_;
	_tmp152__length1 = 2;
	_tmp153_ = baladoc_api_node_get_children_by_types ((ValadocApiNode*) m, _tmp152_, (gint) 2, TRUE);
	_tmp154_ = _tmp153_;
	...
	if (_tmp166_) {
		...
		_tmp178_ = baladoc_documentation_get_filename ((ValadocDocumentation*) m);
		_tmp179_ = _tmp178_;
		_tmp180_ = baladoc_api_method_get_cname (m);
		_tmp181_ = _tmp180_;
		_tmp182_ = baladoc_api_node_get_documentation ((ValadocApiNode*) m);
		_tmp183_ = _tmp182_;
		...
		GtkdocGComment* _tmp200_;
		_tmp193_ = baladoc_documentation_get_filename ((ValadocDocumentation*) m);
		_tmp194_ = _tmp193_;
		_tmp195_ = baladoc_api_method_get_cname (m);
		_tmp196_ = _tmp195_;
		_tmp197_ = baladoc_api_node_get_documentation ((ValadocApiNode*) m);
		_tmp198_ = _tmp197_;
	...
	if (_tmp204_) {
		...
		_tmp212_ = baladoc_api_callable_get_return_type ((ValadocApiCallable*) m);
		_tmp213_ = _tmp212_;
		if (_tmp213_ != NULL) {
			...
			ValadocApiItem* _tmp217_;
			_tmp214_ = baladoc_api_callable_get_return_type ((ValadocApiCallable*) m);
			_tmp215_ = _tmp214_;
		...
		if (_tmp211_) {
			...
			_tmp219_ = _tmp218_;
			_tmp220_ = baladoc_api_callable_get_return_type ((ValadocApiCallable*) m);
			_tmp221_ = _tmp220_;
		...
		_tmp229_ = _tmp228_;
		_tmp230_ = baladoc_api_node_get_documentation ((ValadocApiNode*) m);
		_tmp231_ = _tmp230_;
	...
	_tmp245_ = baladoc_api_callable_get_return_type ((ValadocApiCallable*) m);
	_tmp246_ = _tmp245_;
	_tmp247_ = baladoc_api_typereference_get_data_type (_tmp246_);
	_tmp248_ = _tmp247_;
	_tmp249_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp248_, BALADOC_API_TYPE_TYPEPARAMETER) ? ((ValadocApiTypeParameter*) _tmp248_) : NULL);
	...
	if (_tmp250_ != NULL) {
		...
		_tmp252_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp251_);
		_tmp253_ = _tmp252_;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp253_, BALADOC_API_TYPE_CLASS)) {
			...
			gchar* _tmp262_;
			gchar* _tmp263_;
			_tmp254_ = baladoc_api_item_get_parent ((ValadocApiItem*) m);
			_tmp255_ = _tmp254_;
			_tmp256_ = gtkdoc_get_cname (_tmp255_);
			_tmp257_ = _tmp256_;
			_tmp258_ = type_parameter;
			_tmp259_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp258_);
			_tmp260_ = _tmp259_;
			...
			_tmp266_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp265_);
			_tmp267_ = _tmp266_;
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp267_, BALADOC_API_TYPE_INTERFACE)) {
				...
				_tmp269_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp268_);
				_tmp270_ = _tmp269_;
				_tmp271_ = baladoc_api_symbol_get_attribute (G_TYPE_CHECK_INSTANCE_CAST (_tmp270_, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol), "GenericAccessors");
				_tmp272_ = _tmp271_;
			...
			if (_tmp264_) {
				...
				gchar* _tmp281_;
				gchar* _tmp282_;
				_tmp273_ = baladoc_api_item_get_parent ((ValadocApiItem*) m);
				_tmp274_ = _tmp273_;
				_tmp275_ = gtkdoc_get_cname (_tmp274_);
				_tmp276_ = _tmp275_;
				_tmp277_ = type_parameter;
				_tmp278_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp277_);
				_tmp279_ = _tmp278_;
				...
				_tmp284_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp283_);
				_tmp285_ = _tmp284_;
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp285_, BALADOC_API_TYPE_STRUCT)) {
					...
					_tmp287_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp286_);
					_tmp288_ = _tmp287_;
					if (_tmp288_ == G_TYPE_CHECK_INSTANCE_CAST (m, BALADOC_API_TYPE_ITEM, ValadocApiItem)) {
						...
						_tmp290_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp289_);
						_tmp291_ = _tmp290_;
	...
	if (_tmp296_) {
		...
		_tmp297_ = baladoc_documentation_get_filename ((ValadocDocumentation*) m);
		_tmp298_ = _tmp297_;
		_tmp299_ = baladoc_api_method_get_finish_function_cname (m);
		_tmp300_ = _tmp299_;
		_tmp301_ = baladoc_api_node_get_documentation ((ValadocApiNode*) m);
		_tmp302_ = _tmp301_;
		...
		bala_collection_clear ((ValaCollection*) _tmp306_);
		...
		if (!_tmp308_) {
			...
			_tmp311_ = baladoc_api_item_get_parent ((ValadocApiItem*) m);
			_tmp312_ = _tmp311_;
			...
			_tmp318_ = _tmp317_;
			bala_collection_add ((ValaCollection*) _tmp310_, _tmp318_);
		...
		_tmp322_ = _tmp321_;
		bala_collection_add ((ValaCollection*) _tmp320_, _tmp322_);
		...
		if (_tmp323_ != NULL) {
			...
			bala_collection_add ((ValaCollection*) _tmp325_, _tmp326_);
		}
	...
	if (_tmp346_) {
		...
		gchar* _tmp359_;
		gchar* _tmp360_;
		_tmp351_ = baladoc_documentation_get_filename ((ValadocDocumentation*) m);
		_tmp352_ = _tmp351_;
		...
		_tmp360_ = _tmp359_;
		bala_collection_add ((ValaCollection*) _tmp356_, _tmp360_);
		_g_free0 (_tmp360_);
		_g_free0 (_tmp358_);
		_gtkdoc_generator_file_data_unref0 (file_data);
	}
                                        ...
                                        ValadocApiMethod* m)
{
	...
	_tmp7_ = baladoc_api_symbol_get_is_private ((ValadocApiSymbol*) m);
	_tmp8_ = _tmp7_;
	if (!_tmp8_) {
		gboolean _tmp9_;
		gboolean _tmp10_;
		_tmp9_ = baladoc_api_symbol_get_is_protected ((ValadocApiSymbol*) m);
		_tmp10_ = _tmp9_;
		_tmp6_ = !_tmp10_;
	} else {
		_tmp6_ = FALSE;
	...
	if (_tmp6_) {
		gboolean _tmp11_;
		gboolean _tmp12_;
		_tmp11_ = baladoc_api_symbol_get_is_internal ((ValadocApiSymbol*) m);
		_tmp12_ = _tmp11_;
		_tmp5_ = !_tmp12_;
	} else {
		_tmp5_ = FALSE;
	...
	if (_tmp5_) {
		...
		gboolean _tmp21_;
		gboolean _tmp22_;
		_tmp13_ = baladoc_api_node_get_name ((ValadocApiNode*) m);
		_tmp14_ = _tmp13_;
		...
		if (_tmp22_) {
			...
			_tmp23_ = baladoc_api_node_get_name ((ValadocApiNode*) m);
			_tmp24_ = _tmp23_;
			_tmp25_ = g_strconcat (_tmp24_, "_finish", NULL);
			_tmp26_ = _tmp25_;
			_tmp27_ = baladoc_api_node_get_name ((ValadocApiNode*) m);
			_tmp28_ = _tmp27_;
...
" by %s", _tmp28_, _tmp30_);
		...
		gboolean _tmp39_;
		gboolean _tmp40_;
		_tmp35_ = baladoc_api_node_get_name ((ValadocApiNode*) m);
		_tmp36_ = _tmp35_;
		...
		if (_tmp40_) {
			...
			_tmp41_ = baladoc_api_node_get_name ((ValadocApiNode*) m);
			_tmp42_ = _tmp41_;
                                          ...
                                          ValadocApiProperty* prop)
{
	...
	if (_tmp9_ != NULL) {
		...
		_tmp11_ = _tmp10_;
		_tmp12_ = baladoc_api_symbol_get_is_private ((ValadocApiSymbol*) _tmp11_);
		_tmp13_ = _tmp12_;
		_tmp7_ = !_tmp13_;
	} else {
		_tmp7_ = FALSE;
	...
	if (_tmp7_) {
		...
		_tmp15_ = _tmp14_;
		_tmp16_ = baladoc_api_symbol_get_is_internal ((ValadocApiSymbol*) _tmp15_);
		_tmp17_ = _tmp16_;
		_tmp6_ = !_tmp17_;
	} else {
		_tmp6_ = FALSE;
	...
	if (_tmp5_) {
		...
		GtkdocHeader* _tmp31_;
		_tmp22_ = baladoc_api_node_get_name ((ValadocApiNode*) prop);
		_tmp23_ = _tmp22_;
	...
	if (_tmp37_ != NULL) {
		...
		_tmp39_ = _tmp38_;
		_tmp40_ = baladoc_api_symbol_get_is_private ((ValadocApiSymbol*) _tmp39_);
		_tmp41_ = _tmp40_;
		_tmp35_ = !_tmp41_;
	} else {
		_tmp35_ = FALSE;
	...
	if (_tmp35_) {
		...
		_tmp43_ = _tmp42_;
		_tmp44_ = baladoc_api_symbol_get_is_internal ((ValadocApiSymbol*) _tmp43_);
		_tmp45_ = _tmp44_;
		_tmp34_ = !_tmp45_;
	} else {
		_tmp34_ = FALSE;
	...
	if (_tmp32_) {
		...
		_tmp54_ = baladoc_api_node_get_name ((ValadocApiNode*) prop);
		_tmp55_ = _tmp54_;
                                              ...
                                              ValadocApiParameter* param)
{
	...
	_tmp1_ = baladoc_api_node_get_name ((ValadocApiNode*) param);
	_tmp2_ = _tmp1_;
	_tmp0_ = _tmp2_;
	if (_tmp0_ == NULL) {
		_tmp0_ = "...";
	...
	_tmp20_ = _tmp19_;
	_tmp21_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp20_, BALADOC_API_TYPE_TYPEPARAMETER) ? ((ValadocApiTypeParameter*) _tmp20_) : NULL);
	...
	if (_tmp22_ != NULL) {
		...
		_tmp24_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp23_);
		_tmp25_ = _tmp24_;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp25_, BALADOC_API_TYPE_CLASS)) {
			...
			_tmp28_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp27_);
			_tmp29_ = _tmp28_;
			_tmp30_ = gtkdoc_get_cname (_tmp29_);
			_tmp31_ = _tmp30_;
			_tmp32_ = type_parameter;
			_tmp33_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp32_);
			_tmp34_ = _tmp33_;
			...
			_tmp43_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp42_);
			_tmp44_ = _tmp43_;
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp44_, BALADOC_API_TYPE_INTERFACE)) {
				...
				_tmp46_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp45_);
				_tmp47_ = _tmp46_;
				_tmp48_ = baladoc_api_symbol_get_attribute (G_TYPE_CHECK_INSTANCE_CAST (_tmp47_, BALADOC_API_TYPE_SYMBOL, ValadocApiSymbol), "GenericAccessors");
				_tmp49_ = _tmp48_;
			...
			if (_tmp41_) {
				...
				_tmp50_ = param_name;
				_tmp51_ = type_parameter;
				_tmp52_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp51_);
				_tmp53_ = _tmp52_;
				_tmp54_ = gtkdoc_get_cname (_tmp53_);
				_tmp55_ = _tmp54_;
				_tmp56_ = type_parameter;
				_tmp57_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp56_);
				_tmp58_ = _tmp57_;
				...
				_tmp66_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp65_);
				_tmp67_ = _tmp66_;
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp67_, BALADOC_API_TYPE_STRUCT)) {
					...
					_tmp69_ = baladoc_api_item_get_parent ((ValadocApiItem*) _tmp68_);
					_tmp70_ = _tmp69_;
	...
	if (_tmp129_ != NULL) {
		...
		_tmp130_ = baladoc_api_node_get_documentation ((ValadocApiNode*) param);
		_tmp131_ = _tmp130_;
	...
	if (_tmp128_) {
		...
		GtkdocHeader* _tmp143_;
		_tmp135_ = param_name;
		_tmp136_ = baladoc_api_node_get_documentation ((ValadocApiNode*) param);
		_tmp137_ = _tmp136_;
	...
	baladoc_api_node_accept_all_children ((ValadocApiNode*) param, (ValadocApiVisitor*) self, TRUE);
	_g_object_unref0 (type_parameter);
	_g_free0 (direction);
	annotations = (_bala_array_free (annotations, annotations_length1, (GDestroyNotify) g_free), NULL);
	_g_free0 (param_name);
                                     ...
                                     GtkdocGComment* gcomment)
{
	...
	if (_tmp1_) {
		...
		if (_tmp3_ != NULL) {
			...
			gchar* _tmp11_;
			_tmp4_ = version;
			_tmp5_ = baladoc_api_item_get_data ((ValadocApiItem*) _tmp4_);
			_tmp6_ = _tmp5_;
			_tmp7_ = bala_attribute_get_string (G_TYPE_CHECK_INSTANCE_CAST (_tmp6_, BALA_TYPE_ATTRIBUTE, ValaAttribute), "deprecated_since", NULL);
			_g_free0 (deprecated_since);
			deprecated_since = _tmp7_;
			_tmp8_ = version;
			_tmp9_ = baladoc_api_item_get_data ((ValadocApiItem*) _tmp8_);
			_tmp10_ = _tmp9_;
			_tmp11_ = bala_attribute_get_string (G_TYPE_CHECK_INSTANCE_CAST (_tmp10_, BALA_TYPE_ATTRIBUTE, ValaAttribute), "replacement", NULL);
			...
			if (_tmp13_ != NULL) {
				...
				gchar* _tmp21_;
				_tmp14_ = deprecated;
				_tmp15_ = baladoc_api_item_get_data ((ValadocApiItem*) _tmp14_);
				_tmp16_ = _tmp15_;
				_tmp17_ = bala_attribute_get_string (G_TYPE_CHECK_INSTANCE_CAST (_tmp16_, BALA_TYPE_ATTRIBUTE, ValaAttribute), "since", NULL);
				_g_free0 (deprecated_since);
		...
		if (_tmp34_ != NULL) {
			...
			_tmp51_ = baladoc_api_tree_search_symbol_str (_tmp49_, (ValadocApiNode*) sym, _tmp50_);
		...
		if (_tmp52_) {
			...
			_tmp57_ = baladoc_api_node_get_full_name ((ValadocApiNode*) sym);
			_tmp58_ = _tmp57_;
		...
		if (_tmp60_) {
			...
			if (_tmp68_) {
				...
				if (_tmp73_) {
					...
					_tmp81_ = baladoc_api_node_get_full_name ((ValadocApiNode*) sym);
					_tmp82_ = _tmp81_;
...
"on %s.", _tmp82_);
		...
		_tmp86_ = _tmp85_;
		bala_collection_add ((ValaCollection*) _tmp83_, _tmp86_);
                                                  ...
                                                  const gchar* line)
{
	...
	if (line != NULL) {
		...
		bala_collection_add ((ValaCollection*) _tmp0_, line);
	}
}
