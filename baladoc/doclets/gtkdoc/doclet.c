...
struct _GtkdocDirectorPrivate {
	...
	gchar** bala_headers;
	gint bala_headers_length1;
	gint _bala_headers_size_;
	gchar** c_headers;
...
static BaladocDocletIface * gtkdoc_director_baladoc_doclet_parent_iface = NULL;
...
static void _bala_array_add4 (gchar** * array,
                       ...
                       gint* size,
                       gchar* value);
static void gtkdoc_director_real_process (BaladocDoclet* base,
                                   BaladocSettings* settings,
                                   BaladocApiTree* tree,
                                   BaladocErrorReporter* reporter);
...
static void gtkdoc_director_prepare_c_file (GtkdocDirector* self,
                                     ...
                                     const gchar* comments_dir);
gboolean gtkdoc_is_generated_by_bala (const gchar* filename);
...
static void _bala_array_add8 (gchar** * array,
                       ...
                       gint* size,
                       gchar* value);
static void _bala_array_add9 (gchar** * array,
                       gint* length,
                       gint* size,
                       gchar* value);
static void _bala_array_add10 (gchar** * array,
                        gint* length,
                        gint* size,
                        gchar* value);
static void _bala_array_add11 (gchar** * array,
                        gint* length,
                        gint* size,
                        gchar* value);
...
gboolean gtkdoc_package_exists (const gchar* package_name,
                                BaladocErrorReporter* reporter);
static void _bala_array_add13 (gchar** * array,
                        gint* length,
                        gint* size,
                        gchar* value);
static void _bala_array_add14 (gchar** * array,
                        gint* length,
                        gint* size,
                        gchar* value);
static void _bala_array_add15 (gchar** * array,
                        gint* length,
                        gint* size,
                        gchar* value);
static void _bala_array_add16 (gchar** * array,
                        gint* length,
                        gint* size,
                        gchar* value);
static void _bala_array_add17 (gchar** * array,
                        gint* length,
                        gint* size,
                        gchar* value);
static void _bala_array_add18 (gchar** * array,
                        gint* length,
                        gint* size,
                        gchar* value);
                     ...
                     BaladocErrorReporter* reporter)
{
	...
	_args_size_ = args_length1;
	{
		...
		for (arg_it = 0; arg_it < arg_collection_length1; arg_it = arg_it + 1) {
			...
			arg = _tmp2_;
			{
				...
				_bala_array_add3 (&args, &args_length1, &_args_size_, _tmp4_);
				_g_free0 (arg);
			}
		}
	}
	{
		...
		_tmp5_ = g_option_context_new ("- Bala GTK-Doc");
		opt_context = _tmp5_;
		_tmp6_ = opt_context;
		...
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			...
			args = (_bala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
	...
	__catch0_g_option_error:
	{
		...
		baladoc_error_reporter_simple_error (reporter, "GtkDoc", "%s\n" \
	...
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp16__length1 = _bala_array_length (gtkdoc_config_ignore_headers);
				if (!(i < _tmp16__length1)) {
					break;
				}
				_tmp17_ = gtkdoc_config_ignore_headers;
				_tmp17__length1 = _bala_array_length (gtkdoc_config_ignore_headers);
				_tmp18_ = _tmp17_[i];
				_tmp19_ = bala_code_context_realpath (_tmp18_);
				realheader = _tmp19_;
				_tmp20_ = realheader;
				if (_tmp20_ != NULL) {
					gchar** _tmp21_;
					...
					_tmp21__length1 = _bala_array_length (gtkdoc_config_ignore_headers);
					_tmp22_ = realheader;
                                       ...
                                       gint* result_length1)
{
	...
	gint _tmp4__length1;
	gchar** result = NULL;
	_tmp0_ = (a != NULL) ? _bala_array_dup3 (a, a_length1) : ((gpointer) a);
	...
	__result__size_ = _result__length1;
	{
		...
		for (e_it = 0; e_it < e_collection_length1; e_it = e_it + 1) {
			...
			e = _tmp1_;
			{
				...
				_bala_array_add4 (&_result_, &_result__length1, &__result__size_, _tmp3_);
				_g_free0 (e);
			}
		}
	}
...
static void
gtkdoc_director_real_process (BaladocDoclet* base,
                              BaladocSettings* settings,
                              BaladocApiTree* tree,
                              BaladocErrorReporter* reporter)
{
	...
	_tmp11__length1 = _bala_array_length (gtkdoc_config_source_files);
	_tmp12_ = baladoc_api_tree_get_external_c_files (tree);
	_tmp13_ = _tmp12_;
	_tmp15_ = bala_collection_to_array (_tmp13_, &_tmp14_);
	_tmp16_ = _tmp15_;
	...
	if (!gtkdoc_director_prepare_files (self, _tmp20_, (gint) _tmp20__length1, _tmp21_)) {
		files = (_bala_array_free (files, files_length1, (GDestroyNotify) g_free), NULL);
		_g_free0 (cscan_dir);
		_g_free0 (ccomments_dir);
		return;
	}
	_tmp22_ = self->priv->bala_headers;
	_tmp22__length1 = self->priv->bala_headers_length1;
	...
	if (!gtkdoc_director_scan (self, _tmp26_, _tmp27_, (gint) _tmp27__length1)) {
		all_headers = (_bala_array_free (all_headers, all_headers_length1, (GDestroyNotify) g_free), NULL);
		files = (_bala_array_free (files, files_length1, (GDestroyNotify) g_free), NULL);
		_g_free0 (cscan_dir);
		_g_free0 (ccomments_dir);
		return;
                                ...
                                const gchar* comments_dir)
{
	...
	if (gtkdoc_is_generated_by_bala (filename)) {
		return;
	}
	...
	_tmp3_ = _tmp2_;
	_tmp4_ = !baladoc_copy_file (filename, _tmp3_);
	_g_free0 (_tmp3_);
	_g_free0 (_tmp1_);
	if (_tmp4_) {
		BaladocErrorReporter* _tmp5_;
		_tmp5_ = self->priv->reporter;
		baladoc_error_reporter_simple_error (_tmp5_, "GtkDoc", "Can't copy '%s'", filename);
	}
}
                                ...
                                const gchar* filename)
{
	...
	_tmp0__length1 = _bala_array_length (gtkdoc_config_ignore_headers);
	if (_bala_string_array_contains (_tmp0_, _tmp0__length1, filename)) {
		return;
	}
	if (gtkdoc_is_generated_by_bala (filename)) {
		gchar* _tmp1_;
		_tmp1_ = g_strdup (filename);
		_bala_array_add5 (&self->priv->bala_headers, &self->priv->bala_headers_length1, &self->priv->_bala_headers_size_, _tmp1_);
	} else {
		gchar* _tmp2_;
		_tmp2_ = g_strdup (filename);
		_bala_array_add6 (&self->priv->c_headers, &self->priv->c_headers_length1, &self->priv->_c_headers_size_, _tmp2_);
	}
}
                               ...
                               const gchar* comments_dir)
{
	...
	self->priv->bala_headers = (_bala_array_free (self->priv->bala_headers, self->priv->bala_headers_length1, (GDestroyNotify) g_free), NULL);
	self->priv->bala_headers = _tmp0_;
	self->priv->bala_headers_length1 = 0;
	self->priv->_bala_headers_size_ = self->priv->bala_headers_length1;
	_tmp1_ = g_new0 (gchar*, 0 + 1);
	self->priv->c_headers = (_bala_array_free (self->priv->c_headers, self->priv->c_headers_length1, (GDestroyNotify) g_free), NULL);
	...
	_prepared_size_ = prepared_length1;
	{
		...
		for (relative_filename_it = 0; relative_filename_it < relative_filename_collection_length1; relative_filename_it = relative_filename_it + 1) {
			...
			relative_filename = _tmp3_;
			{
				...
				_tmp5_ = bala_code_context_realpath (_tmp4_);
				filename = _tmp5_;
				_tmp6_ = filename;
				_tmp7_ = prepared;
				_tmp7__length1 = prepared_length1;
				if (_bala_string_array_contains (_tmp7_, _tmp7__length1, _tmp6_)) {
					_g_free0 (filename);
				...
				_bala_array_add7 (&prepared, &prepared_length1, &_prepared_size_, _tmp9_);
				_tmp10_ = filename;
				if (!g_file_test (_tmp10_, G_FILE_TEST_EXISTS)) {
					...
					baladoc_error_reporter_simple_error (_tmp11_, "GtkDoc", "'%s' not found", _tmp12_);
					_g_free0 (filename);
					_g_free0 (relative_filename);
					continue;
				}
				...
				if (g_str_has_suffix (_tmp13_, ".c")) {
					...
					if (g_str_has_suffix (_tmp15_, ".h")) {
						...
						baladoc_error_reporter_simple_error (_tmp17_, "GtkDoc", "'%s' is not a supported source file type. Only .h, and .c files are su" \
"pported.", _tmp18_);
					}
				}
				_g_free0 (filename);
	...
	_tmp19_ = self->priv->bala_headers;
	_tmp19__length1 = self->priv->bala_headers_length1;
	if (_tmp19__length1 <= 0) {
		BaladocErrorReporter* _tmp20_;
		_tmp20_ = self->priv->reporter;
		baladoc_error_reporter_simple_error (_tmp20_, "GtkDoc", "No bala header found");
	}
	_tmp21_ = self->priv->reporter;
	_tmp22_ = baladoc_error_reporter_get_errors (_tmp21_);
	_tmp23_ = _tmp22_;
	result = _tmp23_ == 0;
	prepared = (_bala_array_free (prepared, prepared_length1, (GDestroyNotify) g_free), NULL);
	return result;
}
                      ...
                      gint headers_length1)
{
	...
	_args_size_ = args_length1;
	{
		...
		for (header_it = 0; header_it < header_collection_length1; header_it = header_it + 1) {
			...
			header = _tmp10_;
			{
				...
				_bala_array_add8 (&args, &args_length1, &_args_size_, _tmp12_);
				_g_free0 (header);
			}
		}
	}
	...
	if (_tmp13_ != NULL) {
		...
		_bala_array_add9 (&args, &args_length1, &_args_size_, _tmp14_);
		_tmp15_ = gtkdoc_config_deprecated_guards;
		_tmp16_ = g_strdup (_tmp15_);
		_bala_array_add10 (&args, &args_length1, &_args_size_, _tmp16_);
	}
	...
	if (_tmp17_ != NULL) {
		...
		_bala_array_add11 (&args, &args_length1, &_args_size_, _tmp18_);
		_tmp19_ = gtkdoc_config_ignore_decorators;
		_tmp20_ = g_strdup (_tmp19_);
		_bala_array_add12 (&args, &args_length1, &_args_size_, _tmp20_);
	}
	{
		BaladocSettings* _tmp21_;
		const gchar* _tmp22_;
		gchar** _tmp23_;
		gint _tmp23__length1;
	...
	__catch0_g_error:
	{
		...
		baladoc_error_reporter_simple_error (_tmp24_, "gtkdoc-scan", "%s", _tmp26_);
		result = FALSE;
		_g_error_free0 (e);
		args = (_bala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
		return result;
...
gtkdoc_director_scangobj (GtkdocDirector* self)
{
	...
	_tmp0__length1 = _bala_array_length (gtkdoc_config_library_filenames);
	if (_tmp0_ == NULL) {
		result = TRUE;
		return result;
	}
	...
	_tmp3__length1 = _bala_array_length (gtkdoc_config_library_filenames);
	{
		...
		for (library_it = 0; library_it < library_collection_length1; library_it = library_it + 1) {
			...
			library = _tmp4_;
			{
				...
				GString* _tmp14_;
				_tmp5_ = library;
				_tmp6_ = bala_code_context_realpath (_tmp5_);
				so_path = _tmp6_;
				_tmp7_ = so_path;
	...
	_pc_size_ = pc_length1;
	{
		...
		while (TRUE) {
			...
			package = (BaladocApiPackage*) _tmp24_;
			_tmp26_ = package;
			_tmp27_ = baladoc_api_package_get_is_package (_tmp26_);
			_tmp28_ = _tmp27_;
			if (_tmp28_) {
				BaladocApiPackage* _tmp29_;
				const gchar* _tmp30_;
				const gchar* _tmp31_;
				BaladocErrorReporter* _tmp32_;
				_tmp29_ = package;
				_tmp30_ = baladoc_api_node_get_name ((BaladocApiNode*) _tmp29_);
				_tmp31_ = _tmp30_;
			...
			if (_tmp25_) {
				BaladocApiPackage* _tmp33_;
				const gchar* _tmp34_;
				const gchar* _tmp35_;
				gchar* _tmp36_;
				_tmp33_ = package;
				_tmp34_ = baladoc_api_node_get_name ((BaladocApiNode*) _tmp33_);
				_tmp35_ = _tmp34_;
				_tmp36_ = g_strdup (_tmp35_);
				_bala_array_add13 (&pc, &pc_length1, &_pc_size_, _tmp36_);
			}
			_g_object_unref0 (package);
		}
		_bala_iterator_unref0 (_package_it);
	}
	...
	_tmp38__length1 = pc_length1;
	{
		...
		for (name_it = 0; name_it < name_collection_length1; name_it = name_it + 1) {
			...
			name = _tmp39_;
			{
				...
				_bala_array_add14 (&pc_cflags, &pc_cflags_length1, &_pc_cflags_size_, _tmp41_);
				_g_free0 (name);
			}
		}
	}
	_tmp42_ = g_strdup ("--cflags");
	_bala_array_add15 (&pc_cflags, &pc_cflags_length1, &_pc_cflags_size_, _tmp42_);
	...
	_tmp44__length1 = pc_length1;
	{
		...
		for (name_it = 0; name_it < name_collection_length1; name_it = name_it + 1) {
			...
			name = _tmp45_;
			{
				...
				_bala_array_add16 (&pc_libs, &pc_libs_length1, &_pc_libs_size_, _tmp47_);
				_g_free0 (name);
			}
		}
	}
	_tmp48_ = g_strdup ("--libs");
	_bala_array_add17 (&pc_libs, &pc_libs_length1, &_pc_libs_size_, _tmp48_);
	{
		...
		gchar* _tmp69_;
		gchar* _tmp70_;
		BaladocSettings* _tmp71_;
		const gchar* _tmp72_;
		gchar* _tmp73_;
		gchar* _tmp74_;
		BaladocSettings* _tmp75_;
		const gchar* _tmp76_;
		gchar* _tmp77_;
		gchar** _tmp78_;
		gint args_length1;
		...
		if (status != 0) {
			BaladocErrorReporter* _tmp53_;
			const gchar* _tmp54_;
			_tmp53_ = self->priv->reporter;
			_tmp54_ = stderr_buf;
			baladoc_error_reporter_simple_error (_tmp53_, "GtkDoc", "pkg-config cflags error: %s", _tmp54_);
			result = FALSE;
			_g_free0 (cflags);
			_g_free0 (stderr_buf);
			pc_libs = (_bala_array_free (pc_libs, pc_libs_length1, (GDestroyNotify) g_free), NULL);
			pc_cflags = (_bala_array_free (pc_cflags, pc_cflags_length1, (GDestroyNotify) g_free), NULL);
			pc = (_bala_array_free (pc, pc_length1, (GDestroyNotify) g_free), NULL);
		...
		if (status != 0) {
			BaladocErrorReporter* _tmp61_;
			const gchar* _tmp62_;
			_tmp61_ = self->priv->reporter;
			_tmp62_ = stderr_buf;
			baladoc_error_reporter_simple_error (_tmp61_, "GtkDoc", "pkg-config libs error: %s", _tmp62_);
			result = FALSE;
			_g_free0 (libs);
			_g_free0 (cflags);
			_g_free0 (stderr_buf);
		...
		_tmp96_ = _tmp95_ = g_listenv ();
		{
			...
			evar_collection_length1 = _bala_array_length (_tmp95_);
			for (evar_it = 0; evar_it < evar_collection_length1; evar_it = evar_it + 1) {
				...
				evar = _tmp97_;
				{
					...
					if (_tmp98_) {
						...
						_bala_array_add18 (&env, &env_length1, &_env_size_, _tmp106_);
					}
					_g_free0 (evar);
				}
			}
			evar_collection = (_bala_array_free (evar_collection, evar_collection_length1, (GDestroyNotify) g_free), NULL);
		}
		...
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			env = (_bala_array_free (env, env_length1, (GDestroyNotify) g_free), NULL);
			args = (_bala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
			_g_free0 (libs);
			_g_free0 (cflags);
			_g_free0 (stderr_buf);
	...
	__catch0_g_error:
	{
		...
		baladoc_error_reporter_simple_error (_tmp111_, "gtkdoc-scangobj", "%s", _tmp113_);
		result = FALSE;
		_g_error_free0 (e);
		pc_libs = (_bala_array_free (pc_libs, pc_libs_length1, (GDestroyNotify) g_free), NULL);
		pc_cflags = (_bala_array_free (pc_cflags, pc_cflags_length1, (GDestroyNotify) g_free), NULL);
...
gtkdoc_director_mkdb (GtkdocDirector* self)
{
	...
	__catch0_g_error:
	{
		...
		baladoc_error_reporter_simple_error (_tmp35_, "gtkdoc-mkdb", "%s", _tmp37_);
		result = FALSE;
		_g_error_free0 (e);
		args = (_bala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
		_g_free0 (code_dir);
	...
	if (must_update_main_file) {
		gchar* contents = NULL;
		BaladocSettings* _tmp46_;
		const gchar* _tmp47_;
		const gchar* _tmp52_;
		BaladocSettings* _tmp53_;
		const gchar* _tmp54_;
		gchar* _tmp55_;
		gchar* _tmp56_;
		gchar* _tmp57_;
		...
		__catch1_g_error:
		{
			...
			baladoc_error_reporter_simple_error (_tmp41_, "GtkDoc", "Error while reading main file '%s' contents: %s", _tmp42_, _tmp44_);
			result = FALSE;
			_g_error_free0 (e);
			_g_free0 (contents);
			args = (_bala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
		...
		if (_tmp61_ > 0) {
			...
			BaladocSettings* _tmp81_;
			const gchar* _tmp82_;
			BaladocSettings* _tmp83_;
			const gchar* _tmp84_;
			gchar* _tmp85_;
			gchar* _tmp86_;
			gchar* _tmp87_;
			...
			g_string_append_printf (_tmp63_, "\n<chapter>\n<title>%s D-Bus API Reference</title>\n", _tmp65_);
			{
				...
				while (TRUE) {
					...
					_tmp74_ = _iface_list;
					_tmp75_ = bala_list_get (_tmp74_, _iface_index);
		...
		__catch2_g_error:
		{
			...
			baladoc_error_reporter_simple_error (_tmp102_, "GtkDoc", "Error while writing main file '%s' contents: %s", _tmp103_, _tmp105_);
			result = FALSE;
			_g_error_free0 (e);
			_g_free0 (contents);
			args = (_bala_array_free (args, args_length1, (GDestroyNotify) g_free), NULL);
...
gtkdoc_director_mkhtml (GtkdocDirector* self)
{
	...
	__catch0_g_error:
	{
		...
		baladoc_error_reporter_simple_error (_tmp14_, "gtkdoc-mkhtml", "%s", _tmp16_);
		result = FALSE;
		_g_error_free0 (e);
		_g_free0 (html_dir);
		return result;
	...
	__catch1_g_error:
	{
		...
		baladoc_error_reporter_simple_error (_tmp33_, "gtkdoc-fixxref", "%s", _tmp35_);
		result = FALSE;
		_g_error_free0 (e);
		_g_free0 (html_dir);
		return result;
...
static void
gtkdoc_director_baladoc_doclet_interface_init (BaladocDocletIface * iface,
                                               gpointer iface_data)
{
	gtkdoc_director_baladoc_doclet_parent_iface = g_type_interface_peek_parent (iface);
	iface->process = (void (*) (BaladocDoclet*, BaladocSettings*, BaladocApiTree*, BaladocErrorReporter*)) gtkdoc_director_real_process;
}
...
gtkdoc_director_get_type_once (void)
{
	...
	static const GInterfaceInfo baladoc_doclet_info = { (GInterfaceInitFunc) gtkdoc_director_baladoc_doclet_interface_init, (GInterfaceFinalizeFunc) NULL, NULL};
	...
	g_type_add_interface_static (gtkdoc_director_type_id, BALADOC_TYPE_DOCLET, &baladoc_doclet_info);
