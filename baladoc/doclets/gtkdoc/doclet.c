...
static ValadocDocletIface * gtkdoc_director_baladoc_doclet_parent_iface = NULL;
	...
	_pc_size_ = pc_length1;
	{
		...
		while (TRUE) {
			...
			if (_tmp28_) {
				...
				_tmp29_ = package;
				_tmp30_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp29_);
				_tmp31_ = _tmp30_;
			...
			if (_tmp25_) {
				...
				gchar* _tmp36_;
				_tmp33_ = package;
				_tmp34_ = baladoc_api_node_get_name ((ValadocApiNode*) _tmp33_);
				_tmp35_ = _tmp34_;
...
static void
gtkdoc_director_baladoc_doclet_interface_init (ValadocDocletIface * iface,
                                               gpointer iface_data)
{
