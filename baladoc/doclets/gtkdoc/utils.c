/* utils.c generated by balac, the Bala compiler
 * generated from utils.bala, do not modify */
...
gchar* gtkdoc_get_dbus_interface (BaladocApiItem* item);
...
gtkdoc_commentize (const gchar* comment)
{
	...
	_tmp2_ = _tmp1_;
	_tmp2__length1 = _bala_array_length (_tmp0_);
	_tmp3_ = _bala_g_strjoinv ("\n * ", _tmp2_, (gint) _bala_array_length (_tmp0_));
	_tmp4_ = _tmp3_;
...
gchar*
gtkdoc_get_cname (BaladocApiItem* item)
{
	gchar* result = NULL;
	g_return_val_if_fail (item != NULL, NULL);
	if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_METHOD)) {
		gchar* _tmp0_;
		_tmp0_ = baladoc_api_method_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_METHOD, BaladocApiMethod));
		result = _tmp0_;
		return result;
	} else {
		if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_PARAMETER)) {
			const gchar* _tmp1_;
			const gchar* _tmp2_;
			gchar* _tmp3_;
...
gchar*
gtkdoc_get_dbus_interface (BaladocApiItem* item)
{
	gchar* result = NULL;
	g_return_val_if_fail (item != NULL, NULL);
	if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_CLASS)) {
		gchar* _tmp0_;
		_tmp0_ = baladoc_api_class_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_CLASS, BaladocApiClass));
		result = _tmp0_;
		return result;
	} else {
		if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_INTERFACE)) {
			gchar* _tmp1_;
			_tmp1_ = baladoc_api_interface_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_INTERFACE, BaladocApiInterface));
			result = _tmp1_;
			return result;
		}
	}
...
gchar*
gtkdoc_get_docbook_type_link (BaladocApiClass* cls)
{
	gchar* _tmp0_;
	gchar* _tmp1_;
	gchar* _tmp2_;
	...
	_tmp0_ = baladoc_api_class_get_type_id (cls);
	_tmp1_ = _tmp0_;
	_tmp2_ = gtkdoc_to_docbook_id (_tmp1_);
	_tmp3_ = _tmp2_;
	_tmp4_ = baladoc_api_class_get_type_id (cls);
	_tmp5_ = _tmp4_;
...
gchar*
gtkdoc_get_gtkdoc_link (BaladocApiNode* symbol)
{
	gboolean _tmp0_ = FALSE;
	gboolean _tmp1_ = FALSE;
	gboolean _tmp2_ = FALSE;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_CLASS)) {
		_tmp3_ = TRUE;
	} else {
		_tmp3_ = G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_INTERFACE);
	}
	if (_tmp3_) {
		_tmp2_ = TRUE;
	} else {
		_tmp2_ = G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_STRUCT);
	}
	if (_tmp2_) {
		_tmp1_ = TRUE;
	} else {
		_tmp1_ = G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_ENUM);
	}
	if (_tmp1_) {
		_tmp0_ = TRUE;
	} else {
		_tmp0_ = G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_ERROR_DOMAIN);
	}
	if (_tmp0_) {
		gchar* _tmp4_;
		gchar* _tmp5_;
		gchar* _tmp6_;
		gchar* _tmp7_;
		_tmp4_ = gtkdoc_get_cname ((BaladocApiItem*) symbol);
		_tmp5_ = _tmp4_;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_METHOD)) {
		gchar* _tmp8_;
		gchar* _tmp9_;
		gchar* _tmp10_;
		gchar* _tmp11_;
		_tmp8_ = baladoc_api_method_get_cname (G_TYPE_CHECK_INSTANCE_CAST (symbol, BALADOC_API_TYPE_METHOD, BaladocApiMethod));
		_tmp9_ = _tmp8_;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_CONSTANT)) {
		_tmp13_ = TRUE;
	} else {
		_tmp13_ = G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_ENUM_VALUE);
	}
	if (_tmp13_) {
		_tmp12_ = TRUE;
	} else {
		_tmp12_ = G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_ERROR_CODE);
	}
	if (_tmp12_) {
		gchar* _tmp14_;
		gchar* _tmp15_;
		gchar* _tmp16_;
		gchar* _tmp17_;
		_tmp14_ = gtkdoc_get_cname ((BaladocApiItem*) symbol);
		_tmp15_ = _tmp14_;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_SIGNAL)) {
		...
		gchar* _tmp24_;
		gchar* _tmp25_;
		_tmp18_ = baladoc_api_item_get_parent ((BaladocApiItem*) symbol);
		_tmp19_ = _tmp18_;
		_tmp20_ = gtkdoc_get_cname (_tmp19_);
		_tmp21_ = _tmp20_;
		_tmp22_ = baladoc_api_signal_get_cname (G_TYPE_CHECK_INSTANCE_CAST (symbol, BALADOC_API_TYPE_SIGNAL, BaladocApiSignal));
		_tmp23_ = _tmp22_;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_PROPERTY)) {
		...
		gchar* _tmp32_;
		gchar* _tmp33_;
		_tmp26_ = baladoc_api_item_get_parent ((BaladocApiItem*) symbol);
		_tmp27_ = _tmp26_;
		_tmp28_ = gtkdoc_get_cname (_tmp27_);
		_tmp29_ = _tmp28_;
		_tmp30_ = baladoc_api_property_get_cname (G_TYPE_CHECK_INSTANCE_CAST (symbol, BALADOC_API_TYPE_PROPERTY, BaladocApiProperty));
		_tmp31_ = _tmp30_;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_FIELD)) {
		gboolean _tmp35_ = FALSE;
		BaladocApiItem* _tmp36_;
		BaladocApiItem* _tmp37_;
		_tmp36_ = baladoc_api_item_get_parent ((BaladocApiItem*) symbol);
		_tmp37_ = _tmp36_;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp37_, BALADOC_API_TYPE_CLASS)) {
			_tmp35_ = TRUE;
		} else {
			BaladocApiItem* _tmp38_;
			BaladocApiItem* _tmp39_;
			_tmp38_ = baladoc_api_item_get_parent ((BaladocApiItem*) symbol);
			_tmp39_ = _tmp38_;
			_tmp35_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp39_, BALADOC_API_TYPE_STRUCT);
		}
		_tmp34_ = _tmp35_;
	} else {
		_tmp34_ = FALSE;
	...
	if (_tmp34_) {
		...
		BaladocApiField* _tmp40_;
		BaladocApiField* _tmp41_;
		gboolean _tmp42_;
		gboolean _tmp43_;
		_tmp40_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_FIELD) ? ((BaladocApiField*) symbol) : NULL);
		field = _tmp40_;
		_tmp41_ = field;
		_tmp42_ = baladoc_api_field_get_is_static (_tmp41_);
		_tmp43_ = _tmp42_;
		if (_tmp43_) {
			BaladocApiField* _tmp44_;
			gchar* _tmp45_;
			_tmp44_ = field;
			_tmp45_ = baladoc_api_field_get_cname (_tmp44_);
			result = _tmp45_;
			...
			gchar* _tmp48_;
			gchar* _tmp49_;
			BaladocApiField* _tmp50_;
			gchar* _tmp51_;
			gchar* _tmp52_;
			gchar* _tmp53_;
			gchar* _tmp54_;
			_tmp46_ = baladoc_api_item_get_parent ((BaladocApiItem*) symbol);
			_tmp47_ = _tmp46_;
			_tmp48_ = gtkdoc_get_cname (_tmp47_);
			_tmp49_ = _tmp48_;
			_tmp50_ = field;
			_tmp51_ = baladoc_api_field_get_cname (_tmp50_);
			_tmp52_ = _tmp51_;
	...
	_tmp56_ = gtkdoc_get_cname ((BaladocApiItem*) symbol);
	_tmp55_ = _tmp56_;
	if (_tmp55_ == NULL) {
		gchar* _tmp57_;
		_tmp57_ = baladoc_api_node_get_full_name (symbol);
		_g_free0 (_tmp55_);
		_tmp55_ = _tmp57_;
	}
	_tmp58_ = _tmp55_;
...
gchar*
gtkdoc_get_docbook_link (BaladocApiItem* item,
                         gboolean is_dbus,
                         gboolean is_async_finish)
{
	gchar* result = NULL;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_METHOD)) {
		...
		if (is_dbus) {
			...
			gchar* _tmp4_;
			gchar* _tmp5_;
			_tmp0_ = baladoc_api_method_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_METHOD, BaladocApiMethod));
			_g_free0 (name);
			name = _tmp0_;
			_tmp1_ = baladoc_api_item_get_parent (item);
			_tmp2_ = _tmp1_;
			...
			if (!is_async_finish) {
				gchar* _tmp6_;
				_tmp6_ = baladoc_api_method_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_METHOD, BaladocApiMethod));
				_g_free0 (name);
				name = _tmp6_;
			} else {
				gchar* _tmp7_;
				_tmp7_ = baladoc_api_method_get_finish_function_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_METHOD, BaladocApiMethod));
				_g_free0 (name);
				name = _tmp7_;
			}
			_tmp8_ = g_strdup ("");
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_PARAMETER)) {
			...
			const gchar* _tmp19_;
			gchar* _tmp20_;
			_tmp18_ = baladoc_api_node_get_name ((BaladocApiNode*) G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_PARAMETER, BaladocApiParameter));
			_tmp19_ = _tmp18_;
			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_CONSTANT)) {
				...
				gchar* _tmp26_;
				gchar* _tmp27_;
				_tmp21_ = baladoc_api_constant_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_CONSTANT, BaladocApiConstant));
				cname = _tmp21_;
				_tmp22_ = cname;
				...
				if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_ERROR_CODE)) {
					...
					gchar* _tmp33_;
					gchar* _tmp34_;
					_tmp28_ = baladoc_api_error_code_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_ERROR_CODE, BaladocApiErrorCode));
					cname = _tmp28_;
					_tmp29_ = cname;
					...
					if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_PROPERTY)) {
						...
						if (is_dbus) {
							...
							BaladocApiItem* _tmp37_;
							gchar* _tmp38_;
							_tmp35_ = baladoc_api_property_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_PROPERTY, BaladocApiProperty));
							_g_free0 (name);
							name = _tmp35_;
							_tmp36_ = baladoc_api_item_get_parent (item);
							_tmp37_ = _tmp36_;
							...
							gchar* _tmp42_;
							_tmp39_ = baladoc_api_property_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_PROPERTY, BaladocApiProperty));
							_g_free0 (name);
							name = _tmp39_;
							_tmp40_ = baladoc_api_item_get_parent (item);
							_tmp41_ = _tmp40_;
						...
						if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_SIGNAL)) {
							...
							if (is_dbus) {
								...
								gchar* _tmp55_;
								_tmp52_ = baladoc_api_signal_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_SIGNAL, BaladocApiSignal));
								_g_free0 (name);
								name = _tmp52_;
								_tmp53_ = baladoc_api_item_get_parent (item);
								_tmp54_ = _tmp53_;
								...
								gchar* _tmp61_;
								_tmp56_ = baladoc_api_signal_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_SIGNAL, BaladocApiSignal));
								_g_free0 (name);
								name = _tmp56_;
								_tmp57_ = name;
								...
								_g_free0 (name);
								name = _tmp58_;
								_tmp59_ = baladoc_api_item_get_parent (item);
								_tmp60_ = _tmp59_;
...
gdouble
gtkdoc_get_parameter_pos (BaladocApiNode* node,
                          const gchar* name)
{
	gdouble pos = 0.0;
	gdouble result = 0.0;
	...
	pos = (gdouble) 1;
	{
		...
		gint _tmp3_;
		gint _param_index = 0;
		_tmp0_ = baladoc_api_node_get_children_by_type (node, BALADOC_API_NODE_TYPE_FORMAL_PARAMETER, TRUE);
		_param_list = _tmp0_;
		_tmp1_ = _param_list;
                       ...
                       BaladocErrorReporter* reporter)
{
	...
	__catch0_g_spawn_error:
	{
		...
		baladoc_error_reporter_simple_warning (reporter, "GtkDoc", "Error pkg-config --exists %s: %s", package_name, _tmp4_);
		result = FALSE;
		_g_error_free0 (e);
		_g_free0 (pc);
		return result;
...
gboolean
gtkdoc_is_generated_by_bala (const gchar* filename)
{
	FILE* stream = NULL;
	FILE* _tmp0_;
	FILE* _tmp1_;
	...
	if (_tmp1_ != NULL) {
		...
		if (_tmp4_ != NULL) {
			const gchar* _tmp5_;
			_tmp5_ = line;
			result = string_index_of (_tmp5_, "generated by balac", 0) >= 0;
			_g_free0 (line);
			_fclose0 (stream);
			return result;
		}
