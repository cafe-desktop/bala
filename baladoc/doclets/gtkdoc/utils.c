/* utils.c generated by balac, the Vala compiler
...
gtkdoc_get_dbus_interface (ValadocApiItem* item)
{
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_CLASS)) {
		gchar* _tmp0_;
		_tmp0_ = baladoc_api_class_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_CLASS, ValadocApiClass));
		result = _tmp0_;
		return result;
	} else {
		if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_INTERFACE)) {
			gchar* _tmp1_;
			_tmp1_ = baladoc_api_interface_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_INTERFACE, ValadocApiInterface));
			result = _tmp1_;
			return result;
		}
	}
...
gtkdoc_get_gtkdoc_link (ValadocApiNode* symbol)
{
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_METHOD)) {
		...
		gchar* _tmp10_;
		gchar* _tmp11_;
		_tmp8_ = baladoc_api_method_get_cname (G_TYPE_CHECK_INSTANCE_CAST (symbol, BALADOC_API_TYPE_METHOD, ValadocApiMethod));
		_tmp9_ = _tmp8_;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_SIGNAL)) {
		...
		gchar* _tmp24_;
		gchar* _tmp25_;
		_tmp18_ = baladoc_api_item_get_parent ((ValadocApiItem*) symbol);
		_tmp19_ = _tmp18_;
		_tmp20_ = gtkdoc_get_cname (_tmp19_);
		_tmp21_ = _tmp20_;
		_tmp22_ = baladoc_api_signal_get_cname (G_TYPE_CHECK_INSTANCE_CAST (symbol, BALADOC_API_TYPE_SIGNAL, ValadocApiSignal));
		_tmp23_ = _tmp22_;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_PROPERTY)) {
		...
		gchar* _tmp32_;
		gchar* _tmp33_;
		_tmp26_ = baladoc_api_item_get_parent ((ValadocApiItem*) symbol);
		_tmp27_ = _tmp26_;
		_tmp28_ = gtkdoc_get_cname (_tmp27_);
		_tmp29_ = _tmp28_;
		_tmp30_ = baladoc_api_property_get_cname (G_TYPE_CHECK_INSTANCE_CAST (symbol, BALADOC_API_TYPE_PROPERTY, ValadocApiProperty));
		_tmp31_ = _tmp30_;
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_FIELD)) {
		...
		_tmp36_ = baladoc_api_item_get_parent ((ValadocApiItem*) symbol);
		_tmp37_ = _tmp36_;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp37_, BALADOC_API_TYPE_CLASS)) {
			...
			_tmp38_ = baladoc_api_item_get_parent ((ValadocApiItem*) symbol);
			_tmp39_ = _tmp38_;
	...
	if (_tmp34_) {
		...
		gboolean _tmp42_;
		gboolean _tmp43_;
		_tmp40_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (symbol, BALADOC_API_TYPE_FIELD) ? ((ValadocApiField*) symbol) : NULL);
		field = _tmp40_;
		_tmp41_ = field;
		...
		if (_tmp43_) {
			...
			gchar* _tmp53_;
			gchar* _tmp54_;
			_tmp46_ = baladoc_api_item_get_parent ((ValadocApiItem*) symbol);
			_tmp47_ = _tmp46_;
                         ...
                         gboolean is_async_finish)
{
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_METHOD)) {
		...
		if (is_dbus) {
			...
			gchar* _tmp4_;
			gchar* _tmp5_;
			_tmp0_ = baladoc_api_method_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_METHOD, ValadocApiMethod));
			_g_free0 (name);
			name = _tmp0_;
			...
			if (!is_async_finish) {
				gchar* _tmp6_;
				_tmp6_ = baladoc_api_method_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_METHOD, ValadocApiMethod));
				_g_free0 (name);
				name = _tmp6_;
			} else {
				gchar* _tmp7_;
				_tmp7_ = baladoc_api_method_get_finish_function_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_METHOD, ValadocApiMethod));
				_g_free0 (name);
				name = _tmp7_;
			}
			_tmp8_ = g_strdup ("");
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_PARAMETER)) {
			...
			const gchar* _tmp19_;
			gchar* _tmp20_;
			_tmp18_ = baladoc_api_node_get_name ((ValadocApiNode*) G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_PARAMETER, ValadocApiParameter));
			_tmp19_ = _tmp18_;
			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_CONSTANT)) {
				...
				gchar* _tmp26_;
				gchar* _tmp27_;
				_tmp21_ = baladoc_api_constant_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_CONSTANT, ValadocApiConstant));
				cname = _tmp21_;
				_tmp22_ = cname;
				...
				if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_ERROR_CODE)) {
					...
					gchar* _tmp33_;
					gchar* _tmp34_;
					_tmp28_ = baladoc_api_error_code_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_ERROR_CODE, ValadocApiErrorCode));
					cname = _tmp28_;
					_tmp29_ = cname;
					...
					if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_PROPERTY)) {
						...
						if (is_dbus) {
							...
							ValadocApiItem* _tmp37_;
							gchar* _tmp38_;
							_tmp35_ = baladoc_api_property_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_PROPERTY, ValadocApiProperty));
							_g_free0 (name);
							name = _tmp35_;
							...
							gchar* _tmp42_;
							_tmp39_ = baladoc_api_property_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_PROPERTY, ValadocApiProperty));
							_g_free0 (name);
							name = _tmp39_;
						...
						if (G_TYPE_CHECK_INSTANCE_TYPE (item, BALADOC_API_TYPE_SIGNAL)) {
							...
							if (is_dbus) {
								...
								gchar* _tmp55_;
								_tmp52_ = baladoc_api_signal_get_dbus_name (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_SIGNAL, ValadocApiSignal));
								_g_free0 (name);
								name = _tmp52_;
								...
								gchar* _tmp61_;
								_tmp56_ = baladoc_api_signal_get_cname (G_TYPE_CHECK_INSTANCE_CAST (item, BALADOC_API_TYPE_SIGNAL, ValadocApiSignal));
								_g_free0 (name);
								name = _tmp56_;
								_tmp57_ = name;
