/* dbus.c generated by balac, the Bala compiler
                                  ...
                                  GtkdocDBusParameter* parameter)
{
	...
	bala_collection_add ((BalaCollection*) _tmp0_, parameter);
}
                                  ...
                                  GtkdocDBusMember* member)
{
	...
	member->iface = _tmp0_;
	_tmp1_ = self->methods;
	bala_collection_add ((BalaCollection*) _tmp1_, member);
}
...
"</refsect1>", _tmp78_, _tmp79_);
	...
	_tmp81_ = bala_collection_get_size ((BalaCollection*) _tmp80_);
	_tmp82_ = _tmp81_;
	if (_tmp82_ > 0) {
		GString* _tmp83_;
		const gchar* _tmp84_;
