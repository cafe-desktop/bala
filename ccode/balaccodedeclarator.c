/* balaccodedeclarator.c generated by balac, the Vala compiler
...
static void bala_ccode_declarator_real_write_initialization (ValaCCodeDeclarator* self,
 ...
 */
static void
bala_ccode_declarator_real_write_initialization (ValaCCodeDeclarator* self,
                                                 ValaCCodeWriter* writer)
{
...
void
bala_ccode_declarator_write_initialization (ValaCCodeDeclarator* self,
                                            ValaCCodeWriter* writer)
{
...
bala_ccode_declarator_construct (GType object_type)
{
	...
	self = (ValaCCodeDeclarator*) bala_ccode_node_construct (object_type);
	return self;
}

static void
bala_ccode_declarator_class_init (ValaCCodeDeclaratorClass * klass,
                                  gpointer klass_data)
{
	bala_ccode_declarator_parent_class = g_type_class_peek_parent (klass);
	((ValaCCodeDeclaratorClass *) klass)->write_initialization = (void (*) (ValaCCodeDeclarator*, ValaCCodeWriter*)) bala_ccode_declarator_real_write_initialization;
}

static void
bala_ccode_declarator_instance_init (ValaCCodeDeclarator * self,
                                     gpointer klass)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaCCodeDeclaratorClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_ccode_declarator_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaCCodeDeclarator), 0, (GInstanceInitFunc) bala_ccode_declarator_instance_init, NULL };
	GType bala_ccode_declarator_type_id;
	bala_ccode_declarator_type_id = g_type_register_static (BALA_TYPE_CCODE_NODE, "ValaCCodeDeclarator", &g_define_type_info, G_TYPE_FLAG_ABSTRACT);
