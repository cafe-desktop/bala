/* balaccodefragment.c generated by balac, the Vala compiler
...
static void bala_ccode_fragment_real_write (ValaCCodeNode* base,
                                     ValaCCodeWriter* writer);
static void bala_ccode_fragment_real_write_declaration (ValaCCodeNode* base,
                                                 ValaCCodeWriter* writer);
static void bala_ccode_fragment_real_write_combined (ValaCCodeNode* base,
                                              ValaCCodeWriter* writer);
static void bala_ccode_fragment_finalize (ValaCCodeNode * obj);
static GType bala_ccode_fragment_get_type_once (void);

static inline gpointer
bala_ccode_fragment_get_instance_private (ValaCCodeFragment* self)
{
 ...
 */
void
bala_ccode_fragment_append (ValaCCodeFragment* self,
                            ValaCCodeNode* node)
{
	ValaList* _tmp0_;
...
ValaList*
bala_ccode_fragment_get_children (ValaCCodeFragment* self)
{
	ValaList* _tmp0_;
	ValaList* _tmp1_;
...
static void
bala_ccode_fragment_real_write (ValaCCodeNode* base,
                                ValaCCodeWriter* writer)
{
...
static void
bala_ccode_fragment_real_write_declaration (ValaCCodeNode* base,
                                            ValaCCodeWriter* writer)
{
	ValaCCodeFragment * self;
	self = (ValaCCodeFragment*) base;
...
static void
bala_ccode_fragment_real_write_combined (ValaCCodeNode* base,
                                         ValaCCodeWriter* writer)
{
	ValaCCodeFragment * self;
	self = (ValaCCodeFragment*) base;
...
bala_ccode_fragment_construct (GType object_type)
{
	...
	self = (ValaCCodeFragment*) bala_ccode_node_construct (object_type);
	return self;
}
...
static void
bala_ccode_fragment_class_init (ValaCCodeFragmentClass * klass,
                                gpointer klass_data)
{
	bala_ccode_fragment_parent_class = g_type_class_peek_parent (klass);
	((ValaCCodeNodeClass *) klass)->finalize = bala_ccode_fragment_finalize;
	g_type_class_adjust_private_offset (klass, &ValaCCodeFragment_private_offset);
	((ValaCCodeNodeClass *) klass)->write = (void (*) (ValaCCodeNode*, ValaCCodeWriter*)) bala_ccode_fragment_real_write;
	((ValaCCodeNodeClass *) klass)->write_declaration = (void (*) (ValaCCodeNode*, ValaCCodeWriter*)) bala_ccode_fragment_real_write_declaration;
	((ValaCCodeNodeClass *) klass)->write_combined = (void (*) (ValaCCodeNode*, ValaCCodeWriter*)) bala_ccode_fragment_real_write_combined;
}

static void
bala_ccode_fragment_instance_init (ValaCCodeFragment * self,
                                   gpointer klass)
{
	GEqualFunc _tmp0_;
...
static void
bala_ccode_fragment_finalize (ValaCCodeNode * obj)
{
	ValaCCodeFragment * self;
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaCCodeFragmentClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_ccode_fragment_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaCCodeFragment), 0, (GInstanceInitFunc) bala_ccode_fragment_instance_init, NULL };
	GType bala_ccode_fragment_type_id;
	bala_ccode_fragment_type_id = g_type_register_static (BALA_TYPE_CCODE_NODE, "ValaCCodeFragment", &g_define_type_info, 0);
	ValaCCodeFragment_private_offset = g_type_add_instance_private (bala_ccode_fragment_type_id, sizeof (ValaCCodeFragmentPrivate));
