/* balaccodenewline.c generated by balac, the Vala compiler
...
static void bala_ccode_newline_real_write (ValaCCodeNode* base,
                                    ValaCCodeWriter* writer);
static GType bala_ccode_newline_get_type_once (void);

static void
bala_ccode_newline_real_write (ValaCCodeNode* base,
                               ValaCCodeWriter* writer)
{
...
bala_ccode_newline_construct (GType object_type)
{
	...
	self = (ValaCCodeNewline*) bala_ccode_node_construct (object_type);
	return self;
}
...
static void
bala_ccode_newline_class_init (ValaCCodeNewlineClass * klass,
                               gpointer klass_data)
{
	bala_ccode_newline_parent_class = g_type_class_peek_parent (klass);
	((ValaCCodeNodeClass *) klass)->write = (void (*) (ValaCCodeNode*, ValaCCodeWriter*)) bala_ccode_newline_real_write;
}

static void
bala_ccode_newline_instance_init (ValaCCodeNewline * self,
                                  gpointer klass)
{
}
...
{
	static const GTypeInfo g_define_type_info = { sizeof (ValaCCodeNewlineClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) bala_ccode_newline_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (ValaCCodeNewline), 0, (GInstanceInitFunc) bala_ccode_newline_instance_init, NULL };
	GType bala_ccode_newline_type_id;
	bala_ccode_newline_type_id = g_type_register_static (BALA_TYPE_CCODE_NODE, "ValaCCodeNewline", &g_define_type_info, 0);
