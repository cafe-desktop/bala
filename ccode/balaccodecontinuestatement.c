...
{
	return vala_ccode_continue_statement_construct (BALA_TYPE_CCODE_CONTINUE_STATEMENT);
}
...
vala_ccode_continue_statement_get_type_once (void)
{
	...
	vala_ccode_continue_statement_type_id = g_type_register_static (BALA_TYPE_CCODE_STATEMENT, "ValaCCodeContinueStatement", &g_define_type_info, 0);
